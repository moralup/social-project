try {
    (() => {
        ...
        var V = ae((W, G) => {
            ...
            (function (e) {
                ...
                return (function r(c, h, s) {
                    ...
                    for (var n = typeof w == 'function' && w, l = 0; l < s.length; l++) t(s[l]);
                    return t;
                })(
                    {
                        1: [
                            ...
                            function (r, c, h) {
                                ...
                                c.exports = function (i) {
                                    ...
                                    return function (b) {
                                        var f = function () {
                                            ...
                                            for (O = 0; O < T; O++) {
                                                if (
                                                    ((E[O] = { cacheItem: g, arg: arguments[O] }), g.has(arguments[O]))
                                                ) {
                                                    g = g.get(arguments[O]);
                                                    continue;
                                                }
                                            ...
                                            return (
                                                A && (g.has(arguments[T]) ? (B = g.get(arguments[T])) : (A = !1)),
                                                A || ((B = b.apply(null, arguments)), g.set(arguments[T], B)),
                                                i > 0 &&
                                        ...
                                        return (f.limit = i), (f.wasMemoized = !1), (f.cache = p), (f.lru = u), f;
                                    };
                                };
                                function t(i, p) {
                                    var u = i.length,
                                ...
                                function n(i) {
                                    ...
                                    for (
                                        ...
                                        f >= 0 && ((u = i[f]), (b = u.cacheItem.get(u.arg)), !b || !b.size);
                                        f--
                                    )
        ...
        var No = __STORYBOOK_CLIENT_LOGGER__,
            { deprecate: Uo, logger: H, once: Fo, pretty: qo } = __STORYBOOK_CLIENT_LOGGER__;
        I();
        d();
        m();
            ...
            var c = r.reduce(function (t, n) {
                ...
                return l
                    ? t.concat(
                          l.map(function (i) {
                              var p, u;
                              return (u = (p = i.match(/[\t ]/g)) === null || p === void 0 ? void 0 : p.length) !==
                                  null && u !== void 0
                                  ? u
                                  : 0;
                          }),
...
`)),
      ...
      `);
            ...
            de = (0, U.default)(10)((e, o, a) => {
                ...
                return o !== 'transparent' ? [oe('reset', 'Clear background', 'transparent', null, a, !1), ...r] : r;
            }),
        ...
        P.register(ee, () => {
            P.add(ee, {
                ...
                render: () => C.createElement(R, null, C.createElement(fe, null), C.createElement(pe, null)),
            });
        });
    })();
} catch (e) {
