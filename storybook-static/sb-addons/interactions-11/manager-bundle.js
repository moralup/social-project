                    ...
                    function M(x) {
                        ...
                        return (
                            x === 0
                                ...
                                ? (R = 'foreground-color')
                                : ((39 < x && x < 48) || x === 49 || (99 < x && x < 108)) && (R = 'background-color'),
                            R
                        );
                    }
                    function j(x, R) {
                                ...
                                : (f.min ? '' : P + r) +
                                      (n.indexOf(P) !== -1
                                          ? `{${(0, t.printObjectProperties)(
                                                c(m)
                                                    ? Array.from(m).reduce((D, F) => ((D[F.name] = F.value), D), {})
                                                    : { ...m },
                                                f,
                                                w,
                                                g,
...
`) !== -1 && (M = m.spacingOuter + _ + M + m.spacingOuter + f),
                                        (M = `{${M}}`)),
                                    `${m.spacingInner + f + P.prop.open + D + P.prop.close}=${P.value.open}${M}${
                                        P.value.close
                                    }`
                                );
                            })
                    ...
                    var c = (d, h, m, f, w) => {
                        let g = f.colors.tag;
                        return `${g.open}<${d}${h && g.close + h + f.spacingOuter + w + g.open}${
                            m ? `>${g.close}${m}${f.spacingOuter}${w}${g.open}</${d}` : `${h && !f.min ? '' : ' '}/`
                        }>${g.close}`;
                    };
                    e.printElement = c;
                    var p = (d, h) => {
                    ...
                    var P = (T, L, V, J, Q, X) => {
                        ...
                        D = (T, L, V, J, Q, X) => {
                            ...
                            return ++J > L.maxDepth
                                ...
                                : T[o]
                                ? `${x + w}{${
                                      T._iter || T._object ? (0, t.printIteratorEntries)(T.entries(), L, V, J, Q, X) : g
                                  }}`
                                : `${x + w}[${
                                      T._iter || T._array || T._collection || T._iterable
                                          ? (0, t.printIteratorValues)(T.values(), L, V, J, Q, X)
                                          : g
                                  }]`;
                        },
                        F = (T, L, V, J, Q, X, x) =>
                    ...
                    function V(I, Y, te, ue, re, k) {
                        ...
                        return Re === '[object Arguments]'
                            ...
                            ? le
                                ? `[${I.constructor.name}]`
                                : `${
                                      me || (!Y.printBasicPrototype && I.constructor.name === 'Array')
                                          ? ''
                                          : `${I.constructor.name} `
                                  }[${(0, r.printListItems)(I, Y, te, ue, re, x)}]`
                            : Re === '[object Map]'
                            ? le
                                ? '[Map]'
                            ...
                            : le || A(I)
                            ? `[${g(I)}]`
                            : `${me || (!Y.printBasicPrototype && g(I) === 'Object') ? '' : `${g(I)} `}{${(0,
                              r.printObjectProperties)(I, Y, te, ue, re, x)}}`;
                    }
                    function J(I) {
