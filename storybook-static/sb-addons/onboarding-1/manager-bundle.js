try {
    (() => {
        ...
        function A(e) {
            ...
            return A.array(e) ? 'Array' : A.plainFunction(e) ? 'Function' : Tr(e) || 'Object';
        }
        function Xu(...e) {
        ...
        function qi(e, t, n) {
            ...
            return I.undefined(r) || (l = l && c === r), I.undefined(i) || (l = l && s === i), l;
        }
        function $i(e, t, n) {
            ...
            return [a, s].every(I.array)
                ...
                : ![a, s].every((u) => I.primitive(u) && I.defined(u)) &&
                  (o === 'added' ? !I.defined(a) && I.defined(s) : I.defined(a) && !I.defined(s));
        }
        function Ki(e, t, { key: n } = {}) {
            ...
            return [r, o].every(I.plainObject) && ((r = Object.keys(r)), (o = Object.keys(o))), [r, o];
        }
        function Xi(e) {
            return ([t, n]) =>
                I.array(e)
        ...
        function Qi(e) {
            return (t) => (I.array(e) ? e.some((n) => Pe(n, t) || (I.array(t) && zo(t)(n))) : Pe(e, t));
        }
        function sn(e, t) {
            ...
            return {
                ...
                changed: (n, r, o) => {
                    try {
                        ...
                        return [i, a].every(I.array) || [i, a].every(I.plainObject) ? !Pe(i, a) : i !== a;
                    } catch {
                        return !1;
                    }
                },
                ...
                decreased: (n, r, o) => {
                    if (!I.defined(n)) return !1;
                    try {
                        return qi(e, t, { key: n, actual: r, previous: o, type: 'decreased' });
                    } catch {
                        return !1;
                    }
                },
                ...
                increased: (n, r, o) => {
                    if (!I.defined(n)) return !1;
                    try {
                        return qi(e, t, { key: n, actual: r, previous: o, type: 'increased' });
                    } catch {
                        return !1;
                    }
                },
        ...
        function qt(e) {
            ...
            for (var t = en(10) ? document.body : null, n = e.offsetParent || null; n === t && e.nextElementSibling; )
            ...
            return !r || r === 'BODY' || r === 'HTML'
                ...
                : ['TH', 'TD', 'TABLE'].indexOf(n.nodeName) !== -1 && Dt(n, 'position') === 'static'
                ? qt(n)
                : n;
        }
        function sd(e) {
        ...
        function Wo(e, t) {
            ...
            var d = bt({ top: i.top - a.top - l, left: i.left - a.left - u, width: i.width, height: i.height });
            ...
            return (r && !n ? t.contains(s) : t === s && s.nodeName !== 'BODY') && (d = ld(d, t)), d;
        }
        function dd(e) {
        ...
        function tl(e) {
            ...
            for (var t = e.parentElement; t && Dt(t, 'transform') === 'none'; ) t = t.parentElement;
        ...
        function Ho(e, t, n, r) {
            ...
            if (r === 'viewport') i = dd(a, o);
                ...
                var s = void 0;
                r === 'scrollParent'
                    ? ((s = Cn(Uo(t))), s.nodeName === 'BODY' && (s = e.ownerDocument.documentElement))
                    : r === 'window'
        ...
        function il(e, t, n) {
            ...
            var r = ol(e),
                ...
                c = i ? 'height' : 'width',
                l = i ? 'width' : 'height';
            return (o[a] = t[a] + t[c] / 2 - r[c] / 2), n === s ? (o[s] = t[s] - r[l]) : (o[s] = t[ur(s)]), o;
        }
        function An(e, t) {
        ...
        function fd() {
            if (!this.state.isDestroyed) {
                ...
                (e.offsets.reference = rl(this.state, this.popper, this.reference, this.options.positionFixed)),
                    (e.placement = nl(
                    ...
                    (e.offsets.popper = il(this.popper, e.offsets.reference, e.placement)),
        ...
        function cl(e, t, n, r) {
            ...
            i.addEventListener(t, n, { passive: !0 }), o || cl(Cn(i.parentNode), t, n, r), r.push(i);
        }
        function gd(e, t, n, r) {
            (n.updateBound = r), ll(e).addEventListener('resize', n.updateBound, { passive: !0 });
            var o = Cn(e);
            return cl(o, 'scroll', n.updateBound, n.scrollParents), (n.scrollElement = o), (n.eventsEnabled = !0), n;
        }
        function yd() {
            this.state.eventsEnabled ||
                (this.state = gd(this.reference, this.options, this.state, this.scheduleUpdate));
        }
        function vd(e, t) {
            return (
        ...
        function bd() {
            this.state.eventsEnabled &&
                (cancelAnimationFrame(this.scheduleUpdate), (this.state = vd(this.reference, this.state)));
        }
        function Go(e) {
        ...
        function go(e, t) {
            Object.keys(t).forEach(function (n) {
                var r = '';
                ['width', 'height', 'top', 'right', 'bottom', 'left'].indexOf(n) !== -1 && Go(t[n]) && (r = 'px'),
                    (e.style[n] = t[n] + r);
            });
        }
        function xd(e, t) {
        ...
        function wd(e) {
            return (
                ...
                e.arrowElement && Object.keys(e.arrowStyles).length && go(e.arrowElement, e.arrowStyles),
                e
            );
        }
        function Ed(e, t, n, r, o) {
            var i = rl(o, t, e, n.positionFixed),
                a = nl(n.placement, i, t, e, n.modifiers.flip.boundariesElement, n.modifiers.flip.padding);
            return t.setAttribute('x-placement', a), go(t, { position: n.positionFixed ? 'fixed' : 'absolute' }), n;
        }
        function Td(e, t) {
            var n = e.offsets,
                r = n.popper,
        ...
        function Od(e, t) {
            ...
            return (
                ...
                (e.arrowElement = r),
                (e.offsets.arrow = ((n = {}), Kt(n, d, Math.round(y)), Kt(n, p, ''), n)),
                e
            );
        }
        function Cd(e) {
        ...
        function Ad(e, t) {
            if (sl(e.instance.modifiers, 'inner') || (e.flipped && e.placement === e.originalPlacement)) return e;
            var n = Ho(e.instance.popper, e.instance.reference, t.padding, t.boundariesElement, e.positionFixed),
            ...
            return (
                a.forEach(function (s, c) {
                    ...
                    var l = e.offsets.popper,
                        ...
                        v = (r === 'left' && h) || (r === 'right' && f) || (r === 'top' && m) || (r === 'bottom' && x),
        ...
        function Dd(e, t) {
            ...
            var r = Yo('transform'),
                ...
                s = o[r];
            (o.top = ''), (o.left = ''), (o[r] = '');
            var c = Ho(e.instance.popper, e.instance.reference, t.padding, n, e.positionFixed);
            ...
            var l = t.priority,
                ...
                d = {
                    primary: function (p) {
                        var h = u[p];
                        return u[p] < c[p] && !t.escapeWithReference && (h = Math.max(u[p], c[p])), Kt({}, p, h);
                    },
                    secondary: function (p) {
                        ...
                        return (
                            u[p] > c[p] &&
                                ...
                                (f = Math.min(u[h], c[p] - (p === 'right' ? u.width : u.height))),
                            Kt({}, h, f)
                        );
                    },
                };
        ...
        function aa(e, t, n) {
            ...
            return L.undefined(r) || (l = l && c === r), L.undefined(i) || (l = l && s === i), l;
        }
        function sa(e, t, n) {
            var r = n.key,
                o = n.type,
            ...
            return [a, s].every(L.array)
                ...
                : ![a, s].every(function (u) {
                  ...
                  }) && (o === 'added' ? !L.defined(a) && L.defined(s) : L.defined(a) && !L.defined(s));
        }
        function la(e, t, n) {
            var r = n === void 0 ? {} : n,
                o = r.key,
            ...
            return [i, a].every(L.plainObject) && ((i = Object.keys(i)), (a = Object.keys(a))), [i, a];
        }
        function ca(e) {
            return function (t) {
                var n = t[0],
        ...
        function hl() {
            for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
            return e.every(L.array) || e.every(L.number) || e.every(L.plainObject) || e.every(L.string);
        }
        function Ke(e, t) {
        ...
        function ep(e, t) {
            if ([e, t].some(L.nullOrUndefined)) throw new Error('Missing required parameters');
            if (
            ...
            var n = function (d, p) {
                ...
                r = function (d, p, h) {
                    try {
                        ...
                        return [f, m].every(L.array) || [f, m].every(L.plainObject) ? !Oe(f, m) : f !== m;
                    } catch {
                        return !1;
                    }
                },
                ...
                i = function (d, p) {
                    return L.defined(d)
                        ? (console.warn('`changedTo` is deprecated! Replace it with `change`'), r(d, p))
                        : !1;
                },
                a = function (d, p, h) {
                    if (!L.defined(d)) return !1;
                    try {
                        return aa(e, t, { key: d, actual: p, previous: h, type: 'decreased' });
                    } catch {
                        return !1;
                    }
                },
                ...
                l = function (d, p, h) {
                    if (!L.defined(d)) return !1;
                    try {
                        return aa(e, t, { key: d, actual: p, previous: h, type: 'increased' });
                    } catch {
                        return !1;
                    }
                },
            ...
            a &&
                ...
                Array.isArray(n)
                    ? n.forEach(function (c) {
                          L.plainObject(c) && c.key ? s.apply(console, [c.key, c.value]) : s.apply(console, [c]);
                      })
                    : s.apply(console, [n]),
                console.groupEnd());
        }
            ...
            var t = e.content,
                ...
                l = {
                    content: g.isValidElement(t)
                        ? t
                        : g.createElement('div', { className: '__floater__content', style: c.content }, t),
                };
            return (
                s &&
                    (l.title = g.isValidElement(s)
                        ? s
                        : g.createElement('div', { className: '__floater__title', style: c.title }, s)),
                n &&
                    (l.footer = g.isValidElement(n)
                        ? n
                        : g.createElement('div', { className: '__floater__footer', style: c.footer }, n)),
                (a || i) && !L.boolean(o) && (l.close = g.createElement(vl, { styles: c.close, handleClick: r })),
                g.createElement(
                    'div',
        ...
        function Or(e, t, n) {
            ...
            if (r) {
                ...
                if (!(r.scrollHeight > r.offsetHeight) && !t) return (r.style.overflow = 'initial'), At();
            }
            return r;
        }
        function Dn(e, t) {
        ...
        function Cp(e, t, n) {
            ...
            return (
                i instanceof HTMLElement &&
                    ((s = i.scrollTop), !a && !En(e) && (c += s), i.isSameNode(At()) || (c += At().scrollTop)),
                Math.floor(c - t)
            );
        }
        function Ap(e, t, n) {
            var r;
            if (!e) return 0;
            let { offsetTop: o = 0, scrollTop: i = 0 } = (r = (0, Ks.default)(e)) != null ? r : {},
            ...
            t &&
                (n && e
                    ? (console.groupCollapsed(
                      ...
                      Array.isArray(e)
                          ? e.forEach((i) => {
                                I.plainObject(i) && i.key ? o.apply(console, [i.key, i.value]) : o.apply(console, [i]);
                            })
                          : o.apply(console, [e]),
                      console.groupEnd())
        ...
        function Mp(e) {
            let { isFirstStep: t, lifecycle: n, previousLifecycle: r, scrollToFirstStep: o, step: i, target: a } = e;
            return (
                !i.disableScrolling &&
                (!t || o || n === _.TOOLTIP) &&
                i.placement !== 'center' &&
        ...
        function jp(e, t) {
            ...
            window.innerWidth > 480 && (u = 380),
                'width' in l &&
                    (u = typeof l.width == 'number' && window.innerWidth < l.width ? window.innerWidth - 30 : l.width);
            let d = {
                    bottom: 0,
                    left: 0,
                    overflow: 'hidden',
                ...
                p = {
                    ...
                    buttonNext: { ...dn, backgroundColor: l.primaryColor, borderRadius: 4, color: '#fff' },
                    buttonBack: { ...dn, color: l.primaryColor, marginLeft: 'auto', marginRight: 5 },
                    buttonClose: {
                        ...dn,
                        color: l.textColor,
                        height: 14,
                    ...
                    overlay: { ...d, backgroundColor: l.overlayColor, mixBlendMode: 'hard-light' },
                    overlayLegacy: { ...d },
                    overlayLegacyCenter: { ...d, backgroundColor: l.overlayColor },
                    spotlight: { ...ya, backgroundColor: 'gray' },
                    spotlightLegacy: { ...ya, boxShadow: `0 0 0 9999px ${l.overlayColor}, ${l.spotlightShadow}` },
                    floaterStyles: {
                        arrow: {
                            color:
                                (i = (o = (r = a?.styles) == null ? void 0 : r.arrow) == null ? void 0 : o.color) !=
                                null
                                    ? i
                                    : l.arrowColor,
                        },
        ...
        function pn(e, t) {
            var n, r, o, i, a, s;
            let c = e ?? {},
                l = Hn.default.all([Lp, Vp(t), c], { isMergeableObject: I.plainObject }),
                u = jp(t, l),
                d = Dn(yt(l.target), l.disableScrollParentFix),
                p = Hn.default.all([Dp, (n = t.floaterProps) != null ? n : {}, (r = l.floaterProps) != null ? r : {}]);
            return (
                (p.offset = l.offset),
                (p.styles = (0, Hn.default)((o = p.styles) != null ? o : {}, u.floaterStyles)),
                (p.offset += (a = (i = t.spotlightPadding) != null ? i : l.spotlightPadding) != null ? a : 0),
                l.placementBeacon && p.wrapperOptions && (p.wrapperOptions.placement = l.placementBeacon),
                d && p.options.preventOverflow && (p.options.preventOverflow.boundariesElement = 'window'),
                {
                    ...l,
                    locale: Hn.default.all([Sl, (s = t.locale) != null ? s : {}, l.locale || {}]),
                    floaterProps: p,
        ...
        function Pl(e, t = !1) {
            return I.plainObject(e)
                ? e.target
                    ? !0
                    : (xt({ title: 'validateStep', data: 'target is missing from the step', warn: !0, debug: t }), !1)
                : (xt({ title: 'validateStep', data: 'step must be an object', warn: !0, debug: t }), !1);
        }
        function va(e, t = !1) {
            return I.array(e)
                ? e.every((n) => Pl(n, t))
                : (xt({ title: 'validateSteps', data: 'steps must be an array', warn: !0, debug: t }), !1);
        }
        function _p(e) {
            return new Bp(e);
        }
        ...
        function Kp(e) {
            let {
                ...
                N = { primary: E };
            return (
                r && ((N.primary = i ? j : D), x && (N.primary = O('span', null, N.primary, ' (', o + 1, '/', s, ')'))),
                v &&
                    !i &&
                    (N.skip = O(
                        'button',
                ...
                !p &&
                    ...
                    (N.back = O(
                        'button',
                        { 'data-test-id': 'button-back', style: b.buttonBack, type: 'button', ...t },
                        w,
                    )),
                (N.close = !h && O($p, { 'data-test-id': 'button-close', styles: b.buttonClose, ...n })),
                O(
                    'div',
                    {
                        key: 'JoyrideTooltip',
                    ...
                    !f &&
                        O(
                            ...
                            O(
                                'button',
                                { 'data-test-id': 'button-primary', style: b.buttonNext, type: 'button', ...a },
                                N.primary,
                            ),
                        ),
                    N.close,
      ...
      `,
                        ...
                        (r.id = 'sb-onboarding-pulsating-effect'), (r.innerHTML = n), document.head.appendChild(r);
                    }
                    return () => {
        ...
        function Yr(e) {
            let t = {},
                n = {},
                r = {},
                o = [...Object.keys(Ko), 'confettiSource', 'drawShape', 'onConfettiComplete'],
                i = ['canvasRef'];
            for (let a in e) {
                let s = e[a];
        ...
        function Al({
            ...
            colors: o = ['#CA90FF', '#FC521F', '#66BF3C', '#FF4785', '#FFAE00', '#1EA7FD'],
            ...i
        }) {
            let [a] = ne(() => {
        ...
        function Dh({ api: e, isFinalStep: t, onFirstTourDone: n, onLastTourDone: r, codeSnippets: o }) {
            let [i, a] = ne(),
                s = _r();
            U(() => {
                e.once(ki, () => {
                    ...
                    : [
                          ...
                          },
                          {
                              ...
                              content: g.createElement(
                                  ...
                                  g.createElement(Al, { numberOfPieces: 800, recycle: !1, tweenDuration: 2e4 }),
                              ),
                              placement: 'right',
        ...
        function Jh(e, t = globalThis?.document) {
            ...
            return (
                U(() => {
                    let o = (i) => {
                        i.target && !r.current && Il(Kh, n, { originalEvent: i }, { discrete: !1 });
                    };
        ...
        function Il(e, t, n, { discrete: r }) {
            ...
            t && o.addEventListener(e, t, { once: !0 }), r ? Gh(o, i) : o.dispatchEvent(i);
        }
        function tf(e, { select: t = !1 } = {}) {
            let n = document.activeElement;
            for (let r of e) if ((pt(r, { select: t }), document.activeElement !== n)) return;
        }
        function nf(e) {
            let t = kl(e),
                n = Ta(t, e),
        ...
        function df() {
            U(() => {
                ...
                return (
                    ...
                    Xr++,
                    () => {
                        Xr === 1 && document.querySelectorAll('[data-radix-focus-guard]').forEach((r) => r.remove()),
                            Xr--;
                    }
                );
            }, []);
        ...
        function Wf(e) {
                ...
                U(
                    function () {
                        if (e.inert) {
                            ...
                            var m = pf([e.lockRef.current], (e.shards || []).map(Ia), !0).filter(Boolean);
                            return (
            ...
            var s = ye(function (m, x) {
                    if ('touches' in m && m.touches.length === 2) return !a.current.allowPinchZoom;
                    var v = $n(m),
                        b = n.current,
                    ...
                    var P = Aa(D, j);
                    if (!P) return !0;
                    if ((P ? (E = D) : ((E = D === 'v' ? 'h' : 'v'), (P = Aa(D, j))), !P)) return !1;
                    if ((!r.current && 'changedTouches' in m && (y || w) && (r.current = E), !E)) return !0;
                    var N = r.current || E;
                    ...
                    if (!(!zt.length || zt[zt.length - 1] !== i)) {
                        var v = 'deltaY' in x ? Ra(x) : $n(x),
                            b = t.current.filter(function (E) {
                                return E.name === x.type && E.target === x.target && _f(E.delta, v);
                            })[0];
                        if (b && b.should) {
            ...
            var h = e.removeScrollBar,
                f = e.inert;
            return O(dt, null, f ? O(i, { styles: zf(o) }) : null, h ? O(Mf, { gapMode: 'margin' }) : null);
        }
        function ql(e) {
        ...
        function wm() {
            return g.createElement(
                ...
                g.createElement(
                    ...
                    g.createElement('use', { fill: '#FF4785', fillRule: 'nonzero', xlinkHref: '#path-1' }),
                    g.createElement('path', {
        ...
        function Fm(e) {
            ...
            let [a, s] = ne({ left: 0, top: 0, width: 0, height: 0, bottom: 0, right: 0, x: 0, y: 0 }),
                c = ee({ element: null, scrollContainers: null, resizeObserver: null, lastBounds: a }),
            ...
            let [p, h, f] = Se(() => {
                let b = () => {
                    ...
                    let {
                        ...
                        le = { left: y, top: w, width: E, height: j, bottom: D, right: P, x: N, y: te };
                    c.current.element instanceof HTMLElement &&
                        o &&
                        ((le.height = c.current.element.offsetHeight), (le.width = c.current.element.offsetWidth)),
                        Object.freeze(le),
                        d.current && !_m(c.current.lastBounds, le) && s((c.current.lastBounds = le));
                };
                return [b, u ? (0, ka.default)(b, u) : b, l ? (0, ka.default)(b, l) : b];
            }, [s, o, l, u]);
            function m() {
                c.current.scrollContainers &&
                    (c.current.scrollContainers.forEach((b) => b.removeEventListener('scroll', f, !0)),
            ...
            let v = (b) => {
                !b ||
                    b === c.current.element ||
                    (m(), (c.current.element = b), (c.current.scrollContainers = Kl(b)), x());
            };
            return (
                Vm(f, !!n),
                jm(h),
        ...
        function Kl(e) {
            ...
            let { overflow: n, overflowX: r, overflowY: o } = window.getComputedStyle(e);
            return [n, r, o].some((i) => i === 'auto' || i === 'scroll') && t.push(e), [...t, ...Kl(e.parentElement)];
        }
        function Wm(e) {
            let t = new Ma(),
                n = new Ma(),
        ...
        function ec(e, t) {
            let n = !1,
                ...
                s = () => {
                    ...
                    (n = !1),
                        (o.delta = r ? 1e3 / 60 : Math.max(Math.min(l - o.timestamp, Hm), 1)),
                        (o.timestamp = l),
                        (o.isProcessing = !0),
                        Qn.forEach(a),
                        (o.isProcessing = !1),
            ...
            return {
                schedule: Qn.reduce((l, u) => {
                    let d = i[u];
                    return (l[u] = (p, h = !1, f = !1) => (n || c(), d.schedule(p, h, f))), l;
                }, {}),
        ...
        function Ym(e, t, n, r) {
            ...
            return (
                zm(() => {
                    l && (Jo.postRender(l.render), u.current && l.animationState && l.animationState.animateChanges());
                }),
                U(() => {
                    l &&
                        (l.updateFeatures(),
        ...
        function qm(e, t) {
            if (Mr(e)) {
                ...
                return { initial: n === !1 || Tn(n) ? n : void 0, animate: Tn(r) ? r : void 0 };
            }
        ...
        function Qm({ preloadedFeatures: e, createVisualElement: t, useRender: n, useVisualState: r, Component: o }) {
            e && Km(e);
            function i(s, c) {
                let l,
                ...
                return O(
                    Rr.Provider,
                    { value: p },
                    l && p.visualElement ? O(l, { visualElement: p.visualElement, ...u }) : null,
        ...
        function ni(e) {
            return typeof e != 'string' || e.includes('-') ? !1 : !!(eg.indexOf(e) > -1 || /[A-Z]/.test(e));
        }
        function tg(e) {
            Object.assign(hr, e);
        }
        function oc(e, { layout: t, layoutId: n }) {
            return Nt.has(e) || e.startsWith('origin') || ((t || n !== void 0) && (!!hr[e] || e === 'opacity'));
        }
        function og(e, { enableHardwareAcceleration: t = !0, allowTransformNone: n = !0 }, r, o) {
            let i = '';
            for (let a = 0; a < rg; a++) {
                let s = Nn[a];
                if (e[s] !== void 0) {
        ...
        function oi(e, t, n, r) {
            ...
            if (
                (t.transform ||
                    (c || r ? (o.transform = og(e.transform, n, u, r)) : o.transform && (o.transform = 'none')),
                l)
            ) {
        ...
        function pg({ transformTemplate: e }, t, n) {
            return Se(() => {
                let r = ii();
                return oi(r, t, { enableHardwareAcceleration: !n }, e), Object.assign({}, r.vars, r.style);
            }, [t]);
        }
        function hg(e, t, n) {
            let r = e.style || {},
        ...
        function yg(e, t, n) {
            ...
            for (let o in e)
                (o === 'values' && typeof e.values == 'object') ||
                    ((cc(o) || (n === !0 && mr(o)) || (!t && !mr(o)) || (e.draggable && o.startsWith('onDrag'))) &&
                        (r[o] = e[o]));
            return r;
        }
        function ja(e, t, n) {
        ...
        function ai(
            ...
            h.transform && (m && (f.transform = h.transform), delete h.transform),
                m &&
                    ...
                    (f.transformOrigin = vg(m, o !== void 0 ? o : 0.5, i !== void 0 ? i : 0.5)),
                t !== void 0 && (h.x = t),
                n !== void 0 && (h.y = n),
                r !== void 0 && (h.scale = r),
        ...
        function Eg(e, t, n, r) {
            let o = Se(() => {
                let i = uc();
                return (
                    ai(i, t, { enableHardwareAcceleration: !1 }, si(r), e.transformTemplate),
        ...
        function li(e, t) {
            let { style: n } = e,
                r = {};
            for (let o in n) (Ce(n[o]) || (t.style && Ce(t.style[o])) || oc(o, e)) && (r[o] = n[o]);
            return r;
        }
        function fc(e, t) {
            let n = li(e, t);
            for (let r in e)
                if (Ce(e[r]) || Ce(t[r])) {
                    let o = Nn.indexOf(r) !== -1 ? 'attr' + r.charAt(0).toUpperCase() + r.substring(1) : r;
                    n[o] = e[r];
                }
            return n;
        }
        ...
        function Cg({ scrapeMotionValuesFromProps: e, createRenderState: t, onMount: n }, r, o, i) {
        ...
        function Ag(e, t, n, r) {
            ...
            let { initial: a, animate: s } = e,
                c = Mr(e),
                l = tc(e);
            t && l && !c && e.inherit !== !1 && (a === void 0 && (a = t.initial), s === void 0 && (s = t.animate));
        ...
        function Bg({ root: e, ...t }) {
            ...
            let r = ro.get(n),
                o = JSON.stringify(t);
            return r[o] || (r[o] = new IntersectionObserver(Vg, { root: e, ...t })), r[o];
        }
        function _g(e, t, n) {
            let r = Bg(t);
            return (
        ...
        function Tc(e) {
            return !!(!e || (typeof e == 'string' && Sc[e]) || Ec(e) || (Array.isArray(e) && e.every(Tc)));
        }
        function Pc(e) {
        ...
        function $g(
            ...
            t,
            n,
            { delay: r = 0, duration: o, repeat: i = 0, repeatType: a = 'loop', ease: s, times: c } = {},
        ) {
            let l = { [t]: n };
            c && (l.offset = c);
            let u = Pc(s);
        ...
        function Zg(e, t, n, r, o) {
            let i,
                a,
                s = 0;
            do (a = t + (n - t) / 2), (i = Oc(a, r, o) - e), i > 0 ? (n = a) : (t = a);
        ...
        function Wa(e) {
            let t = cy(e);
            ze(!!t, `'${e}' is not an animatable color. Use the equivalent color code instead.`);
            let n = t.parse(e);
        ...
        function uy(e) {
            ...
            return (
                isNaN(e) &&
                Fn(e) &&
                (((t = e.match(ri)) === null || t === void 0 ? void 0 : t.length) || 0) +
                    (((n = e.match(lg)) === null || n === void 0 ? void 0 : n.length) || 0) >
                    0
            );
        }
        function yr(e) {
        ...
        function Fc(e) {
            ...
            return (o) => {
                ...
                for (let a = 0; a < r; a++)
                    if (((i += t[a]), o[a] !== void 0)) {
                        let s = n[a];
                        s === Dc ? (i += bn(o[a])) : s === Lc ? (i += we.transform(o[a])) : (i += o[a]);
                    }
                return i;
            };
        }
        ...
        function gy(e, t) {
            let n = { ...e, ...t },
                r = {};
            for (let o in n) e[o] !== void 0 && t[o] !== void 0 && (r[o] = hi(e[o])(e[o], t[o]));
            return (o) => {
        ...
        function Vc(e, t, n) {
            return typeof e == 'number' && typeof t == 'number' && typeof n == 'number' ? oe(e, t, n) : hi(e)(e, t);
        }
        function by(e, t, n) {
            let r = [],
                o = n || Vc,
        ...
        function vr({ duration: e = 300, keyframes: t, times: n, ease: r = 'easeInOut' }) {
            let o = ty(r) ? r.map(Ua) : Ua(r),
                i = { done: !1, value: t[0] },
                a = Ty(n && n.length === t.length ? n : Ey(t), e),
                s = xy(a, t, { ease: Array.isArray(o) ? o : Sy(t, o) });
            return { calculatedDuration: e, next: (c) => ((i.value = s(c)), (i.done = c >= e), i) };
        }
        function Bc(e, t) {
            return t ? e * (1e3 / t) : 0;
        }
        ...
        function Ry({ duration: e = 800, bounce: t = 0.25, velocity: n = 0, mass: r = 1 }) {
            let o, i;
            ...
            let s = 5 / e,
                c = ky(o, i, s);
            if (((e = vt(e)), isNaN(c))) return { stiffness: 100, damping: 10, duration: e };
            {
        ...
        function zc({ keyframes: e, restDelta: t, restSpeed: n, ...r }) {
            ...
            if (f < 1) {
                ...
                b = (w) => {
                    ...
                    return i - E * (((h + f * x * m) / y) * Math.sin(y * w) + m * Math.cos(y * w));
                };
            } else if (f === 1) b = (y) => i - Math.exp(-x * y) * (m + (h + x * m) * y);
            else {
                let y = x * Math.sqrt(f * f - 1);
                b = (w) => {
                    let E = Math.exp(-f * x * w),
                        j = Math.min(y * w, 300);
                    return i - (E * ((h + f * x * m) * Math.sinh(j) + y * m * Math.cosh(j))) / y;
                };
            }
            return {
        ...
        function Ka({
            ...
            let d = e[0],
                ...
                f = (P) => (s === void 0 ? c : c === void 0 || Math.abs(s - P) < Math.abs(c - P) ? s : c),
                m = n * t,
                x = d + m,
                v = a === void 0 ? x : a(x);
            v !== x && (m = v - d);
        ...
        function br({
            ...
            let E = y({ ...p, keyframes: r }),
                j;
            s === 'mirror' && (j = y({ ...p, keyframes: [...r].reverse(), velocity: -(p.velocity || 0) }));
            let D = 'idle',
                P = null,
                N = null,
                te = null;
                ...
                ae = (J) => {
                    ...
                    if (i) {
                        ...
                        !$ && z >= 1 && ($ = 1),
                            $ === 1 && q--,
                            (q = Math.min(q, i + 1)),
                            q % 2 && (s === 'reverse' ? (($ = 1 - $), a && ($ -= a / Me)) : s === 'mirror' && (W = j)),
                            (Y = wt(0, 1, $) * Me);
                    }
            ...
            let Ft = {
                ...
                set time(J) {
                    (J = vt(J)), (fe = J), P !== null || !b || h === 0 ? (P = J) : (N = b.now() - J / h);
                },
                get duration() {
        ...
        function Hy(e, t, { onUpdate: n, onComplete: r, ...o }) {
            ...
            if (Wy(t, o)) {
                let v = br({ ...o, repeat: 0, delay: 0 }),
                    ...
                    y = [],
                    w = 0;
                for (; !b.done && w < Uy; ) (b = v.sample(w)), y.push(b.value), (w += Jn);
                (h = void 0), (u = y), (d = w - Jn), (p = 'linear');
            }
            let f = $g(e.owner.current, t, u, { ...o, duration: d, ease: p, times: h }),
                m = () => {
                    (c = !1), f.cancel();
                },
                x = () => {
        ...
        function Yy({ keyframes: e, delay: t, onUpdate: n, onComplete: r }) {
            ...
            return t ? br({ keyframes: [0, 1], duration: 0, delay: t, onComplete: o }) : o();
        }
        function Zy(e) {
        ...
        function Uc(e, t) {
            let n = fi(e);
            return n !== ko && (n = Et), n.getAnimatableNone ? n.getAnimatableNone(t) : void 0;
        }
        function tv(e) {
        ...
        function nv(e, t, n, r) {
            ...
            for (let l = 0; l < i.length; l++)
                i[l] === null && (i[l] = l === 0 ? a : i[l - 1]),
                    tv(i[l]) && c.push(l),
                    typeof i[l] == 'string' && i[l] !== 'none' && i[l] !== '0' && (s = i[l]);
            if (o && c.length && s)
        ...
        function uv(e, t) {
            let n = Lr(e, t),
                { transitionEnd: r = {}, transition: o = {}, ...i } = n ? e.makeTargetAnimatable(n, !1) : {};
            i = { ...i, ...r };
            for (let a in i) {
                let s = Og(i[a]);
                cv(e, a, s);
            ...
            if (a)
                for (let s = 0; s < a; s++) {
                    ...
                    Array.isArray(l) && (u = l[0]),
                        u === null &&
                            (u =
                                (o = (r = n[c]) !== null && r !== void 0 ? r : e.readValue(c)) !== null && o !== void 0
                                    ? o
                                    : t[c]),
                        u != null &&
        ...
        function qc(e, t, { delay: n = 0, transitionOverride: r, type: o } = {}) {
            ...
            for (let d in s) {
                ...
                if ((f.type === 'spring' && (p.getVelocity() || f.velocity) && (m = !1), p.animation && (m = !1), m))
                    continue;
                p.start(gi(d, p, h, e.shouldReduceMotion && Nt.has(d) ? { type: !1 } : f));
                let x = p.animation;
            ...
            let i = r ? () => Promise.all(qc(e, r, n)) : () => Promise.resolve(),
                a =
                    e.variantChildren && e.variantChildren.size
                        ? (c = 0) => {
                              let { delayChildren: l = 0, staggerChildren: u, staggerDirection: d } = o;
                ...
                Array.from(e.variantChildren)
                    ...
                    .forEach((l, u) => {
                        l.notify('AnimationStart', t),
                            a.push(Mo(l, t, { ...i, delay: n + c(u) }).then(() => l.notify('AnimationComplete', t)));
                    }),
                Promise.all(a)
            );
        }
        ...
        function wv(e) {
            return (t) => Promise.all(t.map(({ animation: n, options: r }) => vv(e, n, r)));
        }
        function Ev(e) {
            let t = wv(e),
                n = Sv(),
            ...
            function a(c, l) {
                ...
                for (let v = 0; v < xv; v++) {
                    ...
                    if (
                        ...
                        (y.protectedKeys = { ...f }),
                        (!y.isActive && j === null) || (!w && !y.prevProp) || kr(w) || typeof w == 'boolean')
                    )
                        continue;
                    let P = Tv(y.prevProp, w) || (b === l && y.isActive && !D && E) || (v > m && E),
                        N = !1,
                    ...
                    let { prevResolvedValues: Me = {} } = y,
                        Re = { ...Me, ...le },
                        fe = (ae) => {
                            (P = !0), h.has(ae) && ((N = !0), h.delete(ae)), (y.needsAnimating[ae] = !0);
                        };
                    for (let ae in Re) {
                        let Te = le[ae],
                            He = Me[ae];
                    ...
                    (y.prevProp = w),
                        ...
                        P && (!D || N) && p.push(...te.map((ae) => ({ animation: ae, options: { type: b, ...c } })));
                }
                if (h.size) {
                    let v = {};
                    h.forEach((b) => {
                ...
                let x = !!p.length;
                return (
                    r && (u.initial === !1 || u.initial === u.animate) && !e.manuallyAnimateOnMount && (x = !1),
                    (r = !1),
            ...
            function s(c, l, u) {
                ...
                (d = e.variantChildren) === null ||
                    ...
                    d.forEach((h) => {
                        var f;
                        return (f = h.animationState) === null || f === void 0 ? void 0 : f.setActive(c, l);
                    }),
                    (n[c].isActive = l);
                let p = a(u, c);
            ...
            return { animateChanges: a, setActive: s, setAnimateFunction: i, getState: () => n };
        }
        function Tv(e, t) {
        ...
        function co({ point: e }, t) {
            return { point: e, delta: es(e, Kc(t)), offset: es(e, Iv(t)), velocity: kv(t, 0.1) };
        }
        function Iv(e) {
            return e[0];
        }
        ...
        function kv(e, t) {
            ...
            let n = e.length - 1,
                r = null,
                o = Kc(e);
            for (; n >= 0 && ((r = e[n]), !(o.timestamp - r.timestamp > vt(t))); ) n--;
            if (!r) return { x: 0, y: 0 };
        ...
        function Fv(e, t) {
            let n = 0.5,
                r = ke(e),
                o = ke(t);
            return o > r ? (n = Pn(t.min, t.max - r, e.min)) : r > o && (n = Pn(e.min, e.max - o, t.min)), wt(0, 1, n);
        }
        function jv(e, t) {
            let n = {};
        ...
        function Vv(e = Lo) {
            return e === !1 ? (e = 0) : e === !0 && (e = Lo), { x: as(e, 'left', 'right'), y: as(e, 'top', 'bottom') };
        }
        function as(e, t, n) {
        ...
        function Zc(e, { x: t, y: n }) {
            Fo(e.x, t.translate, t.scale, t.originPoint), Fo(e.y, n.translate, n.scale, n.originPoint);
        }
        ...
        function t0(e, t, n, r, o, i) {
            o
                ...
                : i && (e.opacity = oe(t.opacity !== void 0 ? t.opacity : 1, n.opacity !== void 0 ? n.opacity : 1, r));
            for (let a = 0; a < e0; a++) {
                ...
                (c === void 0 && l === void 0) ||
                    ...
                    l || (l = 0),
                    c === 0 || l === 0 || ys(c) === ys(l)
                        ? ((e[s] = Math.max(oe(gs(c), gs(l), r), 0)), (Xe.test(l) || Xe.test(c)) && (e[s] += '%'))
                        : (e[s] = l));
            }
        ...
        function xs(e, t, n, r, o) {
            return (e -= t), (e = wr(e, 1 / n, r)), o !== void 0 && (e = wr(e, 1 / o, r)), e;
        }
        function o0(e, t = 0, n = 1, r = 0.5, o, i = e, a = e) {
            if ((Xe.test(t) && ((t = parseFloat(t)), (t = oe(a.min, a.max, t / 100) - a.min)), typeof t != 'number'))
                return;
            let s = oe(i.min, i.max, r);
            e === i && (s -= t), (e.min = xs(e.min, t, n, s, o)), (e.max = xs(e.max, t, n, s, o));
        }
        function ws(e, t, [n, r, o], i, a) {
            o0(e, t[n], t[r], t[o], t.scale, i, a);
        }
        function Es(e, t, n, r) {
            ws(e.x, t, i0, n ? n.x : void 0, r ? r.x : void 0), ws(e.y, t, a0, n ? n.y : void 0, r ? r.y : void 0);
        }
        function Ts(e) {
            ...
            return class {
                    ...
                    if (
                        ...
                        e(i, () => {
                            (this.root.updateBlockedByResize = !0),
                                u && u(),
                                (u = d0(d, 250)),
                                sr.hasAnimatedSinceResize && ((sr.hasAnimatedSinceResize = !1), this.nodes.forEach(Rs));
                        });
                    }
                    s && this.root.registerSharedNode(s, this),
                        this.options.animate !== !1 &&
                            ...
                            this.addEventListener(
                                'didUpdate',
                                ({ delta: u, hasLayoutChanged: d, hasRelativeTargetChanged: p, layout: h }) => {
                                    if (this.isTreeAnimationBlocked()) {
                                        (this.target = void 0), (this.relativeTarget = void 0);
                                        return;
                                    }
                                    let f = this.options.transition || l.getDefaultTransition() || I0,
                                        { onLayoutAnimationStart: m, onLayoutAnimationComplete: x } = l.getProps(),
                ...
                startUpdate() {
                    this.isUpdateBlocked() ||
                        ((this.isUpdating = !0), this.nodes && this.nodes.forEach(O0), this.animationId++);
                }
                ...
                didUpdate() {
                    this.updateScheduled || ((this.updateScheduled = !0), Jo.read(() => this.update()));
                }
                clearAllSnapshots() {
                ...
                scheduleUpdateProjection() {
                    this.projectionUpdateScheduled ||
                        ((this.projectionUpdateScheduled = !0), ie.preRender(this.updateProjection, !1, !0));
                }
                ...
                removeTransform(i) {
                    ...
                    for (let s = 0; s < this.path.length; s++) {
                        ...
                        let l = pe(),
                            u = c.measurePageBox();
                        De(l, u), Es(a, c.latestValues, c.snapshot ? c.snapshot.layoutBox : void 0, l);
                    }
                ...
                setOptions(i) {
                    this.options = { ...this.options, ...i, crossfade: i.crossfade !== void 0 ? i.crossfade : !0 };
                }
                clearMeasurements() {
                    (this.scroll = void 0),
                        (this.layout = void 0),
                ...
                resolveTargetDelta(i = !1) {
                    ...
                    if (!(!this.layout || !(l || u))) {
                        if (
                            ((this.resolvedRelativeTargetAt = ve.timestamp), !this.targetDelta && !this.relativeTarget)
                        ) {
                            ...
                            d && d.layout && this.animationProgress !== 1
                                ? ((this.relativeParent = d),
                                  ...
                                  wn(this.relativeTargetOrigin, this.layout.layoutBox, d.layout.layoutBox),
                        ...
                        if (!(!this.relativeTarget && !this.targetDelta)) {
                            if (
                                ...
                                this.relativeParent.target
                                    ? (this.forceRelativeParentToResolveTarget(),
                                      Mv(this.target, this.relativeTarget, this.relativeParent.target))
                                    : this.targetDelta
                                    ? (this.resumingFrom
                ...
                getClosestProjectingParent() {
                    if (!(!this.parent || No(this.parent.latestValues) || Qc(this.parent.latestValues)))
                ...
                calcProjection() {
                    ...
                    if (
                        ((this.isProjectionDirty ||
                            ...
                            (c = !1),
                        s && (this.isSharedProjectionDirty || this.isTransformDirty) && (c = !1),
                    ...
                    if (!h) {
                        this.projectionTransform &&
                            ((this.projectionDelta = Yt()), (this.projectionTransform = 'none'), this.scheduleRender());
                        return;
                    }
                    this.projectionDelta || ((this.projectionDelta = Yt()), (this.projectionDeltaWithTransform = Yt()));
                    ...
                    xn(this.projectionDelta, this.layoutCorrected, h, this.latestValues),
                        ...
                        (this.projectionTransform !== f || this.treeScale.x !== d || this.treeScale.y !== p) &&
                            ((this.hasProjected = !0),
                            this.scheduleRender(),
                ...
                setAnimationOrigin(i, a = !1) {
                    ...
                    let d = pe(),
                        ...
                        v = !!(f && !x && this.options.crossfade === !0 && !this.path.some(R0));
                    this.animationProgress = 0;
                    let b;
                    (this.mixTargetDelta = (y) => {
                        ...
                        Is(u.x, i.x, w),
                            ...
                            this.relativeTarget &&
                                ...
                                (wn(d, this.layout.layoutBox, this.relativeParent.layout.layoutBox),
                                A0(this.relativeTarget, this.relativeTargetOrigin, d, w),
                                b && s0(this.relativeTarget, b) && (this.isProjectionDirty = !1),
                                b || (b = pe()),
                                De(b, this.relativeTarget)),
                            f && ((this.animationValues = l), t0(l, c, this.latestValues, w, v, x)),
                ...
                startAnimation(i) {
                    this.notifyListeners('animationStart'),
                        ...
                        this.pendingAnimation && (lt(this.pendingAnimation), (this.pendingAnimation = void 0)),
                ...
                applyTransformsToTarget() {
                    let i = this.getLead(),
                        { targetWithTransforms: a, target: s, layout: c, latestValues: l } = i;
                    if (!(!a || !s || !c)) {
                        if (
                            this !== i &&
                            this.layout &&
                        ...
                        De(a, s), Gt(a, l), xn(this.projectionDeltaWithTransform, this.layoutCorrected, a, l);
                    }
                }
                registerSharedNode(i, a) {
                    this.sharedNodes.has(i) || this.sharedNodes.set(i, new l0()), this.sharedNodes.get(i).add(a);
                    let s = a.options.initialPromotionConfig;
                    a.promote({
                        transition: s ? s.transition : void 0,
                        preserveFollowOpacity:
                            s && s.shouldPreserveFollowOpacity ? s.shouldPreserveFollowOpacity(a) : void 0,
                    });
                }
                isLead() {
                    let i = this.getStack();
                ...
                promote({ needsReset: i, transition: a, preserveFollowOpacity: s } = {}) {
                    let c = this.getStack();
                    c && c.promote(this, s),
                ...
                getProjectionStyles(i) {
                    ...
                    if (!this.projectionDelta || !this.layout || !u.target) {
                        ...
                        return (
                            ...
                            this.hasProjected &&
                                ...
                                ((f.transform = l ? l({}, '') : 'none'), (this.hasProjected = !1)),
                            f
                        );
                    }
                    let d = u.animationValues || u.latestValues;
                    this.applyTransformsToTarget(),
                        (c.transform = Ps(this.projectionDeltaWithTransform, this.treeScale, d)),
                    ...
                    return (
                        this.options.layoutId && (c.pointerEvents = u === this ? ir(i?.pointerEvents) || '' : 'none'), c
                    );
                }
                clearSnapshot() {
        ...
        function v0(e) {
            ...
            if (e.isLead() && e.layout && n && e.hasListeners('didUpdate')) {
                ...
                xn(s, r, n.layoutBox);
                let c = Yt();
                a ? xn(c, e.applyTransform(o, !0), n.measuredBox) : xn(c, r, n.layoutBox);
                let l = !ou(s),
                    u = !1;
                if (!e.resumeFrom) {
                        ...
                        if (p && h) {
                            ...
                            wn(m, r, h.layoutBox),
                                ...
                                d.options.layoutRoot &&
                                    ((e.relativeTarget = m), (e.relativeTargetOrigin = f), (e.relativeParent = d));
                        }
                    }
                }
        ...
        function su(e, t, n) {
            return e === 'position' || (e === 'preserve-aspect' && !Do(Ss(t), Ss(n), 0.2));
        }
        function N0(e) {
            let t = L0.exec(e);
            if (!t) return [,];
        ...
        function $0(e, t, n) {
            ...
            for (let o in t) {
                ...
                else if (Ce(a)) e.addValue(o, Qt(i, { owner: e })), xr(r) && r.remove(o);
                else if (a !== i)
                    if (e.hasValue(o)) {
                        let s = e.getValue(o);
        ...
        function yb() {
            ...
            return (
                U(() => {
                    (async () => {
                        try {
                            let n = (await (await fetch('/index.json')).json()).entries['example-button--primary']
                                .importPath;
                            t({ data: n, error: null });
                        } catch (n) {
                            t({ data: null, error: n });
        ...
        function Ab() {
            ...
            return (
                U(() => {
                    (async () => {
                        try {
                            let n = (await (await fetch('/project.json')).json())?.language === 'javascript' ? Pb : Cb;
                            t({ data: n, error: null });
                        } catch (n) {
                            t({ data: null, error: n });
                        }
                          ...
                          t &&
                              ...
                              g.createElement(Dh, {
                                  ...
                                  onLastTourDone: () => {
                                      ...
                                      e.emit(yn, { step: '6:FinishedOnboarding', type: 'telemetry' }), c();
                                  },
                              }),
                          t &&
                              i === '3:WriteYourStory' &&
        ...
        var bu,
            ...
            fu = Ve(() => {
                ...
                (bu = Object.create),
                    ...
                    (Ae = (e, t) =>
                        function () {
                            return t || (0, e[Bo(e)[0]])((t = { exports: {} }).exports, t), t.exports;
                        }),
                    (Tu = (e, t) => {
                    ...
                    (_s = (e, t, n, r) => {
                        if ((t && typeof t == 'object') || typeof t == 'function')
                            for (let o of Bo(t))
                                !Eu.call(e, o) &&
                                    o !== n &&
                                    Er(e, o, { get: () => t[o], enumerable: !(r = xu(t, o)) || r.enumerable });
                        return e;
                    }),
                    (ct = (e, t, n) => (
                        (n = e != null ? bu(wu(e)) : {}),
                        _s(t || !e || !e.__esModule ? Er(n, 'default', { value: e, enumerable: !0 }) : n, e)
                    )),
                    ...
                    (_o = Ae({
                        '../../node_modules/deepmerge/dist/cjs.js'(e, t) {
                            ...
                            function l(y, w) {
                                return w.clone !== !1 && w.isMergeableObject(y) ? v(c(y), y, w) : y;
                            }
                            function u(y, w, E) {
                            ...
                            function m(y, w) {
                                return (
                                    f(y, w) &&
                                    !(Object.hasOwnProperty.call(y, w) && Object.propertyIsEnumerable.call(y, w))
                                );
                            }
                            function x(y, w, E) {
                                var j = {};
                            ...
                            t.exports = a()
                                ...
                                : function (s, c) {
                                      for (var l, u = i(s), d, p = 1; p < arguments.length; p++) {
                                          ...
                                          if (n) {
                                              d = n(l);
                                              for (var f = 0; f < d.length; f++) o.call(l, d[f]) && (u[d[f]] = l[d[f]]);
                                          }
                                      }
                                      return u;
                                  };
                        ...
                        '../../node_modules/prop-types/factoryWithTypeCheckers.js'(e, t) {
                            ...
                            t.exports = function (l, u) {
                                ...
                                function N(T) {
                                    ...
                                    function k(Y, W, V, K, H) {
                                        for (var z = Y[W], q = 0; q < T.length; q++) if (x(z, T[q])) return null;
                                ...
                                function le(T) {
                                    ...
                                    function W(V, K, H, z, q) {
                                        for (var $ = [], Q = 0; Q < T.length; Q++) {
                                            ...
                                            xe.data && i(xe.data, 'expectedType') && $.push(xe.data.expectedType);
                                        }
                                        var Ze = $.length > 0 ? ', expected one of type [' + $.join(', ') + ']' : '';
                                        return new v(
                                            'Invalid ' + z + ' `' + q + '` supplied to ' + ('`' + H + '`' + Ze + '.'),
                                        );
                                    }
                                    return b(W);
                                }
                                ...
                                function ae(T) {
                                    function k(Y, W, V, K, H) {
                                        ...
                                        for (var Q in $) {
                                            var C = T[Q];
                                            if (i(T, Q) && typeof C != 'function') return Re(V, K, H, Q, je(C));
                                            if (!C)
                                                return new v(
                                                    'Invalid ' +
                                                        K +
...
Valid keys: ` +
                                        ...
                                        case 'object':
                                            ...
                                            if (k) {
                                                var Y = k.call(T),
                                                    W;
                                                if (k !== T.entries) {
                                                    for (; !(W = Y.next()).done; ) if (!Te(W.value)) return !1;
                                                } else
                                                    for (; !(W = Y.next()).done; ) {
                                                        var V = W.value;
                        ...
                        '../../node_modules/tween-functions/index.js'(e, t) {
                            var n = {
                                ...
                                easeInOutQuad: function (r, o, i, a) {
                                    var s = i - o;
                                    return (r /= a / 2) < 1 ? (s / 2) * r * r + o : (-s / 2) * (--r * (r - 2) - 1) + o;
                                },
                                ...
                                easeOutExpo: function (r, o, i, a) {
                                    var s = i - o;
                                    return r == a ? o + s : s * (-Math.pow(2, (-10 * r) / a) + 1) + o;
                                },
                                        ...
                                        r === 0
                                            ...
                                            : (l || (l = a * 0.3),
                                              c < Math.abs(s)
                                                  ? ((c = s), (u = l / 4))
                                                  : (u = (l / (2 * Math.PI)) * Math.asin(s / c)),
                                              c * Math.pow(2, -10 * r) * Math.sin(((r * a - u) * (2 * Math.PI)) / l) +
                                                  s +
                                                  o)
                                    );
                                },
                                ...
                                easeInBack: function (r, o, i, a, s) {
                                    var c = i - o;
                                    return s === void 0 && (s = 1.70158), c * (r /= a) * r * ((s + 1) * r - s) + o;
                                },
                                ...
                                easeOutBounce: function (r, o, i, a) {
                                    ...
                                    return (r /= a) < 0.36363636363636365
                                        ...
                                        : s * (7.5625 * (r -= 0.9545454545454546) * r + 0.984375) + o;
                                },
                                easeInOutBounce: function (r, o, i, a) {
                                    ...
                                    return r < a / 2
                                        ...
                                        : ((c = n.easeOutBounce(r * 2 - a, 0, s, a)), c * 0.5 + s * 0.5 + o);
                                },
                            };
                            t.exports = n;
                        },
                        ...
                        '../../node_modules/debounce/index.js'(e, t) {
                            function n(r, o, i) {
                                ...
                                var p = function () {
                                    ...
                                    var h = i && !a;
                                    return a || (a = setTimeout(d, o)), h && ((u = r.apply(c, s)), (c = s = null)), u;
                                };
                                return (
                                    (p.clear = function () {
                                    ...
                                    (p.flush = function () {
                                        a && ((u = r.apply(c, s)), (c = s = null), clearTimeout(a), (a = null));
                                    }),
                                    p
                                );
                            }
                ...
                (Vu = qs('function')),
                    (Bu = (e) => e === null),
                    (Yi = (e) => Object.prototype.toString.call(e).slice(8, -1) === 'RegExp'),
                ...
                (Yu = [
                    ...
                    (Gu = ['bigint', 'boolean', 'null', 'number', 'string', 'symbol', 'undefined']);
                ...
                (Hn = ct(_o(), 1)),
                    (zr = ct(_o(), 1)),
                    (S = ct(ku())),
                    (On = typeof window < 'u' && typeof document < 'u' && typeof navigator < 'u'),
                    (nd = (function () {
                ...
                (dl = [
                    ...
                    (Ur = dl.slice(3));
                Wr = { FLIP: 'flip', CLOCKWISE: 'clockwise', COUNTERCLOCKWISE: 'counterclockwise' };
                (jd = {
                    ...
                    computeStyle: { order: 850, enabled: !0, fn: Pd, gpuAcceleration: !0, x: 'bottom', y: 'right' },
                    applyStyle: { order: 900, enabled: !0, fn: wd, onLoad: Ed, gpuAcceleration: void 0 },
                }),
                    (Vd = {
                        placement: 'bottom',
                        positionFixed: !1,
                    ...
                    (Sr = (function () {
                        function e(t, n) {
                            ...
                            cd(this, e),
                                ...
                                Object.keys(Fe({}, e.Defaults.modifiers, o.modifiers)).forEach(function (a) {
                                ...
                                this.modifiers.forEach(function (a) {
                                    a.enabled && Qs(a.onLoad) && a.onLoad(r.reference, r.popper, r.options, a, r.state);
                                }),
                                this.update();
                ...
                (ra = Sr),
                    (yo = ct(_o())),
                    (Bd = ['innerHTML', 'ownerDocument', 'style', 'attributes', 'nodeValue']),
                    (_d = [
                        'Array',
                        'ArrayBuffer',
                        'AsyncFunction',
                    ...
                    (zd = ['bigint', 'boolean', 'null', 'number', 'string', 'symbol', 'undefined']);
                ...
                (ip = { flip: { padding: 20 }, preventOverflow: { padding: 10 } }),
                    ...
                    (sp = 'The error message is optional, but must be a string if provided.');
                (X = {
                    INIT: 'init',
                    IDLE: 'idle',
                    OPENING: 'opening',
                        ...
                        In(n, [
                            {
                                ...
                                value: function () {
                                    Ge() && (this.node || this.appendNode(), cn || this.renderPortal());
                                },
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    var r = this.props,
                                        o = r.children,
                                        i = r.setRef;
                                    if ((this.node || this.appendNode(), cn)) return ut.createPortal(o, this.node);
                ...
                vl.propTypes = { handleClick: S.default.func.isRequired, styles: S.default.object.isRequired };
                bl.propTypes = {
                                    ...
                                    return (
                                        s ||
                                            (a.startsWith('top')
                                                ...
                                                : a.startsWith('right') && (v.padding = '0 0 0 '.concat(u, 'px'))),
                                        [X.OPENING, X.OPEN].indexOf(c) !== -1 && (v = re(re({}, v), f)),
                                ...
                                value: function () {
                                    ...
                                    if (o)
                                        if (g.Children.count(o) === 1)
                                            if (!g.isValidElement(o)) p = g.createElement('span', null, o);
                                            else {
                            ...
                            return (
                                ...
                                Ee(rt(o), 'handleTransitionEnd', function () {
                                    ...
                                    o.wrapperPopper && o.wrapperPopper.instance.update(),
                                        o.setState({ status: i === X.OPENING ? X.OPEN : X.IDLE }, function () {
                                ...
                                Ee(rt(o), 'handleClick', function () {
                                    ...
                                    if (!L.boolean(s)) {
                                        ...
                                        (o.event === 'click' || (o.event === 'hover' && l)) &&
                                            (Yn({
                                                title: 'click',
                                                data: [{ event: a, status: u === X.OPEN ? 'closing' : 'opening' }],
                                                debug: o.debug,
                                            }),
                                            o.toggle());
                                    }
                            ...
                            In(n, [
                                ...
                                },
                                {
                                    ...
                                    value: function (r, o) {
                                        if (Ge()) {
                                            ...
                                            if (r.open !== s) {
                                                var h;
                                                L.boolean(s) && (h = s ? X.OPENING : X.CLOSING), this.toggle(h);
                                            }
                                            (r.wrapperOptions.position !== l.position || r.target !== c) &&
                                                this.changeWrapperPosition(this.props),
                                                p('status', X.IDLE) && s
                                                    ? this.toggle(X.OPEN)
                                                    : d('status', X.INIT, X.IDLE) && a && this.toggle(X.OPEN),
                                                this.popper && p('status', X.OPENING) && this.popper.instance.update(),
                                                this.floaterRef &&
                                                    (p('status', X.OPENING) || p('status', X.CLOSING)) &&
                                                    fp(this.floaterRef, 'transitionend', this.handleTransitionEnd),
                                    ...
                                    value: function () {
                                        ...
                                        if (d === 'center') this.setState({ status: X.IDLE });
                                            ...
                                            new ra(o, this.floaterRef, {
                                                ...
                                                modifiers: re(
                                                    {
                                                        arrow: re({ enabled: !l, element: this.arrowRef }, m),
                                                ...
                                                onCreate: function (w) {
                                                    ...
                                                    if (
                                                        ((r.popper = w),
                                                        !((E = r.floaterRef) !== null && E !== void 0 && E.isConnected))
                                                    ) {
                                        ...
                                        if (i) {
                                            ...
                                            new ra(this.target, this.wrapperRef, {
                                                ...
                                                onCreate: function (w) {
                                                    (r.wrapperPopper = w),
                                                        r._isMounted && r.setState({ statusWrapper: X.IDLE }),
                                                        c(w, 'wrapper'),
                                                        d !== w.placement &&
                                                            setTimeout(function () {
                                                                w.instance.update();
                                ...
                                },
                                {
                                    ...
                                    get: function () {
                                        ...
                                        return (
                                            r || (Ge() && 'ReactFloaterDebug' in window && !!window.ReactFloaterDebug)
                                        );
                                    },
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    get: function () {
                                        ...
                                        if (this.target) {
                                            ...
                                            this.wrapperStyles
                                                ? (l.wrapper = re(re({}, l.wrapper), this.wrapperStyles))
                ...
                Ee($o, 'propTypes', {
                    ...
                    children: S.default.node,
                    component: ha(S.default.oneOfType([S.default.func, S.default.element]), function (e) {
                        return !e.content;
                    }),
                    ...
                    (Bp = class {
                        constructor(e) {
                            M(this, 'beaconPopper'),
                                ...
                                M(this, 'getPopper', (o) => (o === 'beacon' ? this.beaconPopper : this.tooltipPopper)),
                                ...
                                M(this, 'close', (o = null) => {
                                    ...
                                    a === G.RUNNING &&
                                        this.setState({
                                            ...this.getNextState({ action: Z.CLOSE, index: i + 1, origin: o }),
                                        });
                                }),
                                M(this, 'go', (o) => {
                                ...
                                M(this, 'next', () => {
                                    ...
                                    i === G.RUNNING &&
                                        this.setState(this.getNextState({ action: Z.NEXT, index: o + 1 }));
                                }),
                                M(this, 'open', () => {
                                    let { status: o } = this.getState();
                                    o === G.RUNNING &&
                                        this.setState({
                                            ...this.getNextState({ action: Z.UPDATE, lifecycle: _.TOOLTIP }),
                                        });
                                }),
                                M(this, 'prev', () => {
                                    let { index: o, status: i } = this.getState();
                                    i === G.RUNNING &&
                                        this.setState({ ...this.getNextState({ action: Z.PREV, index: o - 1 }) });
                                }),
                                M(this, 'reset', (o = !1) => {
                                ...
                                M(this, 'skip', () => {
                                    let { status: o } = this.getState();
                                    o === G.RUNNING &&
                                        this.setState({ action: Z.SKIP, lifecycle: _.INIT, status: G.SKIPPED });
                                }),
                                M(this, 'start', (o) => {
                                    let { index: i, size: a } = this.getState();
                                    this.setState({
                                        ...this.getNextState({ action: Z.START, index: I.number(o) ? o : i }, !0),
                                ...
                                M(this, 'stop', (o = !1) => {
                                    ...
                                    [G.FINISHED, G.SKIPPED].includes(a) ||
                                        this.setState({
                                            ...this.getNextState({ action: Z.STOP, index: i + (o ? 1 : 0) }),
                                            status: G.PAUSED,
                                        });
                                }),
                                M(this, 'update', (o) => {
                                    var i, a;
                                    if (!Ip(o, ba)) throw new Error(`State is not valid. Valid keys: ${ba.join(', ')}`);
                                    this.setState({
                                        ...this.getNextState(
                                            {
                                                ...this.getState(),
                        ...
                        getNextState(e, t = !1) {
                            var n, r, o, i, a;
                            let { action: s, controlled: c, index: l, size: u, status: d } = this.getState(),
      ...
      `),
                        ...
                        componentDidMount() {
                            ...
                            I.domElement(this.beacon) || console.warn('beacon is not a valid DOM element'),
                                setTimeout(() => {
                        ...
                        render() {
                            let {
                                ...
                                u = { 'aria-label': l, onClick: i, onMouseEnter: i, ref: this.setBeaconRef, title: l },
                                d;
                            return (
                                e
                                    ? (d = O(e, { continuous: t, index: n, isLastStep: r, size: a, step: s, ...u }))
                                    : (d = O(
                                          'button',
                                          {
                                              key: 'JoyrideBeacon',
                    ...
                    (Yp = class extends nt {
                        constructor() {
                            super(...arguments),
                                ...
                                M(this, 'scrollParent'),
                                M(this, 'state', { isScrolling: !1, mouseOverSpotlight: !1, showSpotlight: !0 }),
                        ...
                        render() {
                            ...
                            let c = s.overlay;
                            ga() && (c = a === 'center' ? s.overlayLegacyCenter : s.overlayLegacy);
                            let l = {
                                ...
                                u = a !== 'center' && t && O(Hp, { styles: this.spotlightStyles });
                            if (Tl() === 'safari') {
                                let { mixBlendMode: d, zIndex: p, ...h } = l;
                                (u = O('div', { style: { ...h } }, u)), delete l.backgroundColor;
                            }
                            return O(
                                'div',
                                {
                ...
                (Xp = Kp),
                    ...
                    (Zp = class extends nt {
                        ...
                        componentDidMount() {
                            ...
                            xt({ title: `step:${t}`, data: [{ key: 'props', value: this.props }], debug: e });
                        }
                        componentDidUpdate(e) {
                            var t;
                            let {
                            ...
                            if (
                                ...
                                let E = yt(d.target),
                                    j = !!E;
                                j && Op(E)
                                    ? (f('status', G.READY, G.RUNNING) || f('lifecycle', _.INIT, _.READY)) &&
                                      r({ ...m, step: d, type: _e.STEP_BEFORE })
                                    : (console.warn(j ? 'Target not visible' : 'Target not mounted', d),
                            ...
                            f('lifecycle', _.INIT, _.READY) &&
                                ...
                                h('index') &&
                                    xt({ title: `step:${l}`, data: [{ key: 'props', value: this.props }], debug: a }),
                                h('lifecycle', _.BEACON) && r({ ...m, step: d, type: _e.BEACON }),
                                h('lifecycle', _.TOOLTIP) &&
                                    (r({ ...m, step: d, type: _e.TOOLTIP }),
                                    this.tooltip &&
                                        ((this.scope = new zp(this.tooltip, { selector: '[data-action=primary]' })),
                                        this.scope.setFocus())),
                    ...
                    (Cl = class extends nt {
                        ...
                        componentDidUpdate(e, t) {
                            ...
                            let { action: n, controlled: r, index: o, lifecycle: i, status: a } = this.state,
                                ...
                                { reset: h, setSteps: f, start: m, stop: x, update: v } = this.store,
                                ...
                                P = yt(E.target);
                            if (
                                (j && (va(u, s) ? f(u) : console.warn('Steps are not valid', u)),
                                b('run') && (c ? m(l) : x()),
                                D)
                            ) {
                                ...
                                n === Z.STOP && (te = Z.START),
                                    [G.FINISHED, G.SKIPPED].includes(a) ||
                                        v({ action: n === Z.CLOSE ? Z.CLOSE : te, index: l, lifecycle: _.INIT });
                            }
                            !r &&
                                a === G.RUNNING &&
                                o === 0 &&
                                ...
                                this.callback({ ...this.state, type: _e.TARGET_NOT_FOUND, step: E }));
                            let N = { ...this.state, index: o, step: E };
                            if (y('action', [Z.NEXT, Z.PREV, Z.SKIP, Z.CLOSE]) && y('status', G.PAUSED)) {
                            ...
                            if (y('status', [G.FINISHED, G.SKIPPED])) {
                                ...
                                r ||
                                    ...
                                    this.callback({ ...N, type: _e.TOUR_END, step: te, index: t.index }),
                                    h();
                            } else
                        ...
                        scrollToStep(e) {
                            ...
                            if (r === G.RUNNING && p) {
                                ...
                                if (n === _.BEACON && x) {
                                    ...
                                    !['bottom'].includes(y) && !h && (m = Math.floor(b.popper.top - s));
                ...
                (oh = class {
                    constructor(e, t, n, r) {
                        this.getOptions = t;
                        let { colors: o, initialVelocityX: i, initialVelocityY: a } = this.getOptions();
                        (this.context = e),
                            (this.x = n),
                            (this.y = r),
                            (this.w = Ie(5, 20)),
                    ...
                    update() {
                        let { gravity: e, wind: t, friction: n, opacity: r, drawShape: o } = this.getOptions();
                        (this.x += this.vx),
                            (this.y += this.vy),
                            (this.vy += e),
                            (this.vx += t),
                            ...
                            this.rotateY >= 1 && this.rotationDirection === 1
                                ...
                                : this.rotateY <= -1 && this.rotationDirection === -1 && (this.rotationDirection = 1);
                    ...
                    (ih = class {
                        constructor(e, t) {
                            (this.x = 0),
                                ...
                                (this.animate = () => {
                                    let { canvas: r, context: o, particlesGenerated: i, lastNumberOfPieces: a } = this,
                                        {
                                            run: s,
                                            recycle: c,
                                            numberOfPieces: l,
                                    ...
                                    let h = this.particles.length,
                                        ...
                                        m = Date.now();
                                    if (f < l) {
                                        a !== l && ((this.tweenInitTime = m), (this.lastNumberOfPieces = l));
                                        let { tweenInitTime: x } = this,
                                            v = m - x > p ? p : Math.max(0, m - x),
                                            b = d(v, f, l, p),
                                            y = Math.round(b - f);
                                        for (let w = 0; w < y; w++) this.particles.push(this.getParticle());
                                    ...
                                    return (
                                        u &&
                                            ...
                                            (o.fillStyle = '#333'),
                                            (o.textAlign = 'right'),
                                            o.fillText(`Particles: ${h}`, r.width - 10, r.height - 20)),
                                        this.particles.forEach((x, v) => {
                                            x.update(),
                                                (x.y > r.height || x.y < -100 || x.x > r.width + 100 || x.x < -100) &&
                                                    (c && f <= l
                    ...
                    (ah = class {
                        constructor(e, t) {
                            (this.setOptionsWithDefaults = (r) => {
                                let o = { confettiSource: { x: 0, y: 0, w: this.canvas.width, h: 0 } };
                                (this._options = { ...o, ...Ko, ...r }), Object.assign(this, r.confettiSource);
                            }),
                                (this.update = () => {
                                    let {
                                    ...
                                    r && ((a.fillStyle = 'white'), a.clearRect(0, 0, i.width, i.height)),
                    ...
                    (xo = class extends nt {
                        constructor(e, ...t) {
                            super(e, ...t), (this.canvas = g.createRef()), (this.canvas = e.canvasRef || lh);
                        }
                        componentDidMount() {
                ...
                (ch = g.forwardRef((e, t) => g.createElement(xo, { canvasRef: t, ...e }))),
  ...
  box-shadow: ${({ variant: e }) =>
      e === 'primary' ? 'none' : e === 'secondary' || e === 'outline' ? '#D9E8F2 0 0 0 1px inset' : 'none'};
  height: 32px;
  font-size: 0.8125rem;
  font-weight: 700;
...
`),
                    (Le = se(function ({ children: e, onClick: t, variant: n = 'primary', ...r }, o) {
                        return g.createElement(hh, { ref: o, onClick: t, variant: n, ...r }, e);
                    })),
                    (fh = B.div`
                        ...
                        g.createElement(
                            ...
                            !e.hideNextButton &&
                                g.createElement(
                                    ...
                                    g.createElement(
                                        Le,
                                        { ...t, ...(e.onNextButtonClick ? { onClick: e.onNextButtonClick } : {}) },
                                        'Next',
                                    ),
                                ),
                        )),
...
`),
  ...
  margin-bottom: 4px;
`);
                (wo = globalThis?.document ? Bt : () => {}), (Vh = zn || (() => {})), (Bh = 0);
                Xo = se((e, t) => {
                    let { children: n, ...r } = e,
                        o = Ye.toArray(n),
                        i = o.find(Wh);
                    if (i) {
                        let a = i.props.children,
                            s = o.map((c) =>
                                c === i ? (Ye.count(a) > 1 ? Ye.only(null) : Vt(a) ? a.props.children : null) : c,
                            );
                        return O(Eo, ge({}, r, { ref: t }), Vt(a) ? jt(a, void 0, s) : null);
                    }
                ...
                (To = 'dismissableLayer.update'),
                    ...
                    (Qh = se((e, t) => {
                        ...
                        let {
                            ...
                            u = me(Xh),
                            [d, p] = ne(null),
                            h = (n = d?.ownerDocument) !== null && n !== void 0 ? n : globalThis?.document,
                            [, f] = ne({}),
                            m = Ln(t, (P) => p(P)),
                        ...
                        return (
                            qh((P) => {
                                y === u.layers.size - 1 &&
                                    (o?.(P), !P.defaultPrevented && c && (P.preventDefault(), c()));
                            }, h),
                            U(() => {
                                if (d)
                                    return (
                            ...
                            U(
                                () => () => {
                                    d && (u.layers.delete(d), u.layersWithOutsidePointerEventsDisabled.delete(d), wa());
                                },
                                [d, u],
                            ),
                            U(() => {
                                let P = () => f({});
                                return document.addEventListener(To, P), () => document.removeEventListener(To, P);
                            }, []),
                            O(
                                Lt.div,
                                ge({}, l, {
                                    ...
                                    onPointerDownCapture: It(e.onPointerDownCapture, j.onPointerDownCapture),
                                }),
                            )
                        );
                    }));
                ($r = 'focusScope.autoFocusOnMount'),
                    ...
                    (ef = se((e, t) => {
                        let { loop: n = !1, trapped: r = !1, onMountAutoFocus: o, onUnmountAutoFocus: i, ...a } = e,
                            [s, c] = ne(null),
                            l = Mt(o),
                            u = Mt(i),
                            d = ee(null),
                        ...
                        U(() => {
                            if (r) {
                                let m = function (y) {
                                        ...
                                        let w = y.target;
                                        s.contains(w) ? (d.current = w) : pt(d.current, { select: !0 });
                                    },
                                    x = function (y) {
                                        if (h.paused || !s) return;
                                        let w = y.relatedTarget;
                                        w !== null && (s.contains(w) || pt(d.current, { select: !0 }));
                                    },
                                    v = function (y) {
                                ...
                                if (s) {
                                    ...
                                    if (!s.contains(m)) {
                                        ...
                                        s.addEventListener($r, l),
                                            s.dispatchEvent(x),
                                            x.defaultPrevented ||
                                                (tf(sf(kl(s)), { select: !0 }), document.activeElement === m && pt(s));
                                    }
                                    return () => {
                                        s.removeEventListener($r, l),
                                            setTimeout(() => {
                                                ...
                                                s.addEventListener(Kr, u),
                                                    s.dispatchEvent(x),
                                                    x.defaultPrevented || pt(m ?? document.body, { select: !0 }),
                        ...
                        let f = ye(
                            (m) => {
                                ...
                                let x = m.key === 'Tab' && !m.altKey && !m.ctrlKey && !m.metaKey,
                                ...
                                if (x && v) {
                                    ...
                                    y && w
                                        ? !m.shiftKey && v === w
                                            ...
                                            : m.shiftKey && v === y && (m.preventDefault(), n && pt(w, { select: !0 }))
                ...
                lf = se((e, t) => {
                    ...
                    return r ? ut.createPortal(O(Lt.div, ge({}, o, { ref: t })), r) : null;
                });
                Cr = (e) => {
                    let { present: t, children: n } = e,
                        r = uf(t),
                        o = typeof n == 'function' ? n({ present: r.isPresent }) : Ye.only(n),
                        i = Ln(r.ref, o.ref);
                    return typeof n == 'function' || r.isPresent ? jt(o, { ref: i }) : null;
                };
                ...
                (Ll = bf()),
                    ...
                    (Ar = se(function (e, t) {
                        var n = ee(null),
                            r = ne({ onScrollCapture: Zr, onWheelCapture: Zr, onTouchMoveCapture: Zr }),
                            o = r[0],
                            i = r[1],
                            a = e.forwardProps,
                            s = e.children,
                ...
                (Pf = function () {
                    ...
                    (Rf = function (e) {
                        if ((e === void 0 && (e = 'margin'), typeof window > 'u')) return Cf;
                        var t = Af(e),
...
`,
                ...
                (_t = So ? { passive: !1 } : !1),
                    ...
                    (Fl = function (e, t) {
                        ...
                        return n[t] !== 'hidden' && !(n.overflowY === n.overflowX && !Df(e) && n[t] === 'visible');
                    }),
                    (Lf = function (e) {
                ...
                (Yf = Bl),
                        ...
                        return (
                            ...
                            function () {
                                a.forEach(function (d) {
                                    ...
                                    eo--,
                                    eo || ((Ut = new WeakMap()), (Ut = new WeakMap()), (Kn = new WeakMap()), (Xn = {}));
                            }
                        );
                    }),
                    (Kf = function (e, t, n) {
                    ...
                    (Jf = (e) => {
                        ...
                        return O(
                            ...
                            Ye.map(r, (a) => O(Cr, { present: n || i.open }, O(lf, { asChild: !0, container: o }, a))),
                        );
                    }),
                    (Po = 'DialogOverlay'),
                    (em = se((e, t) => {
                        ...
                        return i.modal ? O(Cr, { present: r || i.open }, O(tm, ge({}, o, { ref: t }))) : null;
                    })),
                    (tm = se((e, t) => {
                    ...
                    (nm = se((e, t) => {
                        ...
                        return O(
                            Cr,
                            { present: r || i.open },
                            i.modal ? O(rm, ge({}, o, { ref: t })) : O(om, ge({}, o, { ref: t })),
                        );
                    })),
                    (rm = se((e, t) => {
                        ...
                        return (
                            ...
                            O(
                                ...
                                ge({}, e, {
                                    ...
                                    onFocusOutside: It(e.onFocusOutside, (i) => i.preventDefault()),
                                }),
                            )
                        );
                    })),
                    ...
                    (Yl = se((e, t) => {
                        let { __scopeDialog: n, trapFocus: r, onOpenAutoFocus: o, onCloseAutoFocus: i, ...a } = e,
                            s = Qe(Xt, n),
                            c = ee(null),
                            l = Ln(t, c);
                        return (
                            ...
                            O(
                                ...
                                O(
                                    ef,
                                    { asChild: !0, loop: !0, trapped: r, onMountAutoFocus: o, onUnmountAutoFocus: i },
                                    O(
                                        Qh,
                                        ge(
                                            {
                    ...
                    (cm = se((e, t) => {
                        ...
                        return O(
                            Lt.button,
                            ge({ type: 'button' }, r, { ref: t, onClick: It(e.onClick, () => o.onOpenChange(!1)) }),
                        );
                    }));
...
`),
  ...
  `,
                    ...
                    (xm = g.forwardRef(function ({ width: e, height: t, children: n, ...r }, o) {
                        return g.createElement(
                            fm,
                            { ref: o, asChild: !0, ...r },
...
`;
                (Nm = ({ onProceed: e, skipOnboarding: t }) =>
                    g.createElement(
                        'div',
                        { style: { zIndex: 10 } },
                        g.createElement($l, { width: 540, height: 430, defaultOpen: !0 }, ({ Close: n }) =>
                            g.createElement(
                                Em,
                                ...
                                g.createElement(Om, { onClick: t }, 'Skip tour', g.createElement(Cm, null)),
                                g.createElement(
                                    Am,
                                    null,
                ...
                (Bm = ['x', 'y', 'top', 'bottom', 'left', 'right', 'width', 'height']),
                    ...
                    (Xl = Be({ transformPagePoint: (e) => e, isStatic: !1, reducedMotion: 'never' })),
                    (Rr = Be({})),
                    (Qo = Be(null)),
                ...
                (Qn = ['prepare', 'read', 'update', 'preRender', 'render', 'postRender']), (Hm = 40);
                ({ schedule: Jo, cancel: YO } = ec(queueMicrotask, !1));
                (ei = ['animate', 'whileInView', 'whileFocus', 'whileHover', 'whileTap', 'whileDrag', 'exit']),
                    (ti = ['initial', ...ei]);
                (La = {
                    animation: [
                        'animate',
                    ...
                    (Sn = {});
                for (let e in La) Sn[e] = { isEnabled: (t) => La[e].some((n) => !!t[n]) };
                (nc = Be({})), (rc = Be({})), (Xm = Symbol.for('motionComponentSymbol'));
                eg = [
                    'animate',
                    'circle',
                    'defs',
                ...
                (Ce = (e) => !!(e && e.getVelocity)),
                    (ng = { x: 'translateX', y: 'translateY', z: 'translateZ', transformPerspective: 'perspective' }),
                    (rg = Nn.length);
                (ic = (e) => (t) => typeof t == 'string' && t.startsWith(e)),
                    (ac = ic('--')),
                    (ig = ic('var(--')),
                    (fr = (e) => ig(e) && ag.test(e)),
                    (ag = /var\s*\(\s*--[\w-]+(\s*,\s*(?:(?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)+)?\s*\)$/i),
                ...
                (jn = (e) => ({
                    ...
                    (ug = jn('vh')),
                    (dg = jn('vw')),
                    (Na = { ...Xe, parse: (e) => Xe.parse(e) / 100, transform: (e) => Xe.transform(e * 100) }),
                ...
                ii = () => ({ style: {}, transform: {}, transformOrigin: {}, vars: {} });
                mg = new Set([
                    'animate',
                    'exit',
                    'variants',
                ...
                (uc = () => ({ ...ii(), attrs: {} })), (si = (e) => typeof e == 'string' && e.toLowerCase() === 'svg');
                pc = new Set([
                    'baseFrequency',
                    'diffuseConstant',
                    'kernelMatrix',
                ...
                (he = (e) => e),
                    ({
                        ...
                        state: ve,
                        steps: to,
                    } = ec(typeof requestAnimationFrame < 'u' ? requestAnimationFrame : he, !0)),
                    (Rg = {
                        useVisualState: mc({
                    ...
                    (Ig = { useVisualState: mc({ scrapeMotionValuesFromProps: li, createRenderState: ii }) });
                gc = (e) =>
                        ...
                        super(...arguments),
                                ...
                                let n = this.node.getProps(),
                                    r = it(
                                        ...
                                        (i, a) => {
                                            ...
                                            let { onTap: s, onTapCancel: c, globalTapTarget: l } = this.node.getProps();
                                            ie.update(() => {
                                                !l && !xc(this.node.current, i.target) ? c && c(i, a) : s && s(i, a);
                                            });
                                        },
                                        { passive: !(n.onTap || n.onPointerUp) },
                                    ),
                                    o = it(window, 'pointercancel', (i, a) => this.cancelPress(i, a), {
                            ...
                            (this.startAccessiblePress = () => {
                                let e = (o) => {
                                        ...
                                        this.removeEndListeners(),
                                            (this.removeEndListeners = ot(this.node.current, 'keyup', i)),
                                            no('down', (a, s) => {
                                                this.startPress(a, s);
                                            });
                                    },
                                    ...
                                    n = () => {
                                        this.isPressing && no('cancel', (o, i) => this.cancelPress(o, i));
                                    },
                ...
                (zg = { some: 0, all: 1 }),
                    (Ug = class extends Tt {
                        ...
                        startObserver() {
                            ...
                            let { viewport: e = {} } = this.node.getProps(),
                                ...
                                a = (s) => {
                                    ...
                                    let { onViewportEnter: l, onViewportLeave: u } = this.node.getProps(),
                                        d = c ? l : u;
                                    d && d(s);
                                };
                        ...
                        update() {
                            ...
                            ['amount', 'margin', 'root'].some(Wg(e, t)) && this.startObserver();
                        }
                        unmount() {}
                    });
                Hg = { inView: { Feature: Ug }, tap: { Feature: Fg }, focus: { Feature: Ng }, hover: { Feature: Lg } };
                (Vn = he), (ze = he);
                (Vn = (e, t) => {
                ...
                (Oc = (e, t, n) => (((1 - 3 * n + 3 * t) * e + (3 * n - 6 * t)) * e + 3 * t) * e),
                    (Xg = 1e-7),
                    (Qg = 12);
                (Jg = Bn(0.42, 0, 1, 1)),
                    (ey = Bn(0, 0, 0.58, 1)),
                    ...
                    (Ac = (e) => (t) => t <= 0.5 ? e(2 * t) / 2 : (2 - e(2 * (1 - t))) / 2),
                    (Rc = (e) => (t) => 1 - e(1 - t)),
                    ...
                    (di = Rc(kc)),
                    (ry = Ac(di)),
                    (oy = (e) => ((e *= 2) < 1 ? 0.5 * di(e) : 0.5 * (2 - Math.pow(2, -10 * (e - 1))))),
                    (za = {
                        linear: he,
                        easeIn: Jg,
                        easeInOut: Cc,
                    ...
                    (oe = (e, t, n) => e + (t - e) * n);
                (pi = (e, t) => (n) =>
                    !!((Fn(n) && cg.test(n) && n.startsWith(e)) || (t && Object.prototype.hasOwnProperty.call(n, t)))),
                    (Mc = (e, t, n) => (r) => {
                        if (!Fn(r)) return r;
                ...
                (Ha = (e, t) => {
                    ...
                    (we = {
                        ...
                        parse: (e) => (Rt.test(e) ? Rt.parse(e) : Ht.test(e) ? Ht.parse(e) : Co.parse(e)),
                        transform: (e) => (Fn(e) ? e : e.hasOwnProperty('red') ? Rt.transform(e) : Ht.transform(e)),
                    });
                (Dc = 'number'),
                    (Lc = 'color'),
                    (dy = 'var'),
                ...
                Et = { test: uy, parse: Nc, createTransformer: Fc, getAnimatableNone: fy };
                vy = (e, t) => {
                ...
                (kt = {
                    now: () => (
                        ar === void 0 &&
                            kt.set(ve.isProcessing || Jl.useManualTiming ? ve.timestamp : performance.now()),
                        ar
                    ),
                    set: (e) => {
                ...
                (jy = { decay: Ka, inertia: Ka, tween: vr, keyframes: vr, spring: zc }), (Vy = (e) => e / 100);
                (_y = By(() => Object.hasOwnProperty.call(Element.prototype, 'animate'))),
                    (zy = new Set(['opacity', 'clipPath', 'filter', 'transform'])),
                    (Jn = 10),
                    (Uy = 2e4),
                    (Wy = (e, t) => t.type === 'spring' || e === 'backgroundColor' || !Tc(t.ease));
                (Gy = { type: 'spring', stiffness: 500, damping: 25, restSpeed: 10 }),
                    ...
                    (Ky = { type: 'keyframes', ease: [0.25, 0.1, 0.35, 1], duration: 0.3 }),
                    (Xy = (e, { keyframes: t }) =>
                        t.length > 2 ? $y : Nt.has(e) ? (e.startsWith('scale') ? qy(t[1]) : Gy) : Ky),
                    (Io = (e, t) =>
                        e === 'zIndex'
                            ? !1
                            : !!(
                                  typeof t == 'number' ||
                                  Array.isArray(t) ||
                                  (typeof t == 'string' && (Et.test(t) || t === '0') && !t.startsWith('url('))
                              )),
                ...
                (Za = 30),
                    ...
                    (iv = class {
                        ...
                        getVelocity() {
                            let e = kt.now();
                            if (!this.canTrackVelocity || this.prevFrameValue === void 0 || e - this.updatedAt > Za)
                                return 0;
                            let t = Math.min(this.updatedAt - this.prevUpdatedAt, Za);
                            return Bc(parseFloat(this.current) - parseFloat(this.prevFrameValue), t);
                        }
                        start(e) {
                            return (
                                this.stop(),
                    ...
                    constructor(e, t, { transformPagePoint: n, contextWindow: r, dragSnapToOrigin: o = !1 } = {}) {
                        if (
                            ...
                            (this.updatePoint = () => {
                                ...
                                d || (m && m(this.lastMoveEvent, u), (this.startEvent = this.lastMoveEvent)),
                            ...
                            (this.handlePointerUp = (u, d) => {
                                this.end();
                                let { onEnd: p, onSessionEnd: h, resumeAnimation: f } = this.handlers;
                                if (
                                    (this.dragSnapToOrigin && f && f(), !(this.lastMoveEvent && this.lastMoveEventInfo))
                                )
                                    return;
                                let m = co(
                    ...
                    (Gv = class {
                        ...
                        start(e, { snapToCursor: t = !1 } = {}) {
                                ...
                                s = () =>
                                    Ne((l) => {
                                        ...
                                        return (
                                            ...
                                            ((u = this.getAxisMotionValue(l).animation) === null || u === void 0
                                                ? void 0
                                                : u.play())
                                        );
                                    }),
                            ...
                            this.panSession = new $c(
                                e,
                                { onSessionStart: r, onStart: o, onMove: i, onSessionEnd: a, resumeAnimation: s },
                                {
                                ...
                                o !== this.constraints &&
                                    ...
                                    Ne((i) => {
                                        this.getAxisMotionValue(i) &&
                                            (this.constraints[i] = jv(r.layoutBox[i], this.constraints[i]));
                                    });
                        }
                        ...
                        addListeners() {
                            ...
                            let i = ot(window, 'resize', () => this.scalePositionWithinConstraints()),
                                a = r.addEventListener('didUpdate', ({ delta: s, hasLayoutChanged: c }) => {
                                    this.isDragging &&
                                        c &&
                                        (Ne((l) => {
                ...
                ($v = class extends Tt {
                    ...
                    (Kv = class extends Tt {
                        ...
                        mount() {
                            this.removePointerDownListener = it(this.node.current, 'pointerdown', (e) =>
                ...
                (mn = {
                    ...
                    (Zv = class extends g.Component {
                        ...
                        getSnapshotBeforeUpdate(e) {
                            let { layoutDependency: t, visualElement: n, drag: r, isPresent: o } = this.props,
                                i = n.projection;
                            return (
                                i &&
                                    ((i.isPresent = o),
                ...
                (c0 = (e, t) => e.depth - t.depth),
                    (u0 = class {
                        ...
                        forEach(e) {
                            this.isDirty && this.children.sort(c0), (this.isDirty = !1), this.children.forEach(e);
                        }
                    });
                (Os = ['', 'X', 'Y', 'Z']),
                ...
                (M0 = au({
                    ...
                    (D0 = { pan: { Feature: Kv }, drag: { Feature: $v, ProjectionNode: lu, MeasureLayout: tu } }),
                            ...
                            (o.forEach((c) => {
                                ...
                                if (gr(p)) {
                                    ...
                                    for (let x = m; x < f && p[x] !== null; x++)
                                        h
                                            ? ze(fn(p[x]) === h, 'All keyframes must be of the same type')
                                            : ((h = fn(p[x])),
                                              ze(
                                                  h === d || (tr(d) && tr(h)),
                                ...
                                if (d !== h)
                                    if (tr(d) && tr(h)) {
                                        ...
                                        typeof f == 'string' && l.set(parseFloat(f)),
                                            typeof p == 'string'
                                                ? (t[c] = parseFloat(p))
                                                : Array.isArray(p) && h === F && (t[c] = p.map(parseFloat));
                                    } else
                ...
                (js = new WeakMap()),
                    ...
                    (Q0 = class {
                        constructor(
                            { parent: e, props: t, presenceContext: n, reducedMotionConfig: r, visualState: o },
                            i = {},
                        ) {
                            (this.current = null),
                                (this.children = new Set()),
                            ...
                            for (let u in l) {
                                let d = l[u];
                                a[u] !== void 0 && Ce(d) && (d.set(a[u], !1), xr(c) && c.add(u));
                            }
                        }
                        ...
                        loadFeatures({ children: e, ...t }, n, r, o) {
                            ...
                            for (let s = 0; s < K0; s++) {
                                let c = du[s],
                                    { isEnabled: l, Feature: u, ProjectionNode: d, MeasureLayout: p } = Sn[c];
                                d && (i = d),
                                    l(t) && (!this.features[c] && u && (this.features[c] = new u(this)), p && (a = p));
                            }
                        ...
                        getValue(e, t) {
                            ...
                            return (
                                n === void 0 && t !== void 0 && ((n = Qt(t, { owner: this })), this.addValue(e, n)), n
                            );
                        }
                        readValue(e) {
                            var t;
                        ...
                        on(e, t) {
                            return this.events[e] || (this.events[e] = new bi()), this.events[e].add(t);
                        }
                        notify(e, ...t) {
...
`),
                        ...
                        return g.createElement(
                            ...
                            t.map(({ toggle: i, snippet: a }, s) =>
                                g.createElement(
                                    dt,
                                    { key: s },
                                    i === void 0 && g.createElement(an, { language: 'typescript', customStyle: o }, a),
                                    i &&
                                        !n &&
                                        g.createElement(an, { language: 'typescript', customStyle: o }, '  // ...'),
                                    i &&
                                        n &&
                                        g.createElement(
                                            rn.div,
                    ...
                    (db = ({ activeStep: e, data: t, width: n, filename: r }) => {
                        let [o, i] = ne([]),
                            ...
                            s = (u) => {
                                let d = 0;
                                for (let p = 0; p < u; p++) d -= a[p].current.getBoundingClientRect().height;
                                return d;
                            },
                            c = ye(() => {
                                let u = t.flatMap((d, p) => {
                                    ...
                                    return (
                                        d.length > 1 && f.push({ yPos: s(p), backdropHeight: h, index: p, open: !0 }), f
                                    );
                                });
                                i(u);
                            }, [t]);
                            ...
                            g.createElement(
                                ...
                                g.createElement(
                                    ...
                                    g.createElement(
                                        ib,
                                        null,
                                        g.createElement(an, { language: 'typescript', customStyle: l }, '// ' + r),
                                    ),
                                    t.map((u, d) =>
                                        g.createElement(ub, {
                                            key: d,
                    ...
                    (fb = B.li(() => ({ display: 'flex', alignItems: 'flex-start', columnGap: 12 }))),
                    (mb = B.div`
  font-family: ${({ theme: e }) => e.typography.fonts.base};
  color: ${({ theme: e }) => e.color.darker};
  font-size: 13px;
...
`),
                    ...
                    (ho = ({ children: e, index: t, isCompleted: n }) =>
                        g.createElement(
                            ...
                            g.createElement(
                                ...
                                n ? g.createElement(Bi, { width: 10, height: 10, color: 'white' }) : t,
                            ),
                ...
                (vb = (e, t, n) => {
                            ...
                            if (e) {
                                let i = () => {
                                        n.getChannel().once(Ri, () => {
                                            ...
                                            o(s ? { data: !0, error: null } : { data: !1, error: null });
                                        });
                                    },
                                    a = n.getChannel();
                                return (
                                    t.getData('example-button--warning') ? o({ data: !0, error: null }) : a.on(jr, i),
                                    () => {
                                        a.off(jr, i);
                                    }
                                );
                    ...
                    (Tb = ({ onFinish: e, api: t, addonsStore: n, skipOnboarding: r, codeSnippets: o }) => {
                        let [i, a] = ne('imports'),
                            s = _r(),
                            ...
                            v = () => {
                                ...
                                navigator.clipboard.writeText(y.replace('// Copy the code below', '')), u(!0);
                            },
                            b = ye(() => {
                                t.emit(yn, {
                                    step: 'X:SkippedOnboarding',
                                                ...
                                                i === 'meta' &&
                                                    g.createElement(
                                                        ...
                                                        g.createElement(
                                                            ...
                                                            g.createElement(
                                                                Le,
                                                                { variant: 'secondary', onClick: () => a('imports') },
                                                                'Previous',
                                                            ),
                                                            g.createElement(Le, { onClick: () => a('story') }, 'Next'),
                                                        ),
                                                    ),
                                                i === 'story' &&
                                                    g.createElement(
                                                        ...
                                                        g.createElement(
                                                            ...
                                                            g.createElement(Le, { onClick: () => a('args') }, 'Next'),
                                                        ),
                                                    ),
                                                i === 'args' &&
                                                    g.createElement(
