(() => {
    ...
    (__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.u = (chunkId) =>
            (({
                67: 'widgets-ThemeSwitcher-ui-ThemeSwitcher-stories',
                210: 'shared-ui-AppLink-AppLink-stories',
                242: 'widgets-LangSwitcher-ui-LangSwitcher-stories',
                363: 'widgets-Sidebar-ui-Sidebar-Sidebar-stories',
                384: 'pages-MainPage-ui-MainPage-stories',
                491: 'widgets-PageLoader-ui-PageLoader-stories',
                533: 'shared-ui-Loader-Loader-stories',
                596: 'widgets-PageError-ui-PageError-stories',
                811: 'widgets-Navbar-ui-Navbar-stories',
                821: 'pages-AboutPage-ui-AboutPage-stories',
                967: 'pages-NotFoundPage-ui-NotFoundPage-stories',
                982: 'shared-ui-Button-Button-stories',
            }[chunkId] || chunkId) +
            '.' +
            {
                67: 'de5e738b',
        ...
        (__webpack_require__.l = (url, done, key, chunkId) => {
            if (inProgress[url]) inProgress[url].push(done);
                ...
                if (void 0 !== key)
                    for (var scripts = document.getElementsByTagName('script'), i = 0; i < scripts.length; i++) {
                        ...
                        if (
                            ...
                            s.getAttribute('data-webpack') == 'production-project:' + key
                        ) {
                            script = s;
                            break;
                        }
                ...
                script ||
                    ...
                    script.setAttribute('data-webpack', 'production-project:' + key),
                    (script.src = url)),
                    (inProgress[url] = [done]);
        ...
        (() => {
            ...
            var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
                ...
                chunkLoadingGlobal = (self.webpackChunkproduction_project = self.webpackChunkproduction_project || []);
