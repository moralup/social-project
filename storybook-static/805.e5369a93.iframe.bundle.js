...
(self.webpackChunkproduction_project = self.webpackChunkproduction_project || []).push([
    [805],
    {
        './node_modules/@storybook/components/dist/formatter-B5HCVTEV.mjs': (
            __unused_webpack_module,
            __webpack_exports__,
            __webpack_require__,
        ) => {
            __webpack_require__.r(__webpack_exports__),
                __webpack_require__.d(__webpack_exports__, { formatter: () => formatter });
            var memoizerific__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
                    './node_modules/memoizerific/memoizerific.js',
                ),
                memoizerific__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(
                    memoizerific__WEBPACK_IMPORTED_MODULE_0__,
                ),
                ...
                Q = (t8, e, r) => (jr(t8, e, 'read from private field'), r ? r.call(t8) : e.get(t8)),
                Ur = {};
            ...
            function Zs(t8) {
                ...
                let n = ((t8) => new Intl.ListFormat('en-US', { type: 'disjunction' }).format(t8))(
                    [...ft].map((s) => `'${s}'`),
                );
            ...
            function E(t8, e = {}) {
                return (
                    dt(e.expandedStates),
                    { type: ee, id: e.id, contents: t8, break: !!e.shouldBreak, expandedStates: e.expandedStates }
                );
            }
            function gt(t8) {
            ...
            function Y(t8, e) {
                let r = [];
                for (let n = 0; n < e.length; n++) 0 !== n && r.push(t8), r.push(e[n]);
                return r;
            }
            var me = (t8, e, r) => {
                if (!t8 || null != e)
            ...
            function T(t8, e = rn) {
                return Ct(t8, (r) => ('string' == typeof r ? Y(e, r.split('\n')) : r));
            }
            ...
            var un = class {
                    constructor(e) {
                        ((t8, e, r) => {
                            ...
                            ((t8, e, r, n) => {
                                jr(t8, e, 'write to private field'), n ? n.call(t8, r) : e.set(t8, r);
                            })(this, O, new Set(e));
                    }
                    ...
                    split(e, r = !1) {
                        let n = `[${(function sr(t8) {
                                if ('string' != typeof t8) throw new TypeError('Expected a string');
            ...
            function ln(t8, e) {
                var r;
                if ('text' === t8.type || 'comment' === t8.type || Pe(t8) || 'yaml' === t8.type || 'toml' === t8.type)
                    return null;
                if (
                    ('attribute' === t8.type && delete e.value,
                    'docType' === t8.type && delete e.value,
                    'angularControlFlowBlock' === t8.type && null != (r = e.parameters) && r.children)
                )
            ...
            function pn(t8, e) {
                if (!e) return;
                let r = ((t8) => String(t8).split(/[/\\]/).pop())(e).toLowerCase();
                return t8.find((n) => {
                    var s, i;
                    return (
                        (null == (s = n.extensions) ? void 0 : s.some((a) => r.endsWith(a))) ||
                        (null == (i = n.filenames) ? void 0 : i.some((a) => a.toLowerCase() === r))
                    );
                });
            }
            ...
            var de = function fi(t8) {
                    return 'element' === t8.type && !t8.hasExplicitNamespace && !['html', 'svg'].includes(t8.namespace);
                },
                ar = (t8) => ((t8) => v(!1, t8, /^[\t\f\r ]*\n/g, ''))(H.trimEnd(t8)),
                gn = (t8) => {
                    let e = t8,
            ...
            function _t(t8, e) {
                return !!(
                    ...
                    (ge(t8) && t8.children.some((r) => 'text' !== r.type && 'interpolation' !== r.type)) ||
            ...
            function Ge(t8) {
                return (
                    ...
                    (function di(t8) {
                        return 'comment' === t8.type && 'prettier-ignore' === t8.value.trim();
                    })(t8.prev)
                );
            }
            function N(t8) {
            ...
            function Ye(t8) {
                return (
                    Pe(t8) ||
                    (t8.next && t8.sourceSpan.end && t8.sourceSpan.end.line + 1 < t8.next.sourceSpan.start.line)
                );
            }
            function Dn(t8) {
                return (
                    ...
                    ('element' === t8.type &&
                        ...
                        (['body', 'script', 'style'].includes(t8.name) ||
                            t8.children.some((e) =>
                                (function Ci(t8) {
                                    var e;
                                    return null == (e = t8.children) ? void 0 : e.some((r) => 'text' !== r.type);
                                })(e),
                            ))) ||
                    (t8.firstChild &&
            ...
            function ur(t8) {
                return (
                    ...
                    (['html', 'head', 'ul', 'ol', 'select'].includes(t8.name) ||
                        (t8.cssDisplay.startsWith('table') && 'table-cell' !== t8.cssDisplay))
                );
            }
            function Et(t8) {
                return (
                    ...
                    (t8.prev &&
                        (function gi(t8) {
                            return bn(t8) || ('element' === t8.type && 'br' === t8.fullName) || vn(t8);
                        })(t8.prev)) ||
                    vn(t8)
                );
            }
            ...
            function yn(t8) {
                return (
                    ...
                    (t8.prev
                        ...
                        : 'root' === t8.parent.type || t8.parent.startSourceSpan.end.line < t8.sourceSpan.start.line)
                );
            }
            function wn(t8) {
                return (
                    ...
                    (t8.next
                        ...
                        : 'root' === t8.parent.type ||
                          (t8.parent.endSourceSpan && t8.parent.endSourceSpan.start.line > t8.sourceSpan.end.line))
                );
            }
            function bn(t8) {
                switch (t8.type) {
                ...
                if (t8)
                    switch (t8) {
                        ...
                        case 'text/x-handlebars-template':
                            return 'glimmer';
                        default:
                            if (t8.endsWith('json') || t8.endsWith('importmap') || 'speculationrules' === t8)
                                return 'json';
                    }
            }
            function lr(t8, e) {
            ...
            function kn(t8) {
                return ('element' === t8.type && (!t8.namespace || de(t8)) && dn[t8.name]) || 'normal';
            }
            function cr(
                t8,
                e = (function Ti(t8) {
            ...
            function Dt(t8, e) {
                return Ce(t8, e) && (Ke(t8, e) || (t8.attrMap.lang && 'html' !== t8.attrMap.lang));
            }
                    ...
                    getContext(e, r) {
                        ...
                        if (null != s) {
                            ...
                            let i = s,
                                ...
                                o = 0;
                            for (; a < e && s > 0 && (s--, a++, '\n' != n[s] || ++o != r); );
                            for (a = 0, o = 0; a < e && i < n.length - 1 && (i++, a++, '\n' != n[i] || ++o != r); );
            ...
            ((t8 = Tt || (Tt = {}))[(t8.WARNING = 0)] = 'WARNING'), (t8[(t8.ERROR = 1)] = 'ERROR');
            var Re = class {
                    ...
                    function Fi(t8) {
                        t8.walk((e) => {
                            if (
                                ...
                                let r = e.children[0];
                                1 === r.value.length ? e.removeChild(r) : (r.value = r.value.slice(1));
                            }
                        });
                    },
                    function Pi(t8) {
                        let e = (r) => {
                            ...
                            return (
                                'element' === r.type &&
                                'ieConditionalStartComment' === (null == (n = r.prev) ? void 0 : n.type) &&
                                r.prev.sourceSpan.end.offset === r.startSourceSpan.start.offset &&
                                'ieConditionalEndComment' === (null == (s = r.firstChild) ? void 0 : s.type) &&
                    ...
                    function Oi(t8) {
                        t8.walk((e) => {
                            ...
                            if (
                                ...
                                return (e.hasDanglingSpaces = e.children.length > 0), void (e.children = []);
                            ...
                            if (!r)
                                for (let s = 0; s < e.children.length; s++) {
                                    ...
                                    let { leadingWhitespace: a, text: o, trailingWhitespace: u } = gn(i.value),
                                        p = i.prev,
                                        l = i.next;
                                    o
                                        ? ((i.value = o),
                                        ...
                                        : (e.removeChild(i),
                                          s--,
                                          (a || u) &&
                                              (p && (p.hasTrailingSpaces = !0), l && (l.hasLeadingSpaces = !0)));
                                }
                        ...
                        t8.walk((r) => {
                            r.cssDisplay = (function xn(t8, e) {
                                ...
                                switch (e.htmlWhitespaceSensitivity) {
                                    ...
                                    default:
                                        return (
                                            ('element' === t8.type && (!t8.namespace || r || de(t8)) && fn[t8.name]) ||
                                            'inline'
                                        );
                                }
                            })(r, e);
                        ...
                        t8.walk((r) => {
                            'element' === r.type &&
                                (r.hasHtmComponentClosingTag =
                                    r.endSourceSpan &&
                                    /^<\s*\/\s*\/\s*>$/.test(
                                        e.originalText.slice(r.endSourceSpan.start.offset, r.endSourceSpan.end.offset),
                                    ));
                        });
                    },
                    function Vi(t8, e) {
                        t8.walk((r) => {
                            let { children: n } = r;
                            if (n) {
                                if (0 === n.length) return void (r.isDanglingSpaceSensitive = An(r));
                                for (let s of n)
                                    (s.isLeadingSpaceSensitive = _n(s, e)), (s.isTrailingSpaceSensitive = En(s, e));
                                for (let s = 0; s < n.length; s++) {
                                    let i = n[s];
                                    (i.isLeadingSpaceSensitive =
                                        (0 === s || i.prev.isTrailingSpaceSensitive) && i.isLeadingSpaceSensitive),
                        ...
                        t8.walk((r) => {
                            if (r.children)
                                for (let n = 0; n < r.children.length; n++) {
                                    ...
                                    let i = s.prev,
                                        a = s.next;
                                    (i.value += `<${s.rawName}>` + s.firstChild.value + `</${s.rawName}>` + a.value),
            ...
            function Ee(t8) {
                var e;
                return (
                    (null == (e = t8.lastChild) ? void 0 : e.isTrailingSpaceSensitive) &&
            ...
            function ji(t8, e, r) {
                ...
                let s =
                    ...
                    i = 'boolean' == typeof s ? () => s : Array.isArray(s) ? (d) => s.includes(d.rawName) : () => !1,
                    a = t8.map(({ node: d }) => (i(d) ? T(e.originalText.slice(se(d), ie(d))) : r()), 'attrs'),
                    o =
                        'element' === n.type &&
                        'script' === n.fullName &&
                        1 === n.attrs.length &&
                ...
                return (
                    (n.firstChild && Ze(n.firstChild)) || (n.isSelfClosing && Ee(n.parent)) || o
                        ...
                        : l.push(e.bracketSameLine ? (n.isSelfClosing ? ' ' : '') : n.isSelfClosing ? A : b),
                    l
                );
            }
            function Ki(t8) {
            ...
            function Bt(t8) {
                switch (t8.type) {
                    ...
                    case 'element':
                        if (t8.condition) return `\x3c!--[if ${t8.condition}]>\x3c!--\x3e<${t8.rawName}`;
                    default:
                        return `<${t8.rawName}`;
                }
            }
            ...
            var $e = function Qi(t8, e) {
                ...
                return (
                    Cr.has(r) ||
                        Cr.set(
                            r,
                            r.children.some((n) => yt(n, e) && ['ts', 'typescript'].includes(n.attrMap.lang)),
                        ),
                    Cr.get(r)
                );
            };
            ...
            var Un = function na(t8) {
                ...
                for (;;) {
                    if ((p(Zi), o >= e)) {
                        if (0 === l.length) throw new Error('Must contain one or more image candidate strings.');
                        return l;
                    }
                    ...
                    for (B = 0; B < n.length; B++)
                        (g = n[B]),
                            ...
                            Vn.test($) && 'w' === y2
                                ...
                                : (C = !0);
                    if (C) throw new Error(`Invalid srcset descriptor found in "${t8}" at "${g}".`);
            ...
            function K(t8, e) {
                ...
                return (
                    ...
                    ('ObjectExpression' === r.type ||
                        ...
                        (('__vue_expression' === e.parser || '__vue_ts_expression' === e.parser) &&
            ...
            var zn = function sa(t8) {
                if ('srcset' === t8.node.fullName && ('img' === t8.parent.fullName || 'source' === t8.parent.fullName))
                    return () =>
                        (function aa(t8) {
                            let e = Un(t8),
                                r = ia.filter((l) => e.some((m) => Object.prototype.hasOwnProperty.call(m, l)));
            ...
            function Yn(t8, e) {
                ...
                if ('style' === r.fullName && !e.parentParser && !n.includes('{{'))
                    return async (s) => De(await s(n, { parser: 'css', __isHTMLStyleAttribute: !0 }));
            }
                ...
                let s = L(r.node),
                    {
                        ...
                        if (!u.some((p, l) => !p && (0 === l || u.slice(l + 1).some(Boolean))))
            ...
            var Zn = function la(t8, e) {
                    ...
                    return (function Bn(t8) {
                        let e = t8.fullName;
                        return '#' === e.charAt(0) || 'slot-scope' === e || 'v-slot' === e || e.startsWith('v-slot:');
                    })(r) ||
                        (function Ln(t8, e) {
                            let r = t8.parent;
                            if (!Ce(r, e)) return !1;
                        ...
                        ? (a) =>
                              (function ca(t8, e, { parseWithTs: r }) {
                                  return (function Xn(t8) {
                                      ...
                                      : x(t8, e, { parser: r ? '__vue_ts_event_binding' : '__vue_event_binding' }, K);
                              })(s, a, { parseWithTs: i })
            ...
            function Ca(t8) {
                return async (e, r, n, s) => {
                    ...
                    if (i)
                        return (
                            (i = Ct(i, (a) => ('string' == typeof a ? v(!1, a, '"', '&quot;') : a))),
                            [n.node.rawName, '="', E(i), '"']
                        );
                };
            }
            var rs = function ga(t8, e) {
                ...
                if (r.value) {
                    if (
                        ...
                        ('lwc' === e.parser && r.value.startsWith('{') && r.value.endsWith('}'))
                    )
            ...
            var ns = function Sa(t8, e, r, n) {
                    ...
                    return /^\s*$/.test(i)
                        ? ''
                        : x(i, t8, { parser: '__ng_directive', __isInHtmlAttribute: !1, trailingComma: 'none' }, K);
                },
                ...
                switch (r.type) {
                                ...
                                ? async (s, i) => {
                                      ...
                                      return (
                                          o ||
                                              ...
                                              (o = '' === u)),
                                          [W(r, e), E(et(t8, e, i)), o ? '' : S, u, o ? '' : S, Qe(r, e), U(r, e)]
                                      );
                                  }
                                : void 0;
                        }
                    ...
                    case 'text':
                        if (V(r.parent)) {
                            ...
                            if (n)
                                return async (s) => {
                                    let i = 'markdown' === n ? cr(r.value.replace(/^[^\S\n]*\n/, '')) : r.value,
                                    ...
                                    if ('html' === e.parser && 'babel' === n) {
                                        ...
                                        u &&
                                            ('module' === u.type ||
                                                ('text/babel' === u.type && 'module' === u['data-type'])) &&
                                            (o = 'module'),
                                            (a.__babelSourceType = o);
                                    }
                                    return [re, W(r, e), await s(i, a, { stripTrailingHardline: !0 }), U(r, e)];
                                };
                            ...
                            return async (n) => {
                                ...
                                return (
                                    'angular' === e.parser
                                        ...
                                        : 'vue' === e.parser
                                        ? (s.parser = $e(t8, e) ? '__vue_ts_expression' : '__vue_expression')
                                        : (s.parser = '__js_expression'),
                                    [R([A, await n(r.value, s)]), r.parent.next && j(r.parent.next) ? ' ' : A]
                                );
                            };
                        break;
                    case 'attribute':
            ...
            function Pt(t8, e) {
                return N(t8) && N(e)
                    ? t8.isTrailingSpaceSensitive
                        ...
                        : b
                    : (Je(t8) &&
                          (Ge(e) || e.firstChild || e.isSelfClosing || ('element' === e.type && e.attrs.length > 0))) ||
                      ('element' === t8.type && t8.isSelfClosing && j(e))
                    ? ''
                    : !e.isLeadingSpaceSensitive ||
                      Et(e) ||
                      (j(e) && t8.lastChild && Ae(t8.lastChild) && t8.lastChild.lastChild && Ae(t8.lastChild.lastChild))
                    ? S
                    : e.hasLeadingSpaces
                    ? A
                    : b;
            ...
            function Oe(t8, e, r) {
                ...
                return t8.map((i, a) => {
                    ...
                    return (
                        ...
                        C && (Ye(o) ? N(o.next) && m.push(S, S) : C === S ? N(o.next) && m.push(S) : l.push(C)),
                    ...
                    : a([
                          ...
                          (n.next ? j(n.next) : Ee(n.parent))
                              ...
                              : ('comment' === n.lastChild.type ||
                                ...
                                new RegExp(`\\n[\\t ]{${e.tabWidth * (t8.ancestors.length - 1)}}$`).test(
                                    n.lastChild.value,
                                )
                              ? ''
                              : b,
            ...
            function us(t8) {
                var e, r;
                return !(
                    'angularControlFlowBlock' === (null == (e = t8.next) ? void 0 : e.type) &&
                        ...
                        switch (n.type) {
                            ...
                            case 'text': {
                                if ('interpolation' === n.parent.type) {
                                    let i = /\n[^\S\n]*$/,
                                        a = i.test(n.value);
                                    return [T(a ? n.value.replace(i, '') : n.value), a ? S : ''];
                                }
                            ...
                            case 'docType':
                                return [
                                    E([tt(n, e), ' ', v(!1, n.value.replace(/^html\b/i, 'html'), /\s+/g, ' ')]),
                                    Xe(n, e),
                                ];
                            case 'comment':
            ...
            function it(t8) {
                ...
                let e = t8.indexOf(':', 1);
                if (-1 === e) throw new Error(`Unsupported format "${t8}" expecting ":namespace:name"`);
                ...
                h = class {
                    ...
                    getContentType(e) {
                        return 'object' == typeof this.contentType
                            ? (void 0 === e ? void 0 : this.contentType[e]) ?? this.contentType.default
                            : this.contentType;
                    }
                };
            function He(t8) {
                return (
                    at ||
                        ...
                        (at = Object.assign(Object.create(null), {
                            ...
                            tbody: new h({ closedByChildren: ['tbody', 'tfoot'], closedByParent: !0 }),
                            ...
                            foreignObject: new h({ implicitNamespacePrefix: 'svg', preventNamespaceInheritance: !0 }),
                            ...
                            rb: new h({ closedByChildren: ['rb', 'rt', 'rtc', 'rp'], closedByParent: !0 }),
                            rt: new h({ closedByChildren: ['rb', 'rt', 'rtc', 'rp'], closedByParent: !0 }),
                            rtc: new h({ closedByChildren: ['rb', 'rtc', 'rp'], closedByParent: !0 }),
                            rp: new h({ closedByChildren: ['rb', 'rt', 'rtc', 'rp'], closedByParent: !0 }),
                            optgroup: new h({ closedByChildren: ['optgroup'], closedByParent: !0 }),
                            option: new h({ closedByChildren: ['option', 'optgroup'], closedByParent: !0 }),
                            ...
                            title: new h({ contentType: { default: F.ESCAPABLE_RAW_TEXT, svg: F.PARSABLE_DATA } }),
                            textarea: new h({ contentType: F.ESCAPABLE_RAW_TEXT, ignoreFirstLf: !0 }),
                        })),
                        new (class extends class {} {
                            ...
                            hasElement(e, r) {
                                return (
                                    !!(
                                        ...
                                        (e.indexOf('-') > -1 && (vr(e) || yr(e) || r.some((n) => n.name === Ar_name)))
                            ...
                            normalizeAnimationStyleValue(e, r, n) {
                                ...
                                if (
                                    ...
                                    if ('number' == typeof n) s = 'px';
                                        ...
                                        let o = n.match(/^[+-]?[\d\.]+([a-z]*)$/);
                                        o && 0 == o[1].length && (a = `Please provide a CSS unit value for ${r}:${n}`);
                                    }
                            ...
                            .allKnownElementNames()
                            .forEach((e) => {
                                !at[e] && null === Me(e) && (at[e] = new h({ canSelfClose: !1 }));
                            })),
                    at[t8] ?? Ss
                );
            }
            ...
            function zt(t8, e, r = null) {
                let n = [],
                    s = t8.visit ? (i) => t8.visit(i, r) || i.visit(t8, r) : (i) => i.visit(t8, r);
                return (
                    e.forEach((i) => {
                        let a = s(i);
                        a && n.push(a);
            ...
            var pt = class {
                ...
                Pr = class {
                    constructor(e, r, n) {
                        (this._getTagContentType = r),
                            ...
                            (this._leadingTriviaCodePoints =
                                n.leadingTriviaChars && n.leadingTriviaChars.map((i) => i.codePointAt(0) || 0)),
                    ...
                    _getBlockName() {
                        ...
                        return (
                            this._attemptCharCodeUntilFn((n) => (wt(n) ? !e : !xs(n) || ((e = !0), !1))),
                    ...
                    _consumeBlockParameters() {
                        for (
                            ...
                            let e = this._cursor.clone(),
                                r = null,
                                n = 0;
                            for (; (59 !== this._cursor.peek() && 0 !== this._cursor.peek()) || null !== r; ) {
                    ...
                    _endToken(e, r) {
                        ...
                        return (
                            this.tokens.push(n), (this._currentTokenStart = null), (this._currentTokenType = null), n
                        );
                    }
                    _createError(e, r) {
                        this._isInExpansionForm() &&
                    ...
                    handleError(e) {
                        if (
                            (e instanceof ht && (e = this._createError(e.msg, this._cursor.getSpan(e.cursor))),
                            !(e instanceof pt))
                        )
                            throw e;
                    ...
                    _consumeEntity(e) {
                        ...
                        if ((this._cursor.advance(), this._attemptCharCode(35))) {
                            ...
                            if ((this._attemptCharCodeUntilFn(io), 59 != this._cursor.peek())) {
                                this._cursor.advance();
                            ...
                            let n = this._cursor.clone();
                            if ((this._attemptCharCodeUntilFn(ao), 59 != this._cursor.peek()))
                    ...
                    _consumePrefixAndName() {
                        let n,
                            ...
                            r = '';
                        for (; 58 !== this._cursor.peek() && !so(this._cursor.peek()); ) this._cursor.advance();
                        return (
                            58 === this._cursor.peek()
                                ? ((r = this._cursor.getChars(e)), this._cursor.advance(), (n = this._cursor.clone()))
                                : (n = e),
                    ...
                    _consumeTagOpen(e) {
                        ...
                        try {
                            ...
                            if (o instanceof pt)
                                return void (s ? (s.type = 4) : (this._beginToken(5, e), this._endToken(['<'])));
                            throw o;
                        }
                        ...
                        this._handleFullNameStackForTagOpen(n, r),
                            a === F.RAW_TEXT
                                ...
                                : a === F.ESCAPABLE_RAW_TEXT && this._consumeRawTextWithTagClose(n, r, !0);
                    }
                    ...
                    _consumeAttributeName() {
                        ...
                        if (39 === e || 34 === e) throw this._createError(Ue(e), this._cursor.getSpan());
                        this._beginToken(14);
                        let r = this._consumePrefixAndName();
                    ...
                    _consumeInterpolation(e, r, n) {
                        ...
                        for (; 0 !== this._cursor.peek() && (null === n || !n()); ) {
                            ...
                            if (this._isTagStart())
                                return (
                                    (this._cursor = u), s.push(this._getProcessedChars(i, u)), void this._endToken(s)
                                );
                            if (null === a) {
                    ...
                    _isTagStart() {
                        if (60 === this._cursor.peek()) {
                            ...
                            e.advance();
                            let r = e.peek();
                            if ((97 <= r && r <= 122) || (65 <= r && r <= 90) || 47 === r || 33 === r) return !0;
                        }
                        return !1;
                    }
                    _isBlockStart() {
                    ...
                    _isInExpansionCase() {
                        return (
                            ...
                            22 === this._expansionCaseStack[this._expansionCaseStack.length - 1]
                        );
                    }
                    _isInExpansionForm() {
                        return (
                            this._expansionCaseStack.length > 0 &&
                            20 === this._expansionCaseStack[this._expansionCaseStack.length - 1]
                        );
                    }
            ...
            function bs(t8) {
                return wt(t8) || 62 === t8 || 60 === t8 || 47 === t8 || 39 === t8 || 34 === t8 || 61 === t8 || 0 === t8;
            }
            function so(t8) {
            ...
            var Kt = class t3 {
                    ...
                    advanceState(e) {
                        ...
                        10 === r ? (e.line++, (e.column = 0)) : fr(r) || e.column++, e.offset++, this.updatePeek(e);
                    }
                    updatePeek(e) {
                ...
                Nr = class t4 extends Kt {
                    ...
                    decodeHexDigits(e, r) {
                        let n = this.input.slice(e.internalState.offset, e.internalState.offset + r),
                            s = parseInt(n, 16);
                        if (isNaN(s))
                ...
                Or = class t6 {
                    ...
                    build() {
                        ...
                        for (let e of this._containerStack)
                            e instanceof J &&
                                this.errors.push(I.create(e.name, e.sourceSpan, `Unclosed block "${e.name}"`));
                    }
                    _advance() {
                        let e = this._peek;
                        return (
                    ...
                    _consumeExpansion(e) {
                        ...
                        if (24 !== this._peek.type)
                            return void this.errors.push(
                                I.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '}'."),
                            );
                    ...
                    _parseExpansionCase() {
                        ...
                        let a = new f(e.sourceSpan.start, s.sourceSpan.end, e.sourceSpan.fullStart),
                        ...
                        })(e.parts[0], i.rootNodes, a, e.sourceSpan, o);
                    }
                    _collectExpansionExpTokens(e) {
                        ...
                        for (;;) {
                            if (
                                ((20 === this._peek.type || 22 === this._peek.type) && n.push(this._peek.type),
                                23 === this._peek.type)
                            ) {
                                if (!Ns(n, 22))
                                    return (
                            ...
                            if (30 === this._peek.type)
                                return (
                                    this.errors.push(I.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'.")),
                                    null
                                );
                    ...
                    _consumeText(e) {
                        ...
                        if (s.length > 0 && '\n' === s[0]) {
                            ...
                            null != i &&
                                ...
                                ((s = s.substring(1)), (r[0] = { type: e.type, sourceSpan: e.sourceSpan, parts: [s] }));
                        }
                    ...
                    _consumeStartTag(e) {
                        let [r, n] = e.parts,
                            s = [];
                        for (; 14 === this._peek.type; ) s.push(this._consumeAttr(this._advance()));
                        ...
                        this._pushContainer(m, d instanceof z && this.getTagDefinition(d.name).isClosedByChild(m.name)),
                            a
                                ? this._popContainer(i, z, u)
                                : 4 === e.type &&
                                  (this._popContainer(i, z, null),
                                  this.errors.push(I.create(i, u, `Opening tag "${i}" not terminated.`)));
                    }
                    _pushContainer(e, r) {
                    ...
                    _consumeEndTag(e) {
                        let r =
                            this.allowHtmComponentClosingTags && 0 === e.parts.length
                                ? null
                                : this._getElementFullName(e.parts[0], e.parts[1], this._getClosestParentElement());
                        if (r && this.getTagDefinition(r).isVoid)
                            this.errors.push(
                                I.create(r, e.sourceSpan, `Void elements do not have end tags "${e.parts[1]}"`),
                            );
                    ...
                    _popContainer(e, r, n) {
                        ...
                        for (let i = this._containerStack.length - 1; i >= 0; i--) {
                            ...
                            if (
                                Me(a.name)
                                    ? a.name === e
                                    : (null == e || a.name.toLowerCase() === e.toLowerCase()) && a instanceof r
                            )
                                return (
                                    (a.endSourceSpan = n),
                            ...
                            (a instanceof J || (a instanceof z && !this.getTagDefinition(a.name).closedByParent)) &&
                                (s = !0);
                        }
                        return !1;
                    }
                    _consumeAttr(e) {
                        ...
                        if (16 === this._peek.type)
                            for (
                                ...
                                16 === this._peek.type || 17 === this._peek.type || 9 === this._peek.type;
                        ...
                        15 === this._peek.type && (u = n = this._advance().sourceSpan.end);
                        let l =
                            o && u && new f(s?.sourceSpan.start ?? o.start, u, s?.sourceSpan.fullStart ?? o.fullStart);
                        return new Vt(
                            r,
                            i,
                    ...
                    _getClosestParentElement() {
                        for (let e = this._containerStack.length - 1; e > -1; e--)
                            if (this._containerStack[e] instanceof z) return this._containerStack[e];
                        return null;
                    }
                    _addToParent(e) {
                        ...
                        (Mr = new (class extends class {
                            ...
                            parse(e, r, n, s = !1, i) {
                                ...
                                return (
                                    ...
                                    })(_2.rootNodes, m.errors.concat(_2.errors))
                                );
                            }
                        } {
                            constructor() {
            ...
            var Rs = function ho(t8) {
                ...
                let { startDelimiter: r, language: n, value: s = '', endDelimiter: i } = e.groups,
                    a = n.trim() || 'yaml';
                if (('+++' === r && (a = 'toml'), 'yaml' !== a && r !== i)) return { content: t8 };
                let [o] = e;
                return {
                    frontMatter: {
                        type: 'front-matter',
            ...
            function Vs(t8, e, r) {
                ...
                if ('vue' === n) {
                    ...
                    let g,
                        ...
                        $ = (w2) =>
                            y2().rootNodes.find(
                                ({ startSourceSpan: q2 }) => q2 && q2.start.offset === w2.startSourceSpan.start.offset,
                            ) ?? w2;
                    for (let [w2, q2] of l.entries()) {
                        ...
                        if (null === Wr2) (m = y2().errors), (l[w2] = $(q2));
                            ...
                            let zr2 = y2().errors.find(
                                (Gr2) =>
                                    Gr2.span.start.offset > js.start.offset && Gr2.span.start.offset < Wr2.end.offset,
                            );
                            zr2 && Hs(zr2), (l[w2] = $(q2));
                        }
                    }
            ...
            function Ao(t8, e) {
                ...
                let r = null == (n = t8.attrs.find((s) => 'lang' === s.name)) ? void 0 : n.value;
            ...
            function Us(t8, e, r = {}, n = !0) {
                let { frontMatter: s, content: i } = n ? Rs(t8) : { frontMatter: null, content: t8 },
                ...
                let l = new (class t7 {
                        constructor(e = {}) {
                            for (let r of new Set([...Ms, ...Object.keys(e)])) this.setProperty(r, e[r]);
                        }
                        setProperty(e, r) {
                            if (this[e] !== r) {
                    ...
                    m = (d, C) => {
                        ...
                        return (
                            c.length === _2
                                ? B.children.shift()
                                : ((c.sourceSpan = new f(c.sourceSpan.start.moveBy(_2), c.sourceSpan.end)),
            ...
            var Ws = {
                ...
                yo = tr({
                    ...
                    shouldParseAsRawText: (t8, e, r, n) =>
                        ...
                        ('template' !== t8 ||
                            n.some(
                                ({ name: s, value: i }) => 'lang' === s && 'html' !== i && '' !== i && void 0 !== i,
                            )),
                }),
                ...
                Me2 = (e, t8) => () => (t8 || e((t8 = { exports: {} }).exports, t8), t8.exports),
                We = (e, t8) => {
                ...
                nr2 = (e, t8, r, n) => {
                    if ((t8 && 'object' == typeof t8) || 'function' == typeof t8)
                        for (let o of Fu(t8))
                            !du.call(e, o) &&
                                o !== r &&
                                $e2(e, o, { get: () => t8[o], enumerable: !(n = fu(t8, o)) || n.enumerable });
                    return e;
                },
                he2 = (e, t8, r) => (
                    (r = null != e ? lu(pu(e)) : {}),
                    nr2(!t8 && e && e.__esModule ? r : $e2(r, 'default', { value: e, enumerable: !0 }), e)
                ),
                ht2 = (e, t8, r) => {
                ...
                or2 = Me2((gt2) => {
                    ...
                    function gu(e, t8, r, n, o) {
                        for (var u = 0, i = t8.length, s = 0, D = 0; u < i; u++) {
                            ...
                            if (a.removed) {
                                if (
                                    ((a.value = e.join(n.slice(D, D + a.count))), (D += a.count), u && t8[u - 1].added)
                                ) {
                                    var d = t8[u - 1];
                                    (t8[u - 1] = t8[u]), (t8[u] = d);
                                }
                        ...
                        (ur2.prototype = {
                            diff: function (t8, r) {
                                var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                                    o = n.callback;
                                'function' == typeof n && ((o = n), (n = {})), (this.options = n);
                                var u = this;
                                function i(F2) {
                                    return o
                                        ? (setTimeout(function () {
                                        ...
                                        if (h2 || B) {
                                            if (
                                                (!h2 || (B && E2.newPos < C.newPos)
                                                    ...
                                                    : ((m = E2).newPos++, u.pushComponent(m.components, !0, void 0)),
                            ...
                            equals: function (t8, r) {
                                return this.options.comparator
                                    ...
                                    : t8 === r || (this.options.ignoreCase && t8.toLowerCase() === r.toLowerCase());
                            },
                ...
                yn2 = Me2((Ft2) => {
                    Object.defineProperty(Ft2, '__esModule', { value: !0 }),
                        ...
                        (Ft2.default = function ao2(e, t8, r, n = {}) {
                            if (!En2) {
                                ...
                                (new Error(u).name = 'DeprecationWarning'), console.warn(new Error(u));
                            }
                            return (r = Math.max(r, 0)), gn2(e, { start: { column: r, line: t8 } }, n);
                        });
                    var e,
                        jt2,
                        dn2 = (pn2(), (e = Fn2), nr2($e2({}, '__esModule', { value: !0 }), e)),
                    ...
                    function gn2(e, t8, r = {}) {
                        let n = (r.highlightCode || r.forceColor) && (0, dn2.shouldHighlight)(r),
                            o = (function io2(e) {
                                return e
                                    ? (null != jt2 || (jt2 = new mn2.default.constructor({ enabled: !0, level: 1 })),
                                      jt2)
                                    : mn2.default;
                            })(r.forceColor),
                            u = (function so2(e) {
                            ...
                            l = (n ? (0, dn2.default)(e, r) : e)
                                ...
                                .map((F2, m) => {
                                    ...
                                    if (h2) {
                                        let Z = '';
                                        if (Array.isArray(h2)) {
                                            let $ = F2.slice(0, Math.max(h2[0] - 1, 0)).replace(/[^\t]/g, ' '),
                                                Q2 = h2[1] || 1;
                                            (Z = [
                                                '\n ',
            ...
            function At2(e, t8 = {}) {
                return (
                    ...
                    { type: _, id: t8.id, contents: e, break: !!t8.shouldBreak, expandedStates: t8.expandedStates }
                );
            }
            function Ge2(e) {
            ...
            function ke2(e, t8) {
                let r = [];
                for (let n = 0; n < t8.length; n++) 0 !== n && r.push(e), r.push(t8[n]);
                return r;
            }
            function qe2(e, t8, r) {
                let n = e;
            ...
            var y = (e, t8, r) => {
                if (!e || null != t8)
                    return Array.isArray(t8) || 'string' == typeof t8 ? t8[r < 0 ? t8.length + r : r] : t8.at(r);
            };
            function be2(e) {
                switch (e) {
                    case 'cr':
            ...
            var we2 = function Tu(e) {
                ...
                br2 = (e) => {
                    ...
                    if (e.type !== k2) throw new Error("Expect doc to be 'array' or 'fill'.");
                    return e.parts;
                };
            function Ne2(e, t8) {
            ...
            function Su(e) {
                if ((e.type === _ && e.break) || (e.type === A2 && e.hard) || e.type === b2) return !0;
            }
            function xr(e) {
                if (e.length > 0) {
                    let t8 = y(!1, e, -1);
            ...
            function vu(e) {
                return e.type !== A2 || e.hard ? (e.type === x2 ? e.flatContents : e) : e.soft ? '' : ' ';
            }
            function kr(e) {
                for (e = [...e]; e.length >= 2 && y(!1, e, -2).type === A2 && y(!1, e, -1).type === b2; ) e.length -= 2;
                if (e.length > 0) {
                    let t8 = Oe2(y(!1, e, -1));
                    e[e.length - 1] = t8;
                }
                            ...
                            (function Pu(e) {
                                switch (U2(e)) {
                                    ...
                                    case j2: {
                                        ...
                                        return 0 === t8.length ? '' : 1 === t8.length ? t8[0] : t8;
                                    }
                                    case M:
                                    case W2:
                                    case v2:
            ...
            function Yu(e, t8, r) {
                return t8 === Number.NEGATIVE_INFINITY
                    ...
                    ? 'root' === t8.type
                        ? { ...e, root: e }
                        : xt2(e, { type: 'string' == typeof t8 ? 'stringAlign' : 'numberAlign', n: t8 }, r)
                    : e;
            }
            function xt2(e, t8, r) {
                let n = 'dedent' === t8.type ? e.queue.slice(0, -1) : [...e.queue, t8],
                    o = '',
                    u = 0,
                    i = 0,
                    s = 0;
                ...
                for (; r >= 0; ) {
                    ...
                    switch (U2(c)) {
                        ...
                        case _: {
                            ...
                            let d = c.break ? R2 : a,
                                f2 = c.expandedStates && d === R2 ? y(!1, c.expandedStates, -1) : c.contents;
            ...
            function fe2(e, t8) {
                let r = {},
                    ...
                    o = be2(t8.endOfLine),
                    u = 0,
                    i = [{ ind: { value: '', length: 0, queue: [] }, mode: R2, doc: e }],
                    s = [],
                    D = !1,
                    a = [],
                    c = 0;
                for (
                    ...
                    switch (U2(l)) {
                        ...
                        case k2: {
                            ...
                            let Q2 = { ind: f2, mode: p, doc: Ge2(m) },
                                rr2 = m[0];
                            Qe2({ ind: f2, mode: K2, doc: [E2, C, rr2] }, [], F2, a.length > 0, r, !0)
                                ? i.push(Q2, Z, g)
                                : B
                                ? i.push(Q2, $, g)
                                : i.push(Q2, $, h2);
                    ...
                    0 === i.length && a.length > 0 && (i.push(...a.reverse()), (a.length = 0));
                }
                let d = s.indexOf(Te2);
                if (-1 !== d) {
            ...
            function J2(e) {
                ...
                return e.type === x2
                    ? { ...e, breakContents: J2(e.breakContents), flatContents: J2(e.flatContents) }
                    : e.type === _
                    ? {
                          ...e,
                          contents: J2(e.contents),
                          expandedStates: null == (t8 = e.expandedStates) ? void 0 : t8.map(J2),
                      }
                    : e.type === k2
            ...
            function et2({ plugins: e = [], showDeprecated: t8 = !1 } = {}) {
                ...
                for (let o of (function $u(e) {
                    ...
                    for (let [r, n] of Object.entries(e)) {
                        let o = { name: r, ...n };
                        Array.isArray(o.default) && (o.default = y(!1, o.default, -1).value), t8.push(o);
                    }
                    return t8;
                    ...
                    (!t8 && o.deprecated) ||
                        (Array.isArray(o.choices) &&
                            ...
                            'parser' === o.name && (o.choices = [...o.choices, ...Vu(o.choices, r, e)])),
                        (o.pluginDefaults = Object.fromEntries(
                            e
                                .filter((u) => {
                                    var i;
                                    return void 0 !== (null == (i = u.defaultOptions) ? void 0 : i[o.name]);
                                })
                ...
                for (let o of t8)
                    if (o.parsers)
                        for (let u of o.parsers)
                            if (!n.has(u)) {
                                n.add(u);
                                let i = r.find((D) => D.parsers && Object.prototype.hasOwnProperty.call(D.parsers, u)),
                                    s = o.name;
            ...
            function Ir(e, t8) {
                if (!t8) return;
                let r = ((e) => String(e).split(/[/\\]/).pop())(t8).toLowerCase();
                return e.find((n) => {
                    var o, u;
                    return (
                        (null == (o = n.extensions) ? void 0 : o.some((i) => r.endsWith(i))) ||
                        (null == (u = n.filenames) ? void 0 : u.some((i) => i.toLowerCase() === r))
                    );
                });
            }
                    ...
                    t8 &&
                        n.push(
                            [`- ${se2.default.blue(t8.title)}:`]
                                .concat(t8.values.map((o) => Ur2(o, r - $r2.length).replace(/^|\n/g, `$&${$r2}`)))
                                .join('\n'),
                        ),
                    zr(n, r)
                );
            ...
            var rt2 = (e, t8, { descriptor: r, logger: n, schemas: o }) => {
                    let u = [`Ignored unknown option ${Nt2.default.yellow(r.pair({ key: e, value: t8 }))}.`],
                        i = Object.keys(o)
                            .sort()
                            .find(
                                (s) =>
            ...
            function Ku(e, t8, r) {
                return 'function' == typeof e ? (...n) => e(...n.slice(0, r - 1), t8, ...n.slice(r - 1)) : () => e;
            }
            ...
            function St2(e) {
                ...
                return (
                    ...
                    })(void 0 !== (t8 || r), 'Unexpected `expected` result, there should be at least one field.'),
                    r ? { text: t8, list: { title: r.title, values: r.values.map(St2) } } : { text: t8 }
                );
            }
            function vt2(e, t8) {
            ...
            function Pt2(e, t8, r = !1) {
                return !1 !== e && (!0 === e ? !!r || [{ value: t8 }] : 'value' in e ? [e] : 0 !== e.length && e);
            }
            function Hr2(e, t8) {
            ...
            function st2(e, t8) {
                return void 0 === e ? [] : Array.isArray(e) ? e.map((r) => Hr2(r, t8)) : [Hr2(e, t8)];
            }
            function Lt2(e, t8) {
                let r = st2('object' == typeof e && 'redirect' in e ? e.redirect : e, t8);
                return 0 === r.length
            ...
            var It2,
                    ...
                    constructor(t8) {
                        super(t8),
                            (this._choices = (function Jr2(e, t8) {
                                ...
                                t8.choices.map((r) => (r && 'object' == typeof r ? r : { value: r })),
                                'value',
                            ));
                    }
                ...
                nn2 = rt2,
                un2 = (e, t8, r) => {
                    let { text: n, list: o } = r.normalizeExpectedResult(r.schemas[e].expected(r)),
                        u = [];
                    return (
                ...
                on2 = (e, t8, { descriptor: r }) => {
                    let n = [`${bt2.default.yellow('string' == typeof e ? r.key(e) : r.pair(e))} is deprecated`];
                    return (
                        t8 &&
                            n.push(
                                `we now treat it as ${bt2.default.blue(
                                    'string' == typeof t8 ? r.key(t8) : r.pair(t8),
                                )}`,
                            ),
                        n.join('; ') + '.'
                    );
            ...
            function Zu(e, { isCLI: t8, optionInfos: r, FlagSchema: n }) {
                ...
                switch (e.type) {
                    ...
                    case 'flag':
                        (i = n),
                            (u.flags = r.flatMap((D) =>
                                [D.alias, D.description && D.name, D.oppositeDescription && `no-${D.name}`].filter(
                                    Boolean,
                                ),
                            ));
                        break;
                ...
                if (
                    ...
                    e.redirect &&
                        (s.redirect = (D) =>
                            D ? { to: { key: e.redirect.option, value: e.redirect.value } } : void 0),
            ...
            var sn2 = function Ju(
                e,
                t8,
                { logger: r = !1, isCLI: n = !1, passThrough: o = !1, FlagSchema: u, descriptor: i } = {},
            ) {
                if (n) {
                ...
                let s = o
                    ...
                    D = (function Xu(e, { isCLI: t8, FlagSchema: r }) {
                        ...
                        for (let o of e)
                            n.push(Zu(o, { isCLI: t8, optionInfos: e, FlagSchema: r })),
                                o.alias && t8 && n.push(nt2.create({ name: o.alias, sourceName: o.name }));
                        return n;
                    ...
                    a = new (class {
                        ...
                        _applyNormalization(t8, r) {
                            ...
                            for (let i of o) {
                                ...
                                let a = ({ from: p, to: l }) => {
                                        n.push('string' == typeof l ? { [l]: p } : { [l.key]: l.value });
                                    },
                                        ...
                                        if (!1 !== F2)
                                            if (!0 === F2)
                                                this._hasDeprecationWarned(i) ||
                                                    this._utils.logger.warn(this._deprecatedHandler(i, l, this._utils));
                                            else
                                                for (let { value: m } of F2) {
                                                    let E2 = { key: i, value: m };
                                                    if (!this._hasDeprecationWarned(E2)) {
                                                        let C = 'string' == typeof l ? { key: l, value: m } : l;
                    ...
                    })(D, { logger: r, unknown: s, descriptor: i }),
                    c = !1 !== r;
            ...
            var re2 = async function Qu(e, t8 = {}) {
                    ...
                    let r = { ...e };
                    if (!r.parser) {
                        if (!r.filepath) throw new ve2("No parser and no file path given, couldn't infer a parser.");
                    ...
                    let n = et2({ plugins: e.plugins, showDeprecated: !0 }).options,
                        o = {
                            ...cn2,
                            ...Object.fromEntries(
                                n.filter((f2) => void 0 !== f2.default).map((f2) => [f2.name, f2.default]),
                            ),
                        },
                    ...
                    let c = {
                        ...o,
                        ...(s.defaultOptions
                            ? Object.fromEntries(Object.entries(s.defaultOptions).filter(([, f2]) => void 0 !== f2))
                            : {}),
                    };
                    for (let [f2, p] of Object.entries(c)) (null === r[f2] || void 0 === r[f2]) && (r[f2] = p);
                    return (
                        'json' === r.parser && (r.trailingComma = 'none'),
                        sn2(r, n, { passThrough: Object.keys(cn2), ...t8 })
                    );
                },
                ln2 = new Set(['tokens', 'comments', 'parent', 'enclosingNode', 'precedingNode', 'followingNode']),
            ...
            var Bn2 = class {
                    ...
                    match(...t8) {
                        ...
                        for (let u of t8) {
                            ...
                            let i = null;
                            if (
                                ('number' == typeof n && ((i = n), (n = this.stack[r--]), (o = this.stack[r--])),
                                u && !u(o, n, i))
                            )
                                return !1;
            ...
            function Et2(e, t8) {
                ...
                let {
                    printer: { getCommentChildNodes: r, canAttachComment: n, getVisitorKeys: o },
                    locStart: u,
                    locEnd: i,
                } = t8;
                if (!n) return [];
            ...
            function On2(e, t8, r, n) {
                ...
                for (; d < f2; ) {
                    ...
                    if (m <= i) (a = l), (d = p + 1);
                        ...
                        if (!(s <= F2)) throw new Error('Comment location overlaps with node location');
                        (c = l), (f2 = p);
                    }
                }
            ...
            function wn2(e, t8) {
                ...
                for (i = r; i > 0; --i) {
                    ...
                    if (!((null == (D = (s = t8.printer).isGap) ? void 0 : D.call(s, f2, t8)) ?? /^[\s(]*$/.test(f2)))
                        break;
                    u = t8.locStart(a);
                }
            ...
            function Bo(e, t8) {
                ...
                if (0 === (r.comments || []).filter((D) => !n.has(D)).length) return { leading: '', trailing: '' };
                let s,
                    u = [],
                    i = [];
                return (
                            ...
                            : c &&
                              ((s = (function Ao2(e, t8, r) {
                                  ...
                                  let n = e.node,
                                      ...
                                      D = null == (a = u.isBlockComment) ? void 0 : a.call(u, n);
                                  if (
                ...
                !(function p() {
                    ...
                    if (F2) {
                        if ('function' == typeof F2)
                            return void c.push({ print: F2, node: l, pathStack: [...e.stack] });
                        o.set(l, F2);
                    }
                })();
                let d = e.stack;
            ...
            async function Ht2(e, t8) {
                ...
                (t8[Symbol.for('comments')] = r),
                    ...
                    (function Nn2(e, t8) {
                        ...
                        if ((wn2(n, t8), !i))
                            for (let p of r) delete p.precedingNode, delete p.enclosingNode, delete p.followingNode;
                    })(e, t8);
                let {
            ...
            function qt2(e, t8, r, n, o = [], u) {
                let { locStart: i, locEnd: s } = r,
                    D = i(e),
                    a = s(e);
                if (!(t8 > a || t8 < D || ('rangeEnd' === u && t8 === D) || ('rangeStart' === u && t8 === a))) {
            ...
            function Mn2(e, t8, r) {
                ...
                if ((({ parser: e }) => 'json' === e || 'json5' === e || 'json-stringify' === e)(t8)) {
                    ...
                    ({ startNode: d, endNode: f2 } = (function Oo(e, t8, { locStart: r, locEnd: n }) {
                        let o = e.node,
                            u = t8.node;
            ...
            async function qn2(e, t8, r = 0) {
                ...
                if (r > 0) {
                    ...
                    void 0 !== i.cursorNodeStart && (i.cursorNodeStart -= i.formatted.indexOf(D)),
                    ...
                    if (
                        (t8.cursorNode && i.cursorNodeText
                            ? ((D = t8.locStart(t8.cursorNode)),
                              ...
                              (d = i.cursorNodeStart),
                              (f2 = i.cursorNodeText))
                            : ((D = 0), (a = o), (c = t8.cursorOffset), (d = 0), (f2 = i.formatted)),
                        a === f2)
                    )
            ...
            function Jt2(e, t8, r) {
                return 'number' != typeof t8 || Number.isNaN(t8) || t8 < 0 || t8 > e.length ? r : t8;
            }
            function zn2(e, t8) {
            ...
            function Jn2(e, t8) {
                let { cursorOffset: r, rangeStart: n, rangeEnd: o, endOfLine: u } = zn2(e, t8),
                    i = '\ufeff' === e.charAt(0);
                if (
                    (i && ((e = e.slice(1)), r--, n--, o--),
                    'auto' === u &&
                ...
                return {
                    hasBOM: i,
                    text: e,
                    options: zn2(e, { ...t8, cursorOffset: r, rangeStart: n, rangeEnd: o, endOfLine: u }),
                };
            }
            ...
            async function Xt2(e, t8) {
                ...
                return (o.rangeStart >= o.rangeEnd && '' !== n) || (o.requirePragma && !(await Gn2(n, o)))
                                ...
                                let { ast: r, text: n } = await De2(e, t8),
                                    ...
                                    c = await qn2(
                                        i,
                                        {
                                            ...
                                            cursorOffset:
                                                t8.cursorOffset > o && t8.cursorOffset <= u ? t8.cursorOffset - o : -1,
                                            endOfLine: 'lf',
                                        },
                                        a,
                                    ),
            ...
            var Ce2 = function Io(e, t8) {
                return !1 !== t8 && ('/' === e.charAt(t8) && '/' === e.charAt(t8 + 1) ? mt2(e, t8) : t8);
            };
            ...
            var ru = function jo(e, t8) {
                ...
                return null === r ? 0 : r.reduce((n, o) => Math.max(n, o.length / t8.length), 0);
            };
            ...
            function Go(e, t8) {
                return 2 === arguments.length || 'number' == typeof t8 ? Ve2(e, t8) : zo(...arguments);
            }
            function Ko(e, t8, r) {
                return Ye2(e, r(t8));
            }
            function Ho(e, t8) {
                return 2 === arguments.length || 'number' == typeof t8 ? Ye2(e, t8) : Ko(...arguments);
            }
            function qo(e, t8, r) {
                return Ct2(e, r(t8));
            }
            function Jo(e, t8) {
                return 2 === arguments.length || 'number' == typeof t8 ? Ct2(e, t8) : qo(...arguments);
            }
            var er2 = {};
            ...
            var Xo = {
                ...
                Qo = {
                    ...
                    replaceEndOfLine: function Tr2(e, t8 = He2) {
                        return Ne2(e, (r) => ('string' == typeof r ? ke2(t8, r.split('\n')) : r));
                    },
            ...
            var ti2 = ae(et2, 0),
                    ...
                    formatDoc: ae(async function Qn2(e, t8) {
                        let r = (function Pr2(e) {
                                ...
                                return (function n(u, i, s) {
                                    ...
                                    if (u.type === A2) {
                                        let c = (null == (D = s?.[i + 1]) ? void 0 : D.type) === b2;
                                        return u.literal
                                            ? c
                                                ? 'literalline'
                                    ...
                                    if (u.type === b2)
                                        return (null == (a = s?.[i - 1]) ? void 0 : a.type) === A2 && s[i - 1].hard
                                            ? void 0
                                            : 'breakParent';
                                    ...
                                    if (u.type === _) {
                                        let c = [];
                                        u.break && 'propagated' !== u.break && c.push('shouldBreak: true'),
                ...
                qc = tr2;
            var formatter = memoizerific__WEBPACK_IMPORTED_MODULE_0___default()(2)(async (type, source) =>
                !1 === type
                    ? source
                    : 'dedent' === type || !0 === type
                              ...
                              return matches
                                  ? arr.concat(
                                        matches.map(function (match) {
                                            ...
                                            return null !==
                                                (_b =
                                                    null === (_a2 = match.match(/[\t ]/g)) || void 0 === _a2
                                                        ? void 0
                    ...
                    : (
                          await qc.format(source, { parser: type, plugins: [dh], htmlWhitespaceSensitivity: 'ignore' })
                      ).trim(),
            );
        },
    },
