(self.webpackChunkproduction_project = self.webpackChunkproduction_project || []).push([
    [540],
    {
        './node_modules/@storybook/blocks/dist/Color-RQJUDNI5.mjs': (
            ...
            var R,
                ...
                dist = __webpack_require__('./node_modules/@storybook/theming/dist/index.mjs'),
                components_dist = __webpack_require__('./node_modules/@storybook/components/dist/index.mjs'),
                icons_dist = __webpack_require__('./node_modules/@storybook/icons/dist/index.mjs'),
                Wrapper = dist.zo.div({ position: 'relative', maxWidth: 250 }),
                PickerTooltip = (0, dist.zo)(components_dist.WithTooltip)({
                    position: 'absolute',
                    zIndex: 1,
                    top: 4,
                    left: 4,
                ...
                Note = (0, dist.zo)(components_dist.TooltipNote)(({ theme }) => ({
                ...
                Swatch = ({ value, active, onClick, style, ...props }) => {
                ...
                Input = (0, dist.zo)(components_dist.Form.Input)(({ theme }) => ({
                    width: '100%',
                    paddingLeft: 30,
                    paddingRight: 30,
                ...
                ToggleIcon = (0, dist.zo)(icons_dist.MarkupIcon)(({ theme }) => ({
                    position: 'absolute',
                    zIndex: 1,
                    top: 6,
                    right: 7,
                ...
                parseValue = (value) => {
                    ...
                    if (RGB_REGEXP.test(value)) {
                        let [r, g, b, a] = stringToArgs(value),
                            [h, s, l] = color_convert_default().rgb.hsl([r, g, b]) || [0, 0, 0];
                        return {
                            valid,
                            value,
                    ...
                    if (HSL_REGEXP.test(value)) {
                        let [h, s, l, a] = stringToArgs(value),
                            [r, g, b] = color_convert_default().hsl.rgb([h, s, l]) || [0, 0, 0];
                        return {
                            valid,
                            value,
                    ...
                    let plain = value.replace('#', ''),
                        rgb = color_convert_default().keyword.rgb(plain) || color_convert_default().hex.rgb(plain),
                ...
                useColorInput = (initialValue, onChange) => {
                    let [value, setValue] = (0, react.useState)(initialValue || ''),
                        ...
                        [colorSpace, setColorSpace] = (0, react.useState)(color?.colorSpace || 'hex');
                    (0, react.useEffect)(() => {
                    ...
                    let realValue = (0, react.useMemo)(
                            () =>
                                ((value, color, colorSpace) => {
                                    ...
                                    if ('hex' !== colorSpace) return color?.[colorSpace] || fallbackColor[colorSpace];
                                    if (!color.hex.startsWith('#'))
                                        try {
                                            return `#${color_convert_default().keyword.hex(color.hex)}`;
                                        } catch {
                        ...
                        updateValue = (0, react.useCallback)(
                            (update) => {
                                ...
                                setValue(v),
                                    ...
                                    parsed &&
                                        (setColor(parsed), setColorSpace(parsed.colorSpace), onChange(parsed.value));
                            },
                            [onChange],
                        ),
                ...
                ColorControl = ({
                    ...
                    let throttledOnChange = (0, react.useCallback)(throttle_default()(onChange, 200), [onChange]),
                        { value, realValue, updateValue, color, colorSpace, cycleColorSpace } = useColorInput(
                            initialValue,
                            throttledOnChange,
                        ),
                        { presets, addPreset } = ((presetColors, currentColor, colorSpace) => {
                                            ...
                                            presets.map((preset, index) =>
                                                react.createElement(
                                                    ...
                                                    react.createElement(Swatch, {
                                                        ...
                                                        active:
                                                            color && id(preset[colorSpace]) === id(color[colorSpace]),
        ...
        './node_modules/color-convert/conversions.js': (module, __unused_webpack_exports, __webpack_require__) => {
            ...
            (convert.rgb.hsl = function (rgb) {
                ...
                (convert.rgb.keyword = function (rgb) {
                    ...
                    for (const keyword of Object.keys(cssKeywords)) {
                        const value = cssKeywords[keyword],
                            distance =
                                ((y = value), ((x = rgb)[0] - y[0]) ** 2 + (x[1] - y[1]) ** 2 + (x[2] - y[2]) ** 2);
                ...
                (convert.hcg.rgb = function (hcg) {
                    ...
                    return (
                        (mg = (1 - c) * g),
                        [255 * (c * pure[0] + mg), 255 * (c * pure[1] + mg), 255 * (c * pure[2] + mg)]
                    );
                }),
                    ...
                    (convert[fromModel][toModel] = (function wrapRounded(fn) {
                        const wrappedFn = function (...args) {
                            ...
                            if ('object' == typeof result)
                                for (let len = result.length, i = 0; i < len; i++) result[i] = Math.round(result[i]);
                            return result;
                        };
            ...
            module.exports = function debounce(func, wait, options) {
                ...
                function invokeFunc(time) {
                    var args = lastArgs,
                        thisArg = lastThis;
                    return (
                        (lastArgs = lastThis = void 0), (lastInvokeTime = time), (result = func.apply(thisArg, args))
                    );
                }
