...
var __require = ((x2) =>
    typeof require < 'u'
        ? require
        : typeof Proxy < 'u'
        ? new Proxy(x2, { get: (a, b) => (typeof require < 'u' ? require : a)[b] })
        : x2)(function (x2) {
...
var __export = (target, all) => {
        for (var name2 in all) __defProp(target, name2, { get: all[name2], enumerable: !0 });
    },
                            ...
                            (Similar.prototype.get = function (key2) {
                                ...
                                (Similar.prototype.has = function (key2) {
                                    ...
                                    return this.lastItem && this.isEqual(this.lastItem.key, key2)
                                        ? !0
                                        : ((index = this.indexOf(key2)),
                                          index >= 0 ? ((this.lastItem = this.list[index]), !0) : !1);
                                }),
                                ...
                                (Similar.prototype.indexOf = function (key2) {
                                    var i;
                                    for (i = 0; i < this.size; i++) if (this.isEqual(this.list[i].key, key2)) return i;
                                    return -1;
                                }),
...
var require_baseTimes = __commonJS({
    '../../node_modules/lodash/_baseTimes.js'(exports, module) {
        ...
        function baseTimes(n, iteratee) {
            for (var index = -1, result2 = Array(n); ++index < n; ) result2[index] = iteratee(index);
            return result2;
        }
...
var require_listCacheDelete = __commonJS({
    '../../node_modules/lodash/_listCacheDelete.js'(exports, module) {
        ...
        function listCacheDelete2(key2) {
            ...
            return index == lastIndex ? data.pop() : splice2.call(data, index, 1), --this.size, !0;
        }
...
var require_SetCache = __commonJS({
    '../../node_modules/lodash/_SetCache.js'(exports, module) {
        ...
        function SetCache(values) {
            ...
            for (this.__data__ = new MapCache2(); ++index < length; ) this.add(values[index]);
        }
...
var require_arrayMap = __commonJS({
    '../../node_modules/lodash/_arrayMap.js'(exports, module) {
        ...
        function arrayMap2(array, iteratee) {
            for (var index = -1, length = array == null ? 0 : array.length, result2 = Array(length); ++index < length; )
        ...
        function overRest(func, start, transform) {
            return (
                ...
                function () {
                    ...
                    index = -1;
                    for (var otherArgs = Array(start + 1); ++index < start; ) otherArgs[index] = args2[index];
        ...
        module.exports = function (fn, length) {
            ...
            return (
                (functionLengthIsConfigurable || functionLengthIsWritable || !loose) &&
                    (hasDescriptors ? define2(fn, 'length', length, !0, !0) : define2(fn, 'length', length)),
                fn
            );
        };
    },
        ...
        module.exports = function inspect_(obj, options2, depth, seen) {
            ...
            if (!isDate(obj) && !isRegExp(obj)) {
                var ys = arrObjKeys(obj, inspect),
                    ...
                    stringTag =
                        !isPlainObject2 && toStringTag && Object(obj) === obj && toStringTag in obj
...
` +
        ...
        function arrObjKeys(obj, inspect) {
            ...
            if (isArr) {
                ...
                for (var i = 0; i < obj.length; i++) xs[i] = has2(obj, i) ? inspect(obj[i], obj) : '';
            }
                ...
                for (i = 0; i < parts.length; ++i)
                    if (i !== skipIndex) {
                        ...
                        pos === -1
                            ...
                            has2.call(obj, key2) ? (obj[key2] = utils.combine(obj[key2], val)) : (obj[key2] = val);
                    }
                return obj;
            },
            ...
            parseKeys = function (givenKey, val, options2, valuesParsed) {
                if (givenKey) {
                    var key2 = options2.allowDots ? givenKey.replace(/\.([^.[]+)/g, '[$1]') : givenKey,
                        ...
                        keys = [];
                    if (parent) {
                        if (!options2.plainObjects && has2.call(Object.prototype, parent) && !options2.allowPrototypes)
                            return;
                        keys.push(parent);
                    }
                    for (
    ...
    '../../node_modules/browser-dtector/browser-dtector.umd.min.js'(exports, module) {
        ...
        (function (e, o) {
            typeof exports == 'object' && typeof module < 'u'
                ...
                ? define(o)
                : ((e = typeof globalThis < 'u' ? globalThis : e || self).BrowserDetector = o());
        })(exports, function () {
            'use strict';
            function e(e2, o2) {
                ...
                t = (function () {
                    function t2(e2) {
                        ...
                        (function (e3, o3) {
                            ...
                            (this.userAgent =
                                e2 || ((o2 = i()) === null || o2 === void 0 ? void 0 : o2.userAgent) || null);
                    }
                    var a, l, s;
                    return (
                        (a = t2),
                                ...
                                value: function (e2) {
                                    var t3,
                                        ...
                                        u2 =
                                            ...
                                            /(crios)[/]([\w.]+)/.exec(d) ||
                                            /(opios)[/]([\w.]+)/.exec(d) ||
                                            /(version)(applewebkit)[/]([\w.]+).*(safari)[/]([\w.]+)/.exec(d) ||
                                            /(webkit)[/]([\w.]+).*(version)[/]([\w.]+).*(safari)[/]([\w.]+)/.exec(d) ||
                                            /(applewebkit)[/]([\w.]+).*(safari)[/]([\w.]+)/.exec(d) ||
                                            /(webkit)[/]([\w.]+)/.exec(d) ||
                                            /(opera)(?:.*version|)[/]([\w.]+)/.exec(d) ||
                                            /(msie) ([\w.]+)/.exec(d) ||
                                            /(fennec)[/]([\w.]+)/.exec(d) ||
                                            (d.indexOf('trident') >= 0 && /(rv)(?::| )([\w.]+)/.exec(d)) ||
                                            (d.indexOf('compatible') < 0 && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(d)) ||
                                            [],
                                        f3 =
                                            /(ipad)/.exec(d) ||
                                            /(ipod)/.exec(d) ||
                                            ...
                                            /(win)/.exec(d) ||
                                            /(tablet)/.exec(d) ||
                                            (/(android)/.test(d) && /(mobile)/.test(d) === !1 && ['androidTablet']) ||
                                            /(android)/.exec(d) ||
                                            /(mac)/.exec(d) ||
                                            /(linux)/.exec(d) ||
                                            /(cros)/.exec(d) ||
                                        ...
                                        b = i();
                                    p === 'chrome' &&
                                        typeof (b == null || (t3 = b.brave) === null || t3 === void 0
                                            ? void 0
                                            : t3.isBrave) == 'function' &&
                                        (p = 'brave'),
                                        p && (s2[p] = !0),
                                    ...
                                    return {
                                        ...
                                        platform: (l2 = r[w2]) !== null && l2 !== void 0 ? l2 : null,
                                        userAgent: c2,
                                        version: x2,
...
var dist_exports3 = {};
__export(dist_exports3, { deprecate: () => deprecate, logger: () => logger, once: () => once, pretty: () => pretty });
var { LOGLEVEL } = scope,
...
` &&
    ...
    cleanCode = (0, import_memoizerific.default)(1e4)((code) => removeCodeComments(code).replace(/\n\s*/g, '').trim()),
...
var replacer = function (options2) {
        ...
        return function (key2, value2) {
            try {
                if (key2 === '')
                    return (keys = []), (objects = new Map([[value2, '[]']])), (map2 = new Map()), (stack = []), value2;
    ...
    PostMessageTransport = class {
        ...
        getFrames(target) {
            if (this.config.page === 'manager') {
                let list = Array.from(document2.querySelectorAll('iframe[data-is-storybook][data-is-loaded]')).flatMap(
                    (e) => {
                        try {
        ...
        getCurrentFrames() {
            return this.config.page === 'manager'
                ? Array.from(document2.querySelectorAll('[data-is-storybook="true"]')).flatMap((e) =>
        ...
        getLocalFrame() {
            return this.config.page === 'manager'
                ? Array.from(document2.querySelectorAll('#storybook-preview-iframe')).flatMap((e) =>
                      e.contentWindow ? [e.contentWindow] : [],
                  )
                : scope && scope.parent
                ? [scope.parent]
...
var Category = ((Category2) => (
    ...
    MissingStoryAfterHmrError = class extends StorybookError {
        constructor(data) {
            super(), (this.data = data), (this.category = 'PREVIEW_API'), (this.code = 1);
        }
        template() {
            return esm_default`
...
`
    ...
    CalledPreviewMethodBeforeInitializationError = class extends StorybookError {
        constructor(data) {
            super(), (this.data = data), (this.category = 'PREVIEW_API'), (this.code = 5);
        }
        template() {
            return esm_default`
    ...
    StoryIndexFetchError = class extends StorybookError {
        constructor(data) {
            super(), (this.data = data), (this.category = 'PREVIEW_API'), (this.code = 6);
        }
        template() {
            return esm_default`
    ...
    MdxFileWithNoCsfReferencesError = class extends StorybookError {
        constructor(data) {
            super(), (this.data = data), (this.category = 'PREVIEW_API'), (this.code = 7);
        }
        template() {
            return esm_default`
    ...
    NoStoryMatchError = class extends StorybookError {
        constructor(data) {
            super(), (this.data = data), (this.category = 'PREVIEW_API'), (this.code = 9);
        }
        template() {
            return esm_default`
    ...
    MissingStoryFromCsfFileError = class extends StorybookError {
        constructor(data) {
            super(), (this.data = data), (this.category = 'PREVIEW_API'), (this.code = 10);
        }
        template() {
            return esm_default`
        ...
        '../../node_modules/ansi-to-html/node_modules/entities/lib/encode.js'(exports) {
            ...
            function getInverseReplacer(inverse) {
                ...
                for (var start = 0; start < single.length - 1; start++) {
                    for (
                        var end = start;
                        end < single.length - 1 && single[end].charCodeAt(1) + 1 === single[end + 1].charCodeAt(1);
            ...
            var Filter = (function () {
                function Filter2(options2) {
                    _classCallCheck(this, Filter2),
                        (options2 = options2 || {}),
                        options2.colors && (options2.colors = Object.assign({}, defaults.colors, options2.colors)),
...
function useStateLike(name2, initialState) {
    let stateRef = useRefLike(name2, typeof initialState == 'function' ? initialState() : initialState),
        setState = (update) => {
...
function useGlobals() {
    let channel = addons.getChannel(),
        ...
        updateGlobals = useCallback((newGlobals) => channel.emit(UPDATE_GLOBALS, { globals: newGlobals }), [channel]);
    return [globals, updateGlobals];
}
var makeDecorator = ({ name: name2, parameterName, wrapper, skipIfNoParametersOrOptions = !1 }) => {
        let decorator = (options2) => (storyFn, context) => {
            let parameters = context.parameters && context.parameters[parameterName];
            return (parameters && parameters.disable) || (skipIfNoParametersOrOptions && !options2 && !parameters)
                ? storyFn(context)
    ...
    combineArgs = (value2, update) =>
        Array.isArray(value2) && Array.isArray(update)
            ? update
                  .reduce(
                      (acc, upd, index) => ((acc[index] = combineArgs(value2[index], update[index])), acc),
                      [...value2],
                  )
                  .filter((v2) => v2 !== void 0)
            : !(0, import_isPlainObject.default)(value2) || !(0, import_isPlainObject.default)(update)
            ? update
    ...
    validateOptions = (args2, argTypes) =>
      ...
      `),
            ...
            let isArray2 = Array.isArray(args2[key2]),
                invalidIndex = isArray2 && args2[key2].findIndex((val) => !options2.includes(val)),
                isValidArray = isArray2 && invalidIndex === -1;
            if (args2[key2] === void 0 || options2.includes(args2[key2]) || isValidArray) return allowArg();
    ...
    deepDiff = (value2, update) => {
        ...
        return (0, import_isPlainObject.default)(value2) && (0, import_isPlainObject.default)(update)
            ? Object.keys({ ...value2, ...update }).reduce((acc, key2) => {
...
var ArgsStore = class {
    ...
    getValuesFromArgTypes = (argTypes = {}) =>
        Object.entries(argTypes).reduce(
            (acc, [arg, { defaultValue }]) => (typeof defaultValue < 'u' && (acc[arg] = defaultValue), acc),
            {},
        ),
    GlobalsStore = class {
    ...
    normalizeControl = (control) => (typeof control == 'string' ? { type: control } : control),
    ...
    normalizeInputTypes = (inputTypes) => (0, import_mapValues.default)(inputTypes, normalizeInputType),
    normalizeArrays = (array) => (Array.isArray(array) ? array : array ? [array] : []),
...
`,
    deprecatedStoryAnnotationWarning = (0, import_util_deprecate.default)(() => {}, deprecatedStoryAnnotation);
            ...
            (acc, parameters) => (
                Object.entries(parameters).forEach(([key2, value2]) => {
                    ...
                    Array.isArray(value2) || typeof existing > 'u'
                        ? (acc[key2] = value2)
                        : (0, import_isPlainObject.default)(value2) && (0, import_isPlainObject.default)(existing)
                        ? (mergeKeys[key2] = !0)
...
function prepareStory(storyAnnotations, componentAnnotations, projectAnnotations) {
    let { moduleExport, id, name: name2 } = storyAnnotations || {},
        ...
        applyLoaders = async (context) => {
            ...
            for (let loaders of [
                ...('__STORYBOOK_TEST_LOADERS__' in scope && Array.isArray(scope.__STORYBOOK_TEST_LOADERS__)
                ...
                let loadResults = await Promise.all(loaders.map((loader) => loader(updatedContext))),
    ...
    let decoratedStoryFn = applyHooks(applyDecorators)(undecoratedStoryFn, decorators),
...
function preparePartialAnnotations(storyAnnotations, componentAnnotations, projectAnnotations) {
    let tags = [...(storyAnnotations?.tags || componentAnnotations.tags || []), 'story'],
    ...
    let passedArgs = { ...projectAnnotations.args, ...componentAnnotations.args, ...storyAnnotations?.args },
        contextForEnhancers = {
...
function prepareContext(context) {
    ...
    let mappedArgs = Object.entries(targetedContext.args).reduce((acc, [key2, val]) => {
            if (!targetedContext.argTypes[key2]?.mapping) return (acc[key2] = val), acc;
        ...
        includedArgs = Object.entries(mappedArgs).reduce((acc, [key2, val]) => {
            ...
            return O(argType, mappedArgs, targetedContext.globals) && (acc[key2] = val), acc;
        }, {});
...
var inferType = (value2, name2, visited) => {
    ...
    inferArgTypes = (context) => {
        let { id, argTypes: userArgTypes = {}, initialArgs = {} } = context,
            ...
            userArgTypesNames = (0, import_mapValues.default)(userArgTypes, (argType, key2) => ({ name: key2 }));
...
var matches = (name2, descriptor) => (Array.isArray(descriptor) ? descriptor.includes(name2) : name2.match(descriptor)),
    ...
    inferControl = (argType, name2, matchers) => {
        ...
        if (type) {
            ...
            if (matchers.date && matchers.date.test(name2)) return { control: { type: 'date' } };
            switch (type.name) {
                case 'array':
...
function normalizeProjectAnnotations({
    ...
    return {
        ...
        argTypesEnhancers: [...(argTypesEnhancers || []), inferArgTypes, inferControls],
        ...annotations,
    };
}
...
function composeStory(storyAnnotations, componentAnnotations, projectAnnotations, defaultConfig, exportsName) {
    ...
    let normalizedComponentAnnotations = normalizeComponentAnnotations(componentAnnotations),
        ...
        globalsFromGlobalTypes = getValuesFromArgTypes(normalizedProjectAnnotations.globalTypes),
        context = {
            hooks: new HooksContext(),
            globals: { ...globalsFromGlobalTypes, ...normalizedProjectAnnotations.globals },
    ...
    return Object.assign(
        function (extraArgs) {
            return (
                (context.args = { ...context.initialArgs, ...extraArgs }), story.unboundStoryFn(prepareContext(context))
            );
        },
        {
            id: story.id,
...
function composeStories(storiesImport, globalConfig, composeStoryFn) {
    ...
    return Object.entries(stories).reduce(
        (storiesMap, [exportsName, story]) =>
            G(exportsName, meta)
                ? Object.assign(storiesMap, { [exportsName]: composeStoryFn(story, meta, globalConfig, exportsName) })
                : storiesMap,
        {},
    );
}
    ...
    StoryStore = class {
        ...
        async loadAllCSFFiles() {
            ...
            return (
                ...
                ).reduce((acc, { importPath, csfFile }) => ((acc[importPath] = csfFile), acc), {})
            );
        }
        ...
        storyFromCSFFile({ storyId, csfFile }) {
            ...
            return (
                this.args.setInitial(story), (this.hooks[story.id] = this.hooks[story.id] || new HooksContext()), story
            );
        }
        ...
        raw() {
            return (
                deprecate('StoryStore.raw() is deprecated and will be removed in 9.0, please use extract() instead'),
...
var sanitize2 = (parts) => {
    ...
    return lastStripped && nextToLast && lastStripped.toLowerCase() === nextToLast.toLowerCase()
        ? [...parts.slice(0, -2), lastStripped]
        : lastStripped && (/^(story|stories)([.][^.]+)$/i.test(last) || /^index$/i.test(lastStripped))
        ? parts.slice(0, -1)
            ...
            for (; storyTitleA[depth] || storyTitleB[depth]; ) {
                ...
                if (nameA !== nameB) {
                    ...
                    return indexA !== -1 || indexB !== -1
                        ? (indexA === -1 && (indexWildcard !== -1 ? (indexA = indexWildcard) : (indexA = order.length)),
                          indexB === -1 && (indexWildcard !== -1 ? (indexB = indexWildcard) : (indexB = order.length)),
                          indexA - indexB)
                        : method === 'configure'
                        ? 0
                        : nameA.localeCompare(nameB, options2.locales ? options2.locales : void 0, {
                              numeric: !0,
                              sensitivity: 'accent',
                          });
                }
...
var StoryRender = class {
        ...
        async render({ initial = !1, forceRemount = !1 } = {}) {
            ...
            try {
                ...
                if (
                    ...
                    return;
                let ignoreUnhandledErrors = this.story.parameters?.test?.dangerouslyIgnoreUnhandledErrors === !0,
                    unhandledErrors = new Set(),
                    onError = (event) => unhandledErrors.add('error' in event ? event.error : event.reason);
    ...
    Preview = class {
        ...
        async onUpdateArgs({ storyId, updatedArgs }) {
            ...
            this.storyStoreValue.args.update(storyId, updatedArgs),
                ...
                this.channel.emit(STORY_ARGS_UPDATED, { storyId, args: this.storyStoreValue.args.get(storyId) });
        }
        ...
        renderStoryToElement(story, element, callbacks, options2) {
            if (!this.renderToCanvas || !this.storyStoreValue)
                throw new CalledPreviewMethodBeforeInitializationError({ methodName: 'renderStoryToElement' });
    ...
    DocsContext = class {
        ...
        resolveAttachedModuleExportType(moduleExportType) {
            ...
            if (moduleExportType === 'meta') return { type: 'meta', csfFile: firstAttachedCSFFile };
    ...
    CsfDocsRender = class {
        ...
        async prepare() {
            ...
            let { importPath, title } = this.entry,
                primaryCsfFile = this.store.processCSFFileWithCache(entryExports, importPath, title),
...
var PreviewWithSelection = class extends Preview {
        ...
        async selectSpecifiedStory() {
            if (!this.storyStoreValue)
                throw new CalledPreviewMethodBeforeInitializationError({ methodName: 'selectSpecifiedStory' });
            ...
            let { storySpecifier, args: args2 } = this.selectionStore.selectionSpecifier,
                entry = this.storyStoreValue.storyIndex.entryFromSpecifier(storySpecifier);
            if (!entry) {
                storySpecifier === '*'
        ...
        async renderSelection({ persistedArgs } = {}) {
            ...
            entry.type === 'story'
                ? (render = new StoryRender(
                      this.channel,
                      this.storyStoreValue,
                      (...args2) => (this.view.showStoryDuringRender(), renderToCanvas(...args2)),
            ...
            if (
                ...
                lastRender && !lastRender.torndown && !storyIdChanged && !implementationChanged && !viewModeChanged)
            ) {
                (this.currentRender = lastRender), this.channel.emit(STORY_UNCHANGED, storyId), this.view.showMain();
                return;
            }
            if (
                (lastRender && (await this.teardownRender(lastRender, { viewModeChanged })),
                lastSelection && (storyIdChanged || viewModeChanged) && this.channel.emit(STORY_CHANGED, storyId),
                isStoryRender(render))
            ) {
                invariant(!!render.story);
                let { parameters, initialArgs, argTypes, unmappedArgs } = this.storyStoreValue.getStoryContext(
                    render.story,
                );
    ...
    parseArgsParam = (argsString) => {
        ...
        return Object.entries(import_qs.default.parse(parts.join(';'), QS_OPTIONS)).reduce(
            (acc, [key2, value2]) =>
                validateArgs(key2, value2)
...
var getQueryString = ({ selection, extraParams }) => {
        let { search = '' } = document3.location,
            { path, selectedKind, selectedStory, ...rest } = import_qs.default.parse(search, { ignoreQueryPrefix: !0 });
        return import_qs.default.stringify(
            { ...rest, ...extraParams, ...(selection && { id: selection.storyId, viewMode: selection.viewMode }) },
    ...
    isObject4 = (val) => val != null && typeof val == 'object' && Array.isArray(val) === !1,
    getFirstString = (v2) => {
        if (v2 !== void 0) {
    ...
    getSelectionSpecifierFromPath = () => {
        let query = import_qs.default.parse(document3.location.search, { ignoreQueryPrefix: !0 }),
            args2 = typeof query.args == 'string' ? parseArgsParam(query.args) : void 0,
    ...
    WebView = class {
        constructor() {
            this.testing = !1;
            let { __SPECIAL_TEST_PARAMETER__ } = import_qs.default.parse(document22.location.search, {
                ignoreQueryPrefix: !0,
            });
        ...
        showPreparingStory({ immediate = !1 } = {}) {
            clearTimeout(this.preparingTimeout),
                immediate
                    ...
                    : (this.preparingTimeout = setTimeout(() => this.showMode('PREPARING_STORY'), PREPARING_DELAY));
        }
        showPreparingDocs({ immediate = !1 } = {}) {
            clearTimeout(this.preparingTimeout),
                immediate
                    ? this.showMode('PREPARING_DOCS')
                    : (this.preparingTimeout = setTimeout(() => this.showMode('PREPARING_DOCS'), PREPARING_DELAY));
        }
        showMain() {
            this.showMode('MAIN');
        }
...
function simulateDOMContentLoaded() {
    ...
    DOMContentLoadedEvent.initEvent('DOMContentLoaded', !0, !0), document32.dispatchEvent(DOMContentLoadedEvent);
}
function insertScript($script, callback, $scriptRoot) {
    ...
    (scriptEl.type = $script.type === 'module' ? 'module' : 'text/javascript'),
        $script.src
            ? ((scriptEl.onload = callback), (scriptEl.onerror = callback), (scriptEl.src = $script.src))
            : (scriptEl.textContent = $script.innerText),
        $scriptRoot ? $scriptRoot.appendChild(scriptEl) : document32.head.appendChild(scriptEl),
...
function getBrowserInfo() {
    return (
        browserInfo || (browserInfo = new import_browser_dtector.default(scope.navigator?.userAgent).getBrowserInfo()),
        browserInfo
    );
}
