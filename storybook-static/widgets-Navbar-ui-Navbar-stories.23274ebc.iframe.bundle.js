    ...
    [811],
    {
        './src/widgets/Navbar/ui/Navbar.stories.tsx': (
            ...
            var themeDecorator = __webpack_require__('./src/shared/config/storybook/themeDecorator.tsx'),
                ...
                Navbar_module = __webpack_require__(
                    './node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[15].use[1]!./node_modules/sass-loader/dist/cjs.js!./src/widgets/Navbar/ui/Navbar.module.scss',
                ),
                options = {};
            ...
            const ui_Navbar_module = Navbar_module.Z && Navbar_module.Z.locals ? Navbar_module.Z.locals : void 0;
            var Navbar = function (param) {
                var className = param.className,
                    t = (0, useTranslation.$)().t;
                return (0, jsx_runtime.jsx)('div', {
                    className: (0, classNames.A)(ui_Navbar_module.Navbar, {}, [className]),
            ...
            const Navbar_stories = { title: 'widgets/Navbar', component: Navbar };
            var Light = {},
        ...
        './node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[15].use[1]!./node_modules/sass-loader/dist/cjs.js!./src/widgets/Navbar/ui/Navbar.module.scss':
            (module, __webpack_exports__, __webpack_require__) => {
                ...
                ___CSS_LOADER_EXPORT___.push([
                    module.id,
                    '.src-widgets-Navbar-ui-Navbar-module__Navbar--YC5yK{width:100%;height:var(--navbar-height);background:var(--inverted-bg-color);display:flex;align-items:center;padding:20px}.src-widgets-Navbar-ui-Navbar-module__links--_tl_p{margin-left:auto}.src-widgets-Navbar-ui-Navbar-module__mainLink--ZMsbP{margin-right:15px}',
                    '',
                    {
                        version: 3,
                        ...
                        names: [],
                        mappings:
                            'AAAA,oDACI,UAAA,CACA,2BAAA,CACA,mCAAA,CACA,YAAA,CACA,kBAAA,CACA,YAAA,CAGJ,mDACI,gBAAA,CAGJ,sDACI,iBAAA',
                        sourcesContent: [
