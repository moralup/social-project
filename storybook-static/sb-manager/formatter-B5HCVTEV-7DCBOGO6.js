...
var import_memoizerific = __toESM(require_memoizerific(), 1),
    ...
    Qr = (t8, e, r, n) => (jr(t8, e, 'write to private field'), n ? n.call(t8, r) : e.set(t8, r), r),
    Ur = {};
    ...
    switch (Fe(t8)) {
        ...
        case be: {
            ...
            for (let r of t8) {
                ...
                typeof n == 'string' && typeof me(!1, e, -1) == 'string' ? (e[e.length - 1] += n) : e.push(n),
                    e.push(...s);
            }
...
function ln(t8, e) {
    ...
    if (
        ...
        t8.type === 'angularControlFlowBlock' && (r = e.parameters) != null && r.children)
    )
...
function hi(t8, e) {
    ...
    return (pi(r, e.language) ?? pn(r, e.physicalFile) ?? pn(r, e.file) ?? (e.physicalFile, void 0))?.parsers[0];
}
var Ne = hi,
    hn = 'inline',
    fn = {
...
function _t(t8, e) {
    return !!(
        ...
        (ge(t8) && t8.children.some((r) => r.type !== 'text' && r.type !== 'interpolation')) ||
...
function Dn(t8) {
    return (
        ...
        (t8.type === 'element' &&
            ...
            (['body', 'script', 'style'].includes(t8.name) || t8.children.some((e) => Ci(e)))) ||
        (t8.firstChild &&
...
function yn(t8) {
    return (
        ...
        (t8.prev
            ...
            : t8.parent.type === 'root' || t8.parent.startSourceSpan.end.line < t8.sourceSpan.start.line)
    );
}
function wn(t8) {
    return (
...
function Ce(t8, e) {
    return (
        e.parser === 'vue' && t8.type === 'element' && t8.parent.type === 'root' && t8.fullName.toLowerCase() !== 'html'
    );
}
function Dt(t8, e) {
...
function Pi(t8) {
    let e = (r) => {
        ...
        return (
            ...
            ((s = r.firstChild) == null ? void 0 : s.type) === 'ieConditionalEndComment' &&
        ...
        if (Cn(n))
            for (let s of n.children) {
                ...
                for (let u = 0; u < o.length; u++, i = a) {
                    ...
                    if (u % 2 === 0) {
                        (a = i.moveBy(p.length)),
                            p.length > 0 && n.insertChildBefore(s, { type: 'text', value: p, sourceSpan: new f(i, a) });
                        continue;
                    }
                    (a = i.moveBy(p.length + 4)),
                        n.insertChildBefore(s, {
                            ...
                            children:
                                p.length === 0
                                    ? []
                                    : [{ type: 'text', value: p, sourceSpan: new f(i.moveBy(2), a.moveBy(-2)) }],
                        });
                }
                n.removeChild(s);
            }
...
function Oi(t8) {
    t8.walk((e) => {
        ...
        if (
            e.children.length === 0 ||
            (e.children.length === 1 && e.children[0].type === 'text' && H.trim(e.children[0].value).length === 0)
        ) {
        ...
        if (!r)
            for (let s = 0; s < e.children.length; s++) {
                ...
                o
                    ? ((i.value = o),
                      (i.sourceSpan = new f(i.sourceSpan.start.moveBy(a.length), i.sourceSpan.end.moveBy(-u.length))),
                      a && (p && (p.hasTrailingSpaces = !0), (i.hasLeadingSpaces = !0)),
                      u && ((i.hasTrailingSpaces = !0), l && (l.hasLeadingSpaces = !0)))
                    : (e.removeChild(i),
                      s--,
                      (a || u) && (p && (p.hasTrailingSpaces = !0), l && (l.hasLeadingSpaces = !0)));
            }
    ...
    t8.walk((r) => {
        ...
        if (n) {
            ...
            for (let s = 0; s < n.length; s++) {
                let i = n[s];
                (i.isLeadingSpaceSensitive = (s === 0 || i.prev.isTrailingSpaceSensitive) && i.isLeadingSpaceSensitive),
                    (i.isTrailingSpaceSensitive =
                        (s === n.length - 1 || i.next.isLeadingSpaceSensitive) && i.isTrailingSpaceSensitive);
            }
        }
    });
}
...
function ji(t8, e, r) {
    ...
    let s = ((m = n.prev) == null ? void 0 : m.type) === 'comment' && Yi(n.prev.value),
        i = typeof s == 'boolean' ? () => s : Array.isArray(s) ? (d) => s.includes(d.rawName) : () => !1,
...
function Xi(t8, e) {
    ...
    return (
        t8.lastChild && Ae(t8.lastChild) ? (n += kt(t8, e).length) : Ee(t8) && (n -= _e(t8.lastChild, e).length),
...
async function jn(t8, e, r, n) {
    let s = L(r.node),
        ...
        u = $e(r, n);
    return [
        E(await x(`function _(${i}) {}`, t8, { parser: u ? 'babel-ts' : 'babel', __isVueForBindingLeft: !0 })),
        ' ',
        a,
        ' ',
...
function ua(t8) {
    ...
    let a = v(!1, s[1].trim(), n, ''),
        o = a.match(r);
    o
        ? ((i.alias = a.replace(r, '')), (i.iterator1 = o[1].trim()), o[2] && (i.iterator2 = o[2].trim()))
        : (i.alias = a);
...
function Kn(t8, e, r) {
    let { node: n } = r,
        s = L(n);
    return x(`type T<${s}> = any`, t8, { parser: 'babel-ts', __isEmbeddedTypescriptGenericParameters: !0 }, K);
}
function Qn(t8, e, { parseWithTs: r }) {
    return x(`function _(${t8}) {}`, e, { parser: r ? 'babel-ts' : 'babel', __isVueBindings: !0 });
}
function Xn(t8) {
...
function Ca(t8) {
    return async (e, r, n, s) => {
        ...
        if (i)
            return (
                (i = Ct(i, (a) => (typeof a == 'string' ? v(!1, a, '"', '&quot;') : a))),
                [n.node.rawName, '="', E(i), '"']
            );
    };
}
                ...
                return n
                    ? async (s, i) => {
                          let a = Ft(r, e),
                              ...
                              u = '';
                          return (
                              o || ((u = await s(ar(a), { parser: n, __embeddedInHtml: !0 })), (o = u === '')),
                    ...
                    return async (s) => {
                        ...
                        if (e.parser === 'html' && n === 'babel') {
                            let o = 'script',
                                { attrMap: u } = r.parent;
                            u &&
                                (u.type === 'module' || (u.type === 'text/babel' && u['data-type'] === 'module')) &&
                                (o = 'module'),
...
function Pt(t8, e) {
    return N(t8) && N(e)
        ? t8.isTrailingSpaceSensitive
            ...
            ? S
            : b
        : (Je(t8) && (Ge(e) || e.firstChild || e.isSelfClosing || (e.type === 'element' && e.attrs.length > 0))) ||
...
function is(t8, e, r) {
    ...
    let s =
        ...
        o = (l) =>
            s
                ? tn(l, { groupId: i })
                : (V(n) || Ke(n, e)) && n.parent.type === 'root' && e.parser === 'vue' && !e.vueIndentScriptAndStyle
                ? l
                : R(l),
        u = () =>
            s
        ...
        p = () =>
            (n.next ? j(n.next) : Ee(n.parent))
                ...
                : (n.lastChild.type === 'comment' ||
                      (n.lastChild.type === 'text' && n.isWhitespaceSensitive && n.isIndentationSensitive)) &&
                  new RegExp(`\\n[\\t ]{${e.tabWidth * (t8.ancestors.length - 1)}}$`).test(n.lastChild.value)
                ? ''
                : b;
...
function ba(t8, e, r) {
    ...
    switch (n.type) {
        ...
        case 'docType':
            return [E([tt(n, e), ' ', v(!1, n.value.replace(/^html\b/i, 'html'), /\s+/g, ' ')]), Xe(n, e)];
        case 'comment':
        ...
        case 'attribute': {
            ...
            let s = pr(n.value),
                i = on(s, '"');
            return [n.rawName, '=', i, T(i === '"' ? v(!1, s, '"', '&quot;') : v(!1, s, "'", '&apos;')), i];
        }
        case 'cdata':
        default:
            throw new sn(n, 'HTML');
    ...
    $t = class extends Rt {
        ...
        hasElement(e, r) {
            return r.some((n) => n.name === Dr.name) ||
                (e.indexOf('-') > -1 && (vr(e) || yr(e) || r.some((n) => n.name === Ar.name)))
                ? !0
...
`,
        ...
        _getBlockName() {
            ...
            return (
                this._attemptCharCodeUntilFn((n) => (wt(n) ? !e : xs(n) ? ((e = !0), !1) : !0)),
        ...
        _tokenizeExpansionForm() {
            ...
            if (oo(this._cursor.peek()) && this._isInExpansionForm()) return this._consumeExpansionCaseStart(), !0;
        ...
        _consumeTagOpen(e) {
            ...
            try {
                ...
                for (
                    s = this._consumeTagOpenStart(e), n = s.parts[0], r = s.parts[1], this._attemptCharCodeUntilFn(k);
        ...
        _consumeRawTextWithTagClose(e, r, n) {
            this._consumeRawText(n, () =>
                ...
                (this._attemptCharCodeUntilFn(k), !this._attemptStrCaseInsensitive(e ? `${e}:${r}` : r))
                    ? !1
        ...
        _consumeInterpolation(e, r, n) {
            ...
            for (; this._cursor.peek() !== 0 && (n === null || !n()); ) {
                ...
                this._cursor.advance(),
                    p === 92 ? this._cursor.advance() : p === a ? (a = null) : !o && a === null && dr(p) && (a = p);
            }
        ...
        _handleFullNameStackForTagOpen(e, r) {
            let n = qe(e, r);
            (this._fullNameStack.length === 0 || this._fullNameStack[this._fullNameStack.length - 1] === n) &&
    ...
    Or = class t6 {
        ...
        _parseExpansionCase() {
            ...
            if (this._peek.type !== 22)
                return (
                    this.errors.push(I.create(null, this._peek.sourceSpan, "Invalid ICU message. Missing '{'.")), null
                );
            let r = this._advance(),
            ...
            for (;;) {
                if (
                    ...
                    if (Ns(n, 22)) {
                        ...
                        return (
                            this.errors.push(I.create(null, e.sourceSpan, "Invalid ICU message. Missing '}'.")), null
                        );
                if (this._peek.type === 24)
                    if (Ns(n, 20)) n.pop();
                    else
        ...
        _popContainer(e, r, n) {
            ...
            for (let i = this._containerStack.length - 1; i >= 0; i--) {
                ...
                if (
                    Me(a.name)
                        ? a.name === e
                        : (e == null || a.name.toLowerCase() === e.toLowerCase()) && a instanceof r
                )
                    return (
                        (a.endSourceSpan = n),
                ...
                (a instanceof J || (a instanceof z && !this.getTagDefinition(a.name).closedByParent)) && (s = !0);
            }
            return !1;
        }
        _consumeAttr(e) {
            ...
            let l = o && u && new f(s?.sourceSpan.start ?? o.start, u, s?.sourceSpan.fullStart ?? o.fullStart);
            return new Vt(
                r,
                i,
...
var $s = fo,
    ...
    Jt = new Map([
        ...
        [
            'frame',
            new Set(['frameborder', 'longdesc', 'marginheight', 'marginwidth', 'name', 'noresize', 'scrolling', 'src']),
        ],
        ...
        [
            'table',
            new Set(['align', 'bgcolor', 'border', 'cellpadding', 'cellspacing', 'frame', 'rules', 'summary', 'width']),
        ],
...
function So(t8, e, r) {
    let [, n] = r;
    return { type: 'ieConditionalStartComment', condition: v(!1, n.trim(), /\s+/g, ' '), sourceSpan: t8.sourceSpan };
}
function _o(t8) {
...
function Eo(t8) {
    if (t8.type === 'block') {
        ...
        t8.parameters = {
            ...
            sourceSpan: new f(t8.parameters[0].sourceSpan.start, me(!1, t8.parameters, -1).sourceSpan.end),
        };
    }
}
function Vs(t8, e, r) {
    ...
    if (n === 'vue') {
        ...
        let g,
            y2 = () =>
                g ?? (g = qr(t8, { canSelfClose: s, allowHtmComponentClosingTags: o, isTagNameCaseSensitive: u })),
            $ = (w2) =>
                y2().rootNodes.find(
        ...
        for (let [w2, q2] of l.entries()) {
            ...
            if (Wr2 === null) (m = y2().errors), (l[w2] = $(q2));
                ...
                let zr2 = y2().errors.find(
                    (Gr2) => Gr2.span.start.offset > js.start.offset && Gr2.span.start.offset < Wr2.end.offset,
                );
                zr2 && Hs(zr2), (l[w2] = $(q2));
            }
        }
    ...
    let d = (c) => {
        ...
        D = (c) => {
            if (
                c.type === 'element' &&
                (i &&
                    (!c.namespace || c.namespace === c.tagDefinition.implicitNamespacePrefix || de(c)) &&
                ...
                for (let g of c.attrs)
                    g.namespace ||
                        (g.name = _2(
                            g.name,
                            (y2) => Jt.has(c.name) && (Jt.get('*').has(y2) || Jt.get(c.name).has(y2)),
                        ));
        },
        P2 = (c) => {
...
function Hs(t8) {
    ...
    throw $s(e, {
        loc: { start: { line: r.line + 1, column: r.col + 1 }, end: { line: n.line + 1, column: n.col + 1 } },
        cause: t8,
    });
}
...
var Ws = { name: 'html', normalizeTagName: !0, normalizeAttributeName: !0, allowHtmComponentClosingTags: !0 },
    Do = tr(Ws),
    vo = tr({ name: 'angular' }),
    yo = tr({
        name: 'vue',
        ...
        shouldParseAsRawText(t8, e, r, n) {
            return (
                ...
                !r &&
                (t8 !== 'template' ||
                    n.some(({ name: s, value: i }) => s === 'lang' && i !== 'html' && i !== '' && i !== void 0))
            );
        },
    }),
    ...
    he2 = (e, t8, r) => (
        (r = e != null ? lu(pu(e)) : {}),
        nr2(t8 || !e || !e.__esModule ? $e2(r, 'default', { value: e, enumerable: !0 }) : r, e)
    ),
    ...
    or2 = Me2((gt2) => {
        Object.defineProperty(gt2, '__esModule', { value: !0 }), (gt2.default = ur2);
        function ur2() {}
        ur2.prototype = {
            diff: function (t8, r) {
                    ...
                    for (var F2 = -1 * a; F2 <= a; F2 += 2) {
                        ...
                        if (
                            (!h2 || (B && E2.newPos < C.newPos)
                                ...
                                : ((m = E2), m.newPos++, u.pushComponent(m.components, !0, void 0)),
    ...
    ir2 = Me2((ye) => {
        Object.defineProperty(ye, '__esModule', { value: !0 }), (ye.diffArrays = _u), (ye.arrayDiff = void 0);
        var Au = Bu(or2());
        function Bu(e) {
...
var no2,
    ...
    yn2 = Me2((Ft2) => {
        Object.defineProperty(Ft2, '__esModule', { value: !0 }), (Ft2.codeFrameColumns = gn2), (Ft2.default = ao2);
        var dn2 = (pn2(), Eu(Fn2)),
            mn2 = oo2(Pe2(), !0);
        function hn2(e) {
        ...
        function io2(e) {
            return e
                ? (jt2 != null || (jt2 = new mn2.default.constructor({ enabled: !0, level: 1 })), jt2)
                : mn2.default;
        }
        var En2 = !1;
        function so2(e) {
            ...
            switch (i) {
                ...
                case _:
                    if (n && u.expandedStates)
                        for (let s = u.expandedStates.length, D = s - 1; D >= 0; --D) o.push(u.expandedStates[D]);
    ...
    switch (U2(e)) {
        ...
        case j2: {
            ...
            for (let r of e) {
                ...
                typeof n == 'string' && typeof y(!1, t8, -1) == 'string' ? (t8[t8.length - 1] += n) : t8.push(n),
                    t8.push(...o);
            }
...
function Yu(e, t8, r) {
    return t8 === Number.NEGATIVE_INFINITY
        ...
        ? t8.type === 'root'
            ? { ...e, root: e }
            : xt2(e, { type: typeof t8 == 'string' ? 'stringAlign' : 'numberAlign', n: t8 }, r)
        : e;
}
function xt2(e, t8, r) {
...
function J2(e) {
    ...
    return e.type === x2
        ...
        : e.type === _
        ? { ...e, contents: J2(e.contents), expandedStates: (t8 = e.expandedStates) == null ? void 0 : t8.map(J2) }
        : e.type === k2
...
function Pr2(e) {
    ...
    function n(u, i, s) {
        ...
        if (u.type === b2)
            return ((a = s?.[i - 1]) == null ? void 0 : a.type) === A2 && s[i - 1].hard ? void 0 : 'breakParent';
        ...
        if (u.type === x2)
            return (
                ...
                (u.groupId ? (u.flatContents ? '' : ', ""') + `, { groupId: ${o(u.groupId)} }` : '') +
                ')'
            );
        if (u.type === P) {
            let c = [];
    ...
    for (let o of $u(Object.assign({}, ...e.map(({ options: u }) => u), Lr)))
        (!t8 && o.deprecated) ||
            (Array.isArray(o.choices) &&
                ...
                o.name === 'parser' && (o.choices = [...o.choices, ...Vu(o.choices, r, e)])),
...
function Ir(e, t8) {
    ...
    return e.find((n) => {
        ...
        return (
            ...
            ((u = n.filenames) == null ? void 0 : u.some((i) => i.toLowerCase() === r))
        );
    });
}
function Wu(e, t8) {
...
function Uu(e, t8) {
    ...
    return (Wu(r, t8.language) ?? Ir(r, t8.physicalFile) ?? Ir(r, t8.file) ?? (t8.physicalFile, void 0))?.parsers[0];
}
var Rr = Uu,
    te2 = {
    ...
    Vr2 = (e, t8, { descriptor: r }) => {
        ...
        return (
            t8 && n.push(`we now treat it as ${bt2.default.blue(typeof t8 == 'string' ? r.key(t8) : r.pair(t8))}`),
            n.join('; ') + '.'
        );
    },
    se2 = he2(Pe2(), 1),
    ...
    Wr = (e, t8, r) => {
        ...
        return (
            ...
            o &&
                u.push(
                    [Mr2(e, t8, o.title, r.descriptor)].concat(o.values.map((i) => Ur2(i, r.loggerPrintWidth))).join(`
`),
                ),
        ...
        t8 &&
            n.push(
                [`- ${se2.default.blue(t8.title)}:`].concat(
                    t8.values.map((o) => Ur2(o, r - $r2.length).replace(/^|\n/g, `$&${$r2}`)),
                ).join(`
`),
            ),
        zr(n, r)
...
function Ot2(e, t8) {
    ...
    for (; d < o; )
        for (i = t8.charCodeAt(u + d), D = d++, s = d, c = 0; c < n; c++)
            (a = i === Gr[c] ? D : D + 1), (D = wt2[c]), (s = wt2[c] = D > s ? (a > s ? s + 1 : a) : a > D ? D + 1 : a);
    return s;
}
...
function St2(e) {
    ...
    return (
        Hu((t8 || r) !== void 0, 'Unexpected `expected` result, there should be at least one field.'),
...
function Pt2(e, t8, r = !1) {
    return e === !1 ? !1 : e === !0 ? (r ? !0 : [{ value: t8 }]) : 'value' in e ? [e] : e.length === 0 ? !1 : e;
}
function Hr2(e, t8) {
...
var Dt2 = class extends w {
    ...
    ct2 = class extends at2 {
        ...
        validate(t8, r) {
            return r.normalizeValidateResult(super.validate(t8, r), t8) === !0 && Qr2(t8);
        }
    },
    Le2 = class extends w {
        expected() {
    ...
    It2;
function Ju(e, t8, { logger: r = !1, isCLI: n = !1, passThrough: o = !1, FlagSchema: u, descriptor: i } = {}) {
    if (n) {
...
function Zu(e, { isCLI: t8, optionInfos: r, FlagSchema: n }) {
    ...
    switch (e.type) {
        ...
        case 'choice':
            (i = Dt2),
                (u.choices = e.choices.map((D) =>
                    D != null && D.redirect ? { ...D, redirect: { to: { key: e.name, value: D.redirect } } } : D,
                ));
            break;
        case 'boolean':
            i = it2;
        ...
        case 'flag':
            (i = n),
                (u.flags = r.flatMap((D) =>
                    [D.alias, D.description && D.name, D.oppositeDescription && `no-${D.name}`].filter(Boolean),
                ));
            break;
        case 'path':
            i = Le2;
    ...
    if (
        ...
        e.redirect && (s.redirect = (D) => (D ? { to: { key: e.redirect.option, value: e.redirect.value } } : void 0)),
...
async function Qu(e, t8 = {}) {
    ...
    let n = et2({ plugins: e.plugins, showDeprecated: !0 }).options,
        o = {
            ...cn2,
            ...Object.fromEntries(n.filter((f2) => f2.default !== void 0).map((f2) => [f2.name, f2.default])),
        },
        u = Rt2(r.plugins, r.parser),
        i = await Yt(u, r.parser);
    (r.astFormat = i.astFormat), (r.locEnd = i.locEnd), (r.locStart = i.locStart);
    let s = (d = u.printers) != null && d[i.astFormat] ? u : Dn2(r.plugins, i.astFormat),
        D = await an2(s, i.astFormat);
    r.printer = D;
    let a = s.defaultOptions
            ? Object.fromEntries(Object.entries(s.defaultOptions).filter(([, f2]) => f2 !== void 0))
            : {},
        c = { ...o, ...a };
...
function Ut2(e, t8) {
    (e.comments ?? (e.comments = [])).push(t8), (t8.printed = !1), (t8.nodeDescription = Eo2(e));
}
function ne2(e, t8) {
...
function Et2(e, t8) {
    ...
    if (!n) return [];
    let s = (r?.(e, t8) ?? [...Wt2(e, { getVisitorKeys: H2(o) })]).flatMap((D) => (n(D) ? [D] : Et2(D, t8)));
...
function Nn2(e, t8) {
    ...
    for (let [p, l] of f2.entries()) {
        ...
        if (
            (i
                ? ($ = [l])
                : ((F2.enclosingNode = E2), (F2.precedingNode = m), (F2.followingNode = C), ($ = [F2, g, h2, B, Z])),
            Co2(g, h2, f2, p))
        )
            (F2.placement = 'ownLine'), a(...$) || (C ? ne2(C, F2) : m ? ue2(m, F2) : X2(E2 || B, F2));
        else if (ho2(g, h2, f2, p))
            (F2.placement = 'endOfLine'), c(...$) || (m ? ue2(m, F2) : C ? ne2(C, F2) : X2(E2 || B, F2));
...
function wn2(e, t8) {
    ...
    for (i = r; i > 0; --i) {
        ...
        if (((D = (s = t8.printer).isGap) == null ? void 0 : D.call(s, f2, t8)) ?? /^[\s(]*$/.test(f2))
            u = t8.locStart(a);
        else break;
    }
...
function go2(e, t8) {
    let r = t8 - 1;
    (r = N2(e, r, { backwards: !0 })), (r = Y2(e, r, { backwards: !0 })), (r = N2(e, r, { backwards: !0 }));
...
function Ao2(e, t8, r) {
    ...
    if ((r != null && r.hasLineSuffix && !(r != null && r.isBlock)) || V2(i, s(n), { backwards: !0 })) {
        let c = Ye2(i, s(n));
...
async function _o2(e, t8, r, n) {
    let o = await re2({ ...r, ...t8, parentParser: r.parser, originalText: e }, { passThrough: !0 }),
        { ast: u } = await De2(e, o),
        i = await n(u, o);
    return Xe2(i);
}
...
function Yn2(e, t8, r, n, o) {
    ...
    return (
        ...
        i.printComment && (!i.willPrintOwnComments || !i.willPrintOwnComments(e, t8)) && (s = vn2(e, s, t8)),
        s
    );
}
...
async function qn2(e, t8, r = 0) {
    ...
    if (r > 0) {
        ...
        i.cursorNodeStart !== void 0 && (i.cursorNodeStart -= i.formatted.indexOf(D)),
...
`,
        ...
        c = await qn2(
            i,
            {
                ...
                cursorOffset: t8.cursorOffset > o && t8.cursorOffset <= u ? t8.cursorOffset - o : -1,
                endOfLine: 'lf',
            },
            a,
        ),
...
async function Xt2(e, t8) {
    ...
    if ((o.rangeStart >= o.rangeEnd && n !== '') || (o.requirePragma && !(await Gn2(n, o))))
    ...
    return (
        o.rangeStart > 0 || o.rangeEnd < n.length
            ...
            : (!o.requirePragma &&
              ...
              (u = await qn2(n, o))),
        r && ((u.formatted = Hn2 + u.formatted), u.cursorOffset >= 0 && u.cursorOffset++),
        u
    );
}
...
var Ee2 = Lo;
function Io(e, t8) {
    return t8 === !1 ? !1 : e.charAt(t8) === '/' && e.charAt(t8 + 1) === '/' ? mt2(e, t8) : t8;
}
var Ce2 = Io;
function Ro(e, t8) {
    let r = null,
...
var ti2 = ae(et2, 0),
    ri2 = { parse: ae(Xn2), formatAST: ae(Zn2), formatDoc: ae(Qn2), printToDoc: ae(eu), printDocToString: ae(tu) },
    qc = tr2;
        ...
        return matches
            ? arr.concat(
                  matches.map(function (match) {
                      var _a2, _b;
                      return (_b = (_a2 = match.match(/[\t ]/g)) === null || _a2 === void 0 ? void 0 : _a2.length) !==
                          null && _b !== void 0
                          ? _b
                          : 0;
                  }),
...
var formatter = (0, import_memoizerific.default)(2)(async (type, source) =>
    type === !1
        ...
        : type === 'dedent' || type === !0
        ? dedent(source)
        : (await qc.format(source, { parser: type, plugins: [dh], htmlWhitespaceSensitivity: 'ignore' })).trim(),
);
export { formatter };
