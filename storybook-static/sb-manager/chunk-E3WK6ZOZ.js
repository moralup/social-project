...
} from './chunk-XCO5HRLK.js';
import { WithToolTipState } from './chunk-FEE35O7J.js';
import {
    _extends,
...
import { __commonJS, __export, __toESM, require_memoizerific } from './chunk-XP3HGWTR.js';
    ...
    '../../node_modules/has-symbols/shams.js'(exports, module) {
        ...
        module.exports = function () {
            ...
            if (
                ...
                (typeof Object.getOwnPropertyNames == 'function' && Object.getOwnPropertyNames(obj).length !== 0)
            )
                return !1;
        ...
        var throwTypeError = function () {
            ...
            INTRINSICS = {
                ...
                '%MapIteratorPrototype%':
                    typeof Map > 'u' || !hasSymbols || !getProto ? undefined2 : getProto(new Map()[Symbol.iterator]()),
                '%Math%': Math,
                '%Number%': Number,
                '%Object%': Object,
                ...
                '%SetIteratorPrototype%':
                    typeof Set > 'u' || !hasSymbols || !getProto ? undefined2 : getProto(new Set()[Symbol.iterator]()),
        ...
        var errorProto,
            ...
            getBaseIntrinsic = function (name2, allowMissing) {
                ...
                if (
                    ...
                    if (
                        (value2 === needsEval && (value2 = doEval(intrinsicName)), typeof value2 > 'u' && !allowMissing)
                    )
                        throw new $TypeError(
...
var require_define_data_property = __commonJS({
    '../../node_modules/define-data-property/index.js'(exports, module) {
        ...
        module.exports = function (obj, property, value2) {
            ...
            else if (loose || (!nonEnumerable && !nonWritable && !nonConfigurable)) obj[property] = value2;
            else
                throw new $SyntaxError(
        ...
        module.exports = function (fn, length) {
            ...
            return (
                (functionLengthIsConfigurable || functionLengthIsWritable || !loose) &&
                    (hasDescriptors ? define(fn, 'length', length, !0, !0) : define(fn, 'length', length)),
                fn
            );
        };
    },
...
var require_callBound = __commonJS({
    '../../node_modules/call-bind/callBound.js'(exports, module) {
        ...
        module.exports = function (name2, allowMissing) {
            ...
            return typeof intrinsic == 'function' && $indexOf(name2, '.prototype.') > -1
                ? callBind(intrinsic)
                : intrinsic;
        };
    },
...
var require_object_inspect = __commonJS({
    '../../node_modules/object-inspect/index.js'(exports, module) {
        ...
        module.exports = function inspect_(obj, options2, depth, seen) {
            ...
            if (isElement(obj)) {
                for (
                    var s = '<' + $toLowerCase.call(String(obj.nodeName)), attrs = obj.attributes || [], i = 0;
                    i < attrs.length;
                    i++
                )
                ...
                return (
                    mapForEach &&
                        mapForEach.call(obj, function (value2, key2) {
                            mapParts.push(inspect(key2, obj, !0) + ' => ' + inspect(value2, obj));
                        }),
        ...
        function isRegExp(obj) {
            return (
                toStr(obj) === '[object RegExp]' && (!toStringTag || !(typeof obj == 'object' && toStringTag in obj))
            );
        }
        ...
        function isString(obj) {
            return (
                toStr(obj) === '[object String]' && (!toStringTag || !(typeof obj == 'object' && toStringTag in obj))
            );
        }
        function isNumber(obj) {
            return (
                toStr(obj) === '[object Number]' && (!toStringTag || !(typeof obj == 'object' && toStringTag in obj))
            );
        }
        function isBoolean(obj) {
            return (
                toStr(obj) === '[object Boolean]' && (!toStringTag || !(typeof obj == 'object' && toStringTag in obj))
            );
        }
...
` +
        ...
        function arrObjKeys(obj, inspect) {
            ...
            if (isArr) {
                ...
                for (var i = 0; i < obj.length; i++) xs[i] = has3(obj, i) ? inspect(obj[i], obj) : '';
            }
            ...
            var $wm,
                ...
                channel = {
                    assert: function (key2) {
                        if (!channel.has(key2)) throw new $TypeError('Side channel does not contain ' + inspect(key2));
                    },
                    get: function (key2) {
                    ...
                    set: function (key2, value2) {
                        $WeakMap && key2 && (typeof key2 == 'object' || typeof key2 == 'function')
    ...
    '../../node_modules/qs/lib/utils.js'(exports, module) {
        ...
        var formats = require_formats(),
            ...
            arrayToObject = function (source2, options2) {
                for (
                    var obj = options2 && options2.plainObjects ? Object.create(null) : {}, i = 0;
                    i < source2.length;
                    ++i
                )
            ...
            merge = function merge2(target, source2, options2) {
                ...
                if (!target || typeof target != 'object') return [target].concat(source2);
                var mergeTarget = target;
                return (
                    isArray2(target) && !isArray2(source2) && (mergeTarget = arrayToObject(target, options2)),
            ...
            encode = function (str, defaultEncoder, charset, kind, format2) {
                ...
                for (var out = '', i = 0; i < string.length; ++i) {
                    ...
                    if (c2 < 55296 || c2 >= 57344) {
                        out =
                            out +
                            (hexTable[224 | (c2 >> 12)] + hexTable[128 | ((c2 >> 6) & 63)] + hexTable[128 | (c2 & 63)]);
                        continue;
                    }
                    (i += 1),
            ...
            compact = function (value2) {
                for (var queue = [{ obj: { o: value2 }, prop: 'o' }], refs2 = [], i = 0; i < queue.length; ++i)
                    for (
                        var item = queue[i], obj = item.obj[item.prop], keys2 = Object.keys(obj), j = 0;
                        j < keys2.length;
                        ++j
                    ) {
                        var key2 = keys2[j],
    ...
    '../../node_modules/qs/lib/stringify.js'(exports, module) {
        ...
        var getSideChannel = require_side_channel(),
            ...
            stringify2 = function stringify3(
                ...
                for (
                    ...
                    var key2 = objKeys[j],
                        value2 = typeof key2 == 'object' && typeof key2.value < 'u' ? key2.value : obj[key2];
            ...
            normalizeStringifyOptions = function (opts) {
                ...
                return (
                    (typeof opts.filter == 'function' || isArray2(opts.filter)) && (filter = opts.filter),
                    {
                        addQueryPrefix:
        ...
        module.exports = function (object, opts) {
            ...
            typeof options2.filter == 'function'
                ...
                : isArray2(options2.filter) && ((filter = options2.filter), (objKeys = filter));
            var keys2 = [];
            ...
            objKeys || (objKeys = Object.keys(obj)), options2.sort && objKeys.sort(options2.sort);
    ...
    '../../node_modules/qs/lib/parse.js'(exports, module) {
        ...
        var utils = require_utils(),
            ...
            parseArrayValue = function (val, options2) {
                return val && typeof val == 'string' && options2.comma && val.indexOf(',') > -1 ? val.split(',') : val;
            },
            ...
            parseValues = function (str, options2) {
                var obj = { __proto__: null },
                    ...
                    limit = options2.parameterLimit === 1 / 0 ? void 0 : options2.parameterLimit,
                ...
                for (i = 0; i < parts.length; ++i)
                    if (i !== skipIndex) {
                        var part = parts[i],
                            ...
                            pos = bracketEqualsPos === -1 ? part.indexOf('=') : bracketEqualsPos + 1,
                            key2,
                            val;
                        pos === -1
                            ...
                            has3.call(obj, key2) ? (obj[key2] = utils.combine(obj[key2], val)) : (obj[key2] = val);
                    }
                return obj;
            },
            parseObject = function (chain, val, options2, valuesParsed) {
                for (
                    var leaf = valuesParsed ? val : parseArrayValue(val, options2), i = chain.length - 1;
                    i >= 0;
                    --i
                ) {
                    var obj,
            ...
            parseKeys = function (givenKey, val, options2, valuesParsed) {
                if (givenKey) {
                    var key2 = options2.allowDots ? givenKey.replace(/\.([^.[]+)/g, '[$1]') : givenKey,
                        ...
                        keys2 = [];
                    if (parent) {
                        if (!options2.plainObjects && has3.call(Object.prototype, parent) && !options2.allowPrototypes)
                            return;
                        keys2.push(parent);
                    }
                    for (
                        var i = 0;
                        options2.depth > 0 && (segment = child.exec(key2)) !== null && i < options2.depth;
        ...
        module.exports = function (str, opts) {
            ...
            if (str === '' || str === null || typeof str > 'u') return options2.plainObjects ? Object.create(null) : {};
            for (
                ...
                var key2 = keys2[i],
                    newObj = parseKeys(key2, tempObj[key2], options2, typeof str == 'string');
...
var require_listCacheDelete = __commonJS({
    '../../node_modules/lodash/_listCacheDelete.js'(exports, module) {
        ...
        function listCacheDelete2(key2) {
            ...
            return index3 == lastIndex ? data.pop() : splice2.call(data, index3, 1), --this.size, !0;
        }
...
var require_listCacheSet = __commonJS({
    '../../node_modules/lodash/_listCacheSet.js'(exports, module) {
        ...
        function listCacheSet2(key2, value2) {
            var data = this.__data__,
                index3 = assocIndexOf2(data, key2);
            return index3 < 0 ? (++this.size, data.push([key2, value2])) : (data[index3][1] = value2), this;
        }
...
var require_mapCacheClear = __commonJS({
    '../../node_modules/lodash/_mapCacheClear.js'(exports, module) {
        ...
        function mapCacheClear2() {
            (this.size = 0),
                (this.__data__ = { hash: new Hash2(), map: new (Map3 || ListCache2)(), string: new Hash2() });
        }
    ...
    '../../node_modules/lodash/_baseAssignValue.js'(exports, module) {
        ...
        function baseAssignValue(object, key2, value2) {
            key2 == '__proto__' && defineProperty
                ? defineProperty(object, key2, { configurable: !0, enumerable: !0, value: value2, writable: !0 })
                : (object[key2] = value2);
        }
...
var require_assignMergeValue = __commonJS({
    '../../node_modules/lodash/_assignMergeValue.js'(exports, module) {
        ...
        function assignMergeValue(object, key2, value2) {
            ((value2 !== void 0 && !eq2(object[key2], value2)) || (value2 === void 0 && !(key2 in object))) &&
...
var require_copyArray = __commonJS({
    '../../node_modules/lodash/_copyArray.js'(exports, module) {
        function copyArray(source2, array) {
            ...
            for (array || (array = Array(length)); ++index3 < length; ) array[index3] = source2[index3];
            return array;
        }
        ...
        function copyObject(source2, props, object, customizer) {
            ...
            for (var index3 = -1, length = props.length; ++index3 < length; ) {
                var key2 = props[index3],
                    newValue = customizer ? customizer(object[key2], source2[key2], key2, object, source2) : void 0;
                newValue === void 0 && (newValue = source2[key2]),
                    isNew ? baseAssignValue(object, key2, newValue) : assignValue(object, key2, newValue);
            }
            return object;
        }
...
var require_baseTimes = __commonJS({
    '../../node_modules/lodash/_baseTimes.js'(exports, module) {
        function baseTimes(n, iteratee) {
            for (var index3 = -1, result2 = Array(n); ++index3 < n; ) result2[index3] = iteratee(index3);
            return result2;
        }
    ...
    '../../node_modules/lodash/_baseKeysIn.js'(exports, module) {
        ...
        function baseKeysIn(object) {
            ...
            for (var key2 in object)
                (key2 == 'constructor' && (isProto || !hasOwnProperty5.call(object, key2))) || result2.push(key2);
            return result2;
        }
                    ...
                    function (srcValue, key2) {
                        if ((stack || (stack = new Stack()), isObject4(srcValue)))
                            ...
                            var newValue = customizer
                                ? customizer(safeGet(object, key2), srcValue, key2 + '', object, source2, stack)
                                : void 0;
                            newValue === void 0 && (newValue = srcValue), assignMergeValue(object, key2, newValue);
                        }
                    },
                    keysIn,
                );
        ...
        function overRest(func, start, transform) {
            return (
                ...
                function () {
                    ...
                    index3 = -1;
                    for (var otherArgs = Array(start + 1); ++index3 < start; ) otherArgs[index3] = args2[index3];
...
var require_mergeWith = __commonJS({
    '../../node_modules/lodash/mergeWith.js'(exports, module) {
        var baseMerge = require_baseMerge(),
            ...
            mergeWith2 = createAssigner(function (object, source2, srcIndex, customizer) {
        ...
        (function (window2, define) {
            var _ = {
                    ...
                    Store: function (id, area, namespace) {
                        ...
                        return (
                            ...
                            _.apis[store3._ns + store3._id] || (_.apis[store3._ns + store3._id] = store3),
                            store3
                        );
                    },
                    storeAPI: {
                        area: function (id, area) {
                            ...
                            return (
                                (!store3 || !store3.area) &&
                                    ((store3 = _.Store(id, area, this._ns)), this[id] || (this[id] = store3)),
                                store3
                            );
                        },
                        ...
                        isFake: function (force) {
                            return (
                                force
                                    ? ((this._real = this._area), (this._area = _.storage('fake')))
                        ...
                        has: function (key2) {
                            return this._area.has ? this._area.has(this._in(key2)) : this._in(key2) in this._area;
                        },
                        size: function () {
                        ...
                        each: function (fn, fill) {
                            for (var i = 0, m2 = _.length(this._area); i < m2; i++) {
                                ...
                                if (key2 !== void 0 && fn.call(this, key2, this.get(key2), fill) === !1) break;
                        ...
                        set: function (key2, data, overwrite) {
                            ...
                            return d != null && overwrite === !1
                                ? data
                                : (typeof overwrite == 'function' && ((replacer3 = overwrite), (overwrite = void 0)),
                                  _.set(this._area, this._in(key2), _.stringify(data, replacer3), overwrite) || d);
                        },
                        setAll: function (data, overwrite) {
                            var changed, val;
                            for (var key2 in data)
                                (val = data[key2]), this.set(key2, val, overwrite) !== val && (changed = !0);
                            return changed;
                        },
                        add: function (key2, data, replacer3) {
                            ...
                            return _.set(this._area, this._in(key2), _.stringify(data, replacer3)), data;
                        },
                        ...
                        _in: function (k2) {
                            return typeof k2 != 'string' && (k2 = _.stringify(k2)), this._ns ? this._ns + k2 : k2;
                        },
                        _out: function (k2) {
                            return this._ns
                    ...
                    storageAPI: {
                        ...
                        key: function (i) {
                            var c2 = 0;
                            for (var k2 in this.items) if (this.has(k2) && i === c2++) return k2;
                        },
            ...
            (store2.local = store2),
                ...
                typeof define == 'function' && define.amd !== void 0
                    ...
                    : (window2.store && (_.conflict = window2.store), (window2.store = store2));
...
var require_SetCache = __commonJS({
    '../../node_modules/lodash/_SetCache.js'(exports, module) {
        ...
        function SetCache(values) {
            ...
            for (this.__data__ = new MapCache2(); ++index3 < length; ) this.add(values[index3]);
        }
...
var require_arraySome = __commonJS({
    '../../node_modules/lodash/_arraySome.js'(exports, module) {
        function arraySome(array, predicate) {
            for (var index3 = -1, length = array == null ? 0 : array.length; ++index3 < length; )
...
var require_equalArrays = __commonJS({
    '../../node_modules/lodash/_equalArrays.js'(exports, module) {
        ...
        function equalArrays(array, other, bitmask, customizer, equalFunc, stack) {
            ...
            for (stack.set(array, other), stack.set(other, array); ++index3 < arrLength; ) {
...
var require_arrayPush = __commonJS({
    '../../node_modules/lodash/_arrayPush.js'(exports, module) {
        function arrayPush(array, values) {
            for (var index3 = -1, length = values.length, offset = array.length; ++index3 < length; )
    ...
    '../../node_modules/lodash/_equalObjects.js'(exports, module) {
        ...
        function equalObjects(object, other, bitmask, customizer, equalFunc, stack) {
            ...
            for (var index3 = objLength; index3--; ) {
                ...
                if (!(isPartial ? key2 in other : hasOwnProperty5.call(other, key2))) return !1;
            }
    ...
    '../../node_modules/lodash/_baseIsEqualDeep.js'(exports, module) {
        ...
        function baseIsEqualDeep(object, other, bitmask, customizer, equalFunc, stack) {
            ...
            if (!(bitmask & COMPARE_PARTIAL_FLAG)) {
                var objIsWrapped = objIsObj && hasOwnProperty5.call(object, '__wrapped__'),
...
var require_baseIsEqual = __commonJS({
    '../../node_modules/lodash/_baseIsEqual.js'(exports, module) {
        ...
        function baseIsEqual(value2, other, bitmask, customizer, stack) {
            return value2 === other
                ? !0
                : value2 == null || other == null || (!isObjectLike2(value2) && !isObjectLike2(other))
                ? value2 !== value2 && other !== other
                : baseIsEqualDeep(value2, other, bitmask, customizer, baseIsEqual, stack);
        }
        ...
        function createBaseEach(eachFunc, fromRight) {
            return function (collection, iteratee) {
                ...
                for (
                    ...
                    (fromRight ? index3-- : ++index3 < length) && iteratee(iterable[index3], index3, iterable) !== !1;
        ...
        function baseIsMatch(object, source2, matchData, customizer) {
            ...
            for (; ++index3 < length; ) {
                ...
                if (noCustomizer && data[2]) {
                    ...
                    var stack = new Stack();
                    if (customizer) var result2 = customizer(objValue, srcValue, key2, object, source2, stack);
                    if (
                        !(result2 === void 0
                            ? baseIsEqual(
                                  srcValue,
    ...
    '../../node_modules/lodash/_matchesStrictComparable.js'(exports, module) {
        function matchesStrictComparable(key2, srcValue) {
            return function (object) {
                return object == null
                    ? !1
                    : object[key2] === srcValue && (srcValue !== void 0 || key2 in Object(object));
            };
        }
...
var require_isKey = __commonJS({
    '../../node_modules/lodash/_isKey.js'(exports, module) {
        ...
        function isKey2(value2, object) {
            ...
            var type = typeof value2;
            return type == 'number' || type == 'symbol' || type == 'boolean' || value2 == null || isSymbol2(value2)
                ? !0
...
var require_baseToString = __commonJS({
    '../../node_modules/lodash/_baseToString.js'(exports, module) {
        ...
        function baseToString2(value2) {
            ...
            if (isSymbol2(value2)) return symbolToString2 ? symbolToString2.call(value2) : '';
            var result2 = value2 + '';
...
var require_castPath = __commonJS({
    '../../node_modules/lodash/_castPath.js'(exports, module) {
        ...
        function castPath2(value2, object) {
            return isArray2(value2) ? value2 : isKey2(value2, object) ? [value2] : stringToPath2(toString2(value2));
        }
...
var require_baseGet = __commonJS({
    '../../node_modules/lodash/_baseGet.js'(exports, module) {
        ...
        function baseGet2(object, path) {
            ...
            for (var index3 = 0, length = path.length; object != null && index3 < length; )
...
var require_hasPath = __commonJS({
    '../../node_modules/lodash/_hasPath.js'(exports, module) {
        ...
        function hasPath(object, path, hasFunc) {
            path = castPath2(path, object);
            for (var index3 = -1, length = path.length, result2 = !1; ++index3 < length; ) {
            ...
            return result2 || ++index3 != length
                ...
                : ((length = object == null ? 0 : object.length),
                  !!length && isLength(length) && isIndex(key2, length) && (isArray2(object) || isArguments(object)));
        }
    ...
    '../../node_modules/lodash/countBy.js'(exports, module) {
        var baseAssignValue = require_baseAssignValue(),
            ...
            countBy2 = createAggregator(function (result2, value2, key2) {
                hasOwnProperty5.call(result2, key2) ? ++result2[key2] : baseAssignValue(result2, key2, 1);
            });
    ...
    '../../node_modules/lodash/_baseSet.js'(exports, module) {
        ...
        function baseSet(object, path, value2, customizer) {
            ...
            for (
                ...
                var key2 = toKey2(path[index3]),
                    newValue = value2;
                if (key2 === '__proto__' || key2 === 'constructor' || key2 === 'prototype') return object;
                if (index3 != lastIndex) {
...
var require_basePickBy = __commonJS({
    '../../node_modules/lodash/_basePickBy.js'(exports, module) {
        ...
        function basePickBy(object, paths, predicate) {
            for (var index3 = -1, length = paths.length, result2 = {}; ++index3 < length; ) {
                var path = paths[index3],
                    value2 = baseGet2(object, path);
                predicate(value2, path) && baseSet(result2, castPath2(path, object), value2);
            }
            return result2;
        }
...
var require_isFlattenable = __commonJS({
    '../../node_modules/lodash/_isFlattenable.js'(exports, module) {
        ...
        function isFlattenable(value2) {
            return (
                isArray2(value2) || isArguments(value2) || !!(spreadableSymbol && value2 && value2[spreadableSymbol])
            );
        }
...
var require_baseFlatten = __commonJS({
    '../../node_modules/lodash/_baseFlatten.js'(exports, module) {
        ...
        function baseFlatten(array, depth, predicate, isStrict, result2) {
            var index3 = -1,
                length = array.length;
            for (predicate || (predicate = isFlattenable), result2 || (result2 = []); ++index3 < length; ) {
                var value2 = array[index3];
    ...
    require_isPlainObject = __commonJS2({
        '../../node_modules/lodash/isPlainObject.js'(exports, module) {
            ...
            function isPlainObject2(value2) {
                ...
                var Ctor = hasOwnProperty5.call(proto, 'constructor') && proto.constructor;
                return (
                    typeof Ctor == 'function' && Ctor instanceof Ctor && funcToString3.call(Ctor) == objectCtorString
                );
            }
        ...
        return matches
            ? arr.concat(
                  matches.map(function (match) {
                      var _a, _b;
                      return (_b = (_a = match.match(/[\t ]/g)) === null || _a === void 0 ? void 0 : _a.length) !==
                          null && _b !== void 0
                          ? _b
                          : 0;
                  }),
...
var splitPathRegex = /\/([^/]+)\/(?:(.*)_)?([^/]+)?/,
    ...
    deepDiff = (value2, update2) => {
        ...
        return (0, import_isPlainObject.default)(value2) && (0, import_isPlainObject.default)(update2)
    ...
    validateArgs = (key2 = '', value2) =>
        key2 === null || key2 === '' || !VALIDATION_REGEXP.test(key2)
            ? !1
            : value2 == null || value2 instanceof Date || typeof value2 == 'number' || typeof value2 == 'boolean'
            ? !0
            : typeof value2 == 'string'
    ...
    stringifyQuery = (query) => import_qs.default.stringify(query, { addQueryPrefix: !0, encode: !1 }),
...
function createBrowserHistory(options2) {
    ...
    index3 == null &&
        ((index3 = 0), globalHistory.replaceState(_extends2({}, globalHistory.state, { idx: index3 }), ''));
    ...
    function getHistoryStateAndUrl(nextLocation, index22) {
        return [{ usr: nextLocation.state, key: nextLocation.key, idx: index22 }, createHref(nextLocation)];
    }
    function allowTx(action2, location22, retry) {
        return !blockers.length || (blockers.call({ action: action2, location: location22, retry }), !1);
    }
    ...
    function push(to, state) {
        ...
        if (allowTx(nextAction, nextLocation, retry)) {
            var _getHistoryStateAndUr = getHistoryStateAndUrl(nextLocation, index3 + 1),
    ...
    var history = {
        ...
        block: function (blocker) {
            ...
            return (
                blockers.length === 1 && window2.addEventListener(BeforeUnloadEventType, promptBeforeUnload),
                function () {
                    unblock(),
                        blockers.length || window2.removeEventListener(BeforeUnloadEventType, promptBeforeUnload);
                }
            );
        },
    };
...
var RouteContext = (0, import_react.createContext)({ outlet: null, matches: [] });
...
function Router(_ref3) {
    ...
    let { pathname = '/', search = '', hash = '', state = null, key: key2 = 'default' } = locationProp,
        location3 = (0, import_react.useMemo)(() => {
            let trailingPathname = stripBasename(pathname, basename);
            return trailingPathname == null ? null : { pathname: trailingPathname, search, hash, state, key: key2 };
...
function useHref(to) {
    ...
    let { basename, navigator: navigator3 } = (0, import_react.useContext)(NavigationContext),
...
function useLocation() {
    return (
        useInRouterContext() || invariant(!1, 'useLocation() may be used only in the context of a <Router> component.'),
...
function _objectWithoutPropertiesLoose2(source2, excluded) {
    ...
    for (i = 0; i < sourceKeys.length; i++)
        (key2 = sourceKeys[i]), !(excluded.indexOf(key2) >= 0) && (target[key2] = source2[key2]);
    return target;
}
...
function BrowserRouter(_ref) {
    ...
    historyRef.current == null && (historyRef.current = createBrowserHistory({ window: window2 }));
    let history = historyRef.current,
        [state, setState] = (0, import_react.useState)({ action: history.action, location: history.location });
    return (
...
var Link = (0, import_react.forwardRef)(function (_ref3, ref) {
    ...
    return (0, import_react.createElement)('a', _extends22({}, rest, { href, onClick: handleClick, ref, target }));
});
...
var NavLink = (0, import_react.forwardRef)(function (_ref4, ref) {
    ...
    return (0,
    import_react.createElement)(Link, _extends22({}, rest, { 'aria-current': ariaCurrent, className, ref, style, to }));
});
...
var { document: document2 } = scope2,
    ...
    Link2 = ({ to, children, ...rest }) =>
        import_react.default.createElement(Link, { to: `${getBase()}path=${to}`, ...rest }, children);
...
function Match({ children, path: targetPath, startsWith = !1 }) {
    return import_react.default.createElement(Location, null, ({ path: urlPath, ...rest }) =>
...
function Route2(input) {
    ...
    return (
        ...
        import_react.default.createElement(Match, { ...rest }, ({ match }) => (match ? children : null))
    );
}
        ...
        'node_modules/get-intrinsic/index.js'(exports, module) {
            ...
            var throwTypeError = function () {
                ...
                INTRINSICS = {
                    ...
                    '%Map%': typeof Map > 'u' ? undefined2 : Map,
                    '%MapIteratorPrototype%':
                        typeof Map > 'u' || !hasSymbols ? undefined2 : getProto(new Map()[Symbol.iterator]()),
                    '%Math%': Math,
                    '%Number%': Number,
                    '%Object%': Object,
                    '%parseFloat%': parseFloat,
                    ...
                    '%Set%': typeof Set > 'u' ? undefined2 : Set,
                    '%SetIteratorPrototype%':
                        typeof Set > 'u' || !hasSymbols ? undefined2 : getProto(new Set()[Symbol.iterator]()),
                    '%SharedArrayBuffer%': typeof SharedArrayBuffer > 'u' ? undefined2 : SharedArrayBuffer,
                    '%String%': String,
            ...
            module.exports = hasToStringTag
                ? function (value2) {
                      ...
                      var descriptor = gOPD(value2, 'lastIndex'),
                          hasLastIndexDataProperty = descriptor && has3(descriptor, 'value');
            ...
            hasSymbols
                ? ((symToStr = Symbol.prototype.toString),
                  ...
                  (isSymbolObject = function (value2) {
                      return typeof value2.valueOf() != 'symbol' ? !1 : symStringRegex.test(symToStr.call(value2));
                  }),
...
function arrayMap(array, iteratee) {
    for (var index3 = -1, length = array == null ? 0 : array.length, result2 = Array(length); ++index3 < length; )
        result2[index3] = iteratee(array[index3], index3, array);
    return result2;
}
...
function isKey(value2, object) {
    ...
    var type = typeof value2;
    return type == 'number' || type == 'symbol' || type == 'boolean' || value2 == null || isSymbol_default(value2)
        ? !0
        : reIsPlainProp.test(value2) || !reIsDeepProp.test(value2) || (object != null && value2 in Object(object));
}
...
function assocIndexOf(array, key2) {
    for (var length = array.length; length--; ) if (eq_default(array[length][0], key2)) return length;
    return -1;
}
...
function listCacheDelete(key2) {
    ...
    if (index3 < 0) return !1;
    var lastIndex = data.length - 1;
    return index3 == lastIndex ? data.pop() : splice.call(data, index3, 1), --this.size, !0;
}
...
` &&
    ...
    cleanCode = (0, import_memoizerific2.default)(1e4)((code) => removeCodeComments(code).replace(/\n\s*/g, '').trim()),
...
var replacer = function (options2) {
        ...
        return function (key2, value2) {
            try {
                if (key2 === '')
                    return (
                        (keys2 = []), (objects = new Map([[value2, '[]']])), (map2 = new Map()), (stack = []), value2
                    );
                let origin = map2.get(this) || this;
                for (; stack.length && origin !== stack[0]; ) stack.shift(), keys2.pop();
                if (typeof value2 == 'boolean') return value2;
                if (value2 === void 0) return options2.allowUndefined ? '_undefined_' : void 0;
                ...
                if (typeof value2 == 'string')
                    return dateFormat.test(value2) ? (options2.allowDate ? `_date_${value2}` : void 0) : value2;
                if ((0, import_is_regex.default)(value2))
                    return options2.allowRegExp ? `_regexp_${value2.flags}|${value2.source}` : void 0;
    ...
    reviver2 = function reviver(options) {
        ...
        return function revive(key, value) {
            ...
            if (isObject3(value) && value['_constructor-name_'] && options.allowFunction) {
                ...
                if (name2 !== 'Object') {
                    let Fn = new Function(`return function ${name2.replace(/[^a-zA-Z0-9$_]+/g, '')}(){}`)();
            ...
            isObject3(value2) &&
                ...
                Array.isArray(value2) &&
                    value2.forEach((v2, index3) => {
                        v2 === '_undefined_'
                            ? (mutated.set(v2, !0), (value2[index3] = void 0))
                            : mutated.get(v2) || (mutated.set(v2, !0), mutateUndefined(v2));
                    });
        };
    },
...
var isMulti = (args2) => args2.transports !== void 0,
    ...
    getEventSourceUrl = (event) => {
        let frames = Array.from(document.querySelectorAll('iframe[data-is-storybook]')),
            [frame, ...remainder] = frames.filter((element) => {
                try {
                    return (
                        element.contentWindow?.location.origin === event.source.location.origin &&
                        element.contentWindow?.location.pathname === event.source.location.pathname
                    );
                } catch {}
                try {
    ...
    PostMessageTransport = class {
        ...
        send(event, options2) {
            let {
                ...
                stringifyOptions = { ...defaultEventOptions, ...(scope.CHANNEL_OPTIONS || {}), ...eventOptions },
                frames = this.getFrames(target),
                query = new URLSearchParams(location?.search || ''),
                data = stringify({ key: KEY, event, refId: query.get('refId') }, stringifyOptions);
        ...
        getFrames(target) {
            if (this.config.page === 'manager') {
                let list = Array.from(document22.querySelectorAll('iframe[data-is-storybook][data-is-loaded]')).flatMap(
                    (e) => {
                        try {
        ...
        getCurrentFrames() {
            return this.config.page === 'manager'
                ? Array.from(document22.querySelectorAll('[data-is-storybook="true"]')).flatMap((e) =>
        ...
        getLocalFrame() {
            return this.config.page === 'manager'
                ? Array.from(document22.querySelectorAll('#storybook-preview-iframe')).flatMap((e) =>
                      e.contentWindow ? [e.contentWindow] : [],
                  )
                : scope && scope.parent
                ? [scope.parent]
                ...
                let { data } = rawEvent,
                    {
                        ...
                        event,
                        refId,
                    } = typeof data == 'string' && isJSON(data) ? parse(data, scope.CHANNEL_OPTIONS || {}) : data;
                if (key2 === KEY) {
                    let pageString =
    ...
    WebsocketTransport = class {
        constructor({ url, onError, page }) {
            (this.buffer = []),
                ...
                (this.socket.onmessage = ({ data }) => {
                    ...
                    invariant2(this.handler, 'WebsocketTransport handler should be set'), this.handler(event);
                }),
        ...
        sendNow(event) {
            let data = stringify(event, { maxDepth: 15, allowFunction: !1, ...scope.CHANNEL_OPTIONS });
...
var F = Object.create,
    ...
    v = (r, e, n) => (
        (n = r != null ? F(h(r)) : {}),
        E(e || !r || !r.__esModule ? u(n, 'default', { value: r, enumerable: !0 }) : n, r)
    ),
    x = I((T) => {
                        ...
                        switch (l.slice(8, -1)) {
                            ...
                            case 'Array':
                                ...
                                for (p = 0; p < o.length; p++)
                                    if ((p in o || p in s) && (p in o != p in s || !i(o[p], s[p], d))) return !1;
                                return !0;
                            case 'Object':
                                return i(e(o), e(s), d);
                            default:
...
function dequal2(foo, bar) {
    ...
    if (foo && bar && (ctor = foo.constructor) === bar.constructor) {
        ...
        if (ctor === Set) {
            if (foo.size !== bar.size) return !1;
            for (len of foo)
                if (((tmp = len), (tmp && typeof tmp == 'object' && ((tmp = find2(bar, tmp)), !tmp)) || !bar.has(tmp)))
                    return !1;
            return !0;
        }
        if (ctor === Map) {
...
var React33 = __toESM(require_react(), 1),
    ...
    PhotoIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
    ...
    ComponentIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    GridIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    OutlineIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    PhotoDragIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    GridAltIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    SearchIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ZoomIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ZoomOutIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
            ...
            React33.createElement('path', { d: 'M4 5.5a.5.5 0 000 1h4a.5.5 0 000-1H4z', fill: color2 }),
            React33.createElement('path', {
                fillRule: 'evenodd',
                clipRule: 'evenodd',
    ...
    ZoomResetIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    EyeIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
            ...
            React33.createElement('path', { d: 'M7 9.5a2.5 2.5 0 100-5 2.5 2.5 0 000 5z', fill: color2 }),
            React33.createElement('path', {
                fillRule: 'evenodd',
                clipRule: 'evenodd',
    ...
    EyeCloseIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    LightningIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    LightningOffIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ContrastIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    SwitchAltIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    MirrorIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    GrowIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    PaintBrushIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    RulerIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    StopIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CameraIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    VideoIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
            ...
            React33.createElement('path', { d: 'M2.5 10a.5.5 0 100-1 .5.5 0 000 1z', fill: color2 }),
            React33.createElement('path', {
                fillRule: 'evenodd',
                clipRule: 'evenodd',
    ...
    SpeakerIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    PlayIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    PlayBackIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    PlayNextIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    RewindIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    FastForwardIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    StopAltIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    SideBySideIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    StackedIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    SunIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
            ...
            React33.createElement(
                ...
                React33.createElement('path', { d: 'M7.5.5a.5.5 0 00-1 0V2a.5.5 0 001 0V.5z' }),
                React33.createElement('path', {
                    fillRule: 'evenodd',
                    clipRule: 'evenodd',
    ...
    MoonIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    BookIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    DocumentIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CopyIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CategoryIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    FolderIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    PrintIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    GraphLineIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CalendarIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    GraphBarIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    AlignLeftIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    AlignRightIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    FilterIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    DocChartIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    DocListIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    DragIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    MenuIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    MarkupIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    BoldIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ItalicIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
            ...
            React33.createElement('path', { d: 'M5 2h6v1H8.5l-2 8H9v1H3v-1h2.5l2-8H5V2z', fill: color2 }),
        ),
    ),
    PaperClipIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ListOrderedIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ListUnorderedIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ParagraphIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    MarkdownIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    RepoIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CommitIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    BranchIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    PullRequestIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    MergeIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    AppleIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    LinuxIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    UbuntuIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    WindowsIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ChromeIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    StorybookIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    AzureDevOpsIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    BitbucketIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ChromaticIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ComponentDrivenIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    DiscordIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    FacebookIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    FigmaIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    GDriveIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    GithubIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    GitlabIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    GoogleIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    GraphqlIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    MediumIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ReduxIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    TwitterIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    YoutubeIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    VSCodeIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    LinkedinIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    BrowserIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    TabletIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    MobileIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    WatchIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    SidebarIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    SidebarAltIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    SidebarAltToggleIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    SidebarToggleIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    BottomBarIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    BottomBarToggleIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CPUIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    DatabaseIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    MemoryIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    StructureIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    BoxIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    PowerIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
            ...
            React33.createElement('path', { d: 'M7.5.5a.5.5 0 00-1 0v6a.5.5 0 001 0v-6z', fill: color2 }),
            React33.createElement('path', {
    ...
    EditIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CogIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    NutIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    WrenchIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    EllipsisIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    WandIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CheckIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    FormIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    BatchDenyIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    BatchAcceptIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ControlsIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    PlusIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CloseAltIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CrossIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    TrashIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    PinAltIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    UnpinIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    AddIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    SubtractIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
            ...
            React33.createElement('path', { d: 'M3.5 6.5a.5.5 0 000 1h7a.5.5 0 000-1h-7z', fill: color2 }),
            React33.createElement('path', {
                fillRule: 'evenodd',
                clipRule: 'evenodd',
                d: 'M14 7A7 7 0 110 7a7 7 0 0114 0zm-1 0A6 6 0 111 7a6 6 0 0112 0z',
    ...
    CloseIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    DeleteIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    PassedIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ChangedIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    FailedIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ClearIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CommentIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CommentAddIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    RequestChangeIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CommentsIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ChatIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    LockIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    UnlockIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
            ...
            React33.createElement(
                ...
                React33.createElement('path', { d: 'M6.5 8.87a1 1 0 111 0v1.634a.5.5 0 01-1 0V8.87z' }),
                React33.createElement('path', {
                    fillRule: 'evenodd',
                    clipRule: 'evenodd',
    ...
    KeyIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
            ...
            React33.createElement('path', { d: 'M11 4a1 1 0 11-2 0 1 1 0 012 0z', fill: color2 }),
            React33.createElement('path', {
                fillRule: 'evenodd',
                clipRule: 'evenodd',
    ...
    OutboxIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CreditIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
            ...
            React33.createElement('path', { d: 'M2.5 8.004a.5.5 0 100 1h3a.5.5 0 000-1h-3z', fill: color2 }),
            React33.createElement('path', {
                fillRule: 'evenodd',
                clipRule: 'evenodd',
    ...
    ButtonIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    TypeIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    PointerDefaultIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    PointerHandIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CommandIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    InfoIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    QuestionIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    SupportIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    AlertIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    AlertAltIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    EmailIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    PhoneIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    LinkIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    LinkBrokenIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    BellIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    RSSIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ShareAltIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ShareIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    JumpToIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CircleHollowIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CircleIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
            ...
            React33.createElement('path', { d: 'M14 7A7 7 0 110 7a7 7 0 0114 0z', fill: color2 }),
        ),
    ),
    BookmarkHollowIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    BookmarkIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    DiamondIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    HeartHollowIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    HeartIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    StarHollowIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    StarIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CertificateIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    VerifiedIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ThumbsUpIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ShieldIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    BasketIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    BeakerIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    HourglassIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
            ...
            React33.createElement('path', { d: 'M7.5 10.5a.5.5 0 11-1 0 .5.5 0 011 0z', fill: color2 }),
            React33.createElement('path', {
                fillRule: 'evenodd',
                clipRule: 'evenodd',
    ...
    FlagIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CloudHollowIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CloudIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    StickerIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ChevronUpIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ChevronDownIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ChevronLeftIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ChevronRightIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ChevronSmallUpIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ChevronSmallDownIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ChevronSmallLeftIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ArrowUpIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ArrowDownIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ArrowLeftIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ArrowRightIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ArrowSolidUpIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ArrowSolidDownIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ArrowSolidLeftIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ArrowSolidRightIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ExpandAltIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CollapseIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ExpandIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    UnfoldIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    TransferIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    RedirectIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    UndoIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ReplyIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    SyncIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    UploadIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    DownloadIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    BackIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ProceedIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    RefreshIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    GlobeIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    CompassIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    LocationIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    PinIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    TimeIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    DashboardIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    TimerIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
            ...
            React33.createElement('path', { d: 'M7.5 4.5a.5.5 0 00-1 0v2.634a1 1 0 101 0V4.5z', fill: color2 }),
            React33.createElement('path', {
                fillRule: 'evenodd',
                clipRule: 'evenodd',
    ...
    HomeIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    AdminIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    DirectionIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    UserIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    UserAltIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    UserAddIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    UsersIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    ProfileIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    FaceHappyIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    FaceNeutralIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    FaceSadIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
    ...
    AccessibilityIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
            ...
            React33.createElement('path', { d: 'M7 4.5a1 1 0 100-2 1 1 0 000 2z', fill: color2 }),
            React33.createElement('path', {
                fillRule: 'evenodd',
                clipRule: 'evenodd',
                d: 'M7 14A7 7 0 107 0a7 7 0 000 14zm0-1A6 6 0 107 1a6 6 0 000 12z',
    ...
    AccessibilityAltIcon = React33.forwardRef(({ color: color2 = 'currentColor', size = 14, ...props }, forwardedRef) =>
        React33.createElement(
            'svg',
            {
                width: size,
...
var __create3 = Object.create,
    ...
    __export2 = (target, all) => {
        for (var name2 in all) __defProp3(target, name2, { get: all[name2], enumerable: !0 });
    },
        ...
        if ((from && typeof from == 'object') || typeof from == 'function')
            for (let key2 of __getOwnPropNames3(from))
                !__hasOwnProp3.call(to, key2) &&
                    ...
                    __defProp3(to, key2, {
                        get: () => from[key2],
                        enumerable: !(desc = __getOwnPropDesc3(from, key2)) || desc.enumerable,
                    });
        return to;
    },
        ...
        '../../node_modules/semver/internal/parse-options.js'(exports, module) {
            var looseOption = Object.freeze({ loose: !0 }),
                ...
                parseOptions = (options2) =>
                    options2 ? (typeof options2 != 'object' ? looseOption : options2) : emptyOpts;
            ...
            var debug = require_debug(),
                ...
                SemVer = class _SemVer {
                    constructor(version2, options2) {
                        if (((options2 = parseOptions(options2)), version2 instanceof _SemVer)) {
                            if (
                        ...
                        let m2 = version2.trim().match(options2.loose ? re[t.LOOSE] : re[t.FULL]);
    ...
    require_parse2 = __commonJS4({
        '../../node_modules/semver/functions/parse.js'(exports, module) {
            var SemVer = require_semver(),
                parse2 = (version2, options2, throwErrors = !1) => {
        ...
        '../../node_modules/semver/functions/valid.js'(exports, module) {
            var parse2 = require_parse2(),
                valid = (version2, options2) => {
                    let v2 = parse2(version2, options2);
        ...
        '../../node_modules/semver/functions/clean.js'(exports, module) {
            var parse2 = require_parse2(),
                clean = (version2, options2) => {
                    let s = parse2(version2.trim().replace(/^[=v]+/, ''), options2);
            ...
            var SemVer = require_semver(),
                inc = (version2, release, options2, identifier, identifierBase) => {
                    typeof options2 == 'string' &&
                        ((identifierBase = identifier), (identifier = options2), (options2 = void 0));
                    try {
                        return new SemVer(version2 instanceof SemVer ? version2.version : version2, options2).inc(
                            release,
                            identifier,
                            identifierBase,
                        ).version;
        ...
        '../../node_modules/semver/functions/prerelease.js'(exports, module) {
            var parse2 = require_parse2(),
                prerelease = (version2, options2) => {
                    let parsed = parse2(version2, options2);
    ...
    require_compare = __commonJS4({
        '../../node_modules/semver/functions/compare.js'(exports, module) {
            var SemVer = require_semver(),
                compare = (a, b, loose) => new SemVer(a, loose).compare(new SemVer(b, loose));
            ...
            var SemVer = require_semver(),
                ...
                coerce = (version2, options2) => {
                    ...
                    if (!options2.rtl)
                        ...
                        let coerceRtlRegex = options2.includePrerelease ? re[t.COERCERTLFULL] : re[t.COERCERTL],
                            next;
                        for (
                            ;
                    ...
                    let major = match[2],
                        minor = match[3] || '0',
                        patch = match[4] || '0',
                        prerelease = options2.includePrerelease && match[5] ? `-${match[5]}` : '',
                        build = options2.includePrerelease && match[6] ? `+${match[6]}` : '';
        ...
        '../../node_modules/yallist/yallist.js'(exports, module) {
            ...
            function Yallist(list) {
                ...
                if (
                    ...
                    for (var i = 0, l = arguments.length; i < l; i++) self2.push(arguments[i]);
                return self2;
            }
        ...
        '../../node_modules/lru-cache/index.js'(exports, module) {
            var Yallist = require_yallist(),
                ...
                LRUCache = class {
                    constructor(options2) {
                        if (
                            ...
                            options2 || (options2 = {}),
                            options2.max && (typeof options2.max != 'number' || options2.max < 0))
                        )
                    ...
                    dump() {
                        return this[LRU_LIST].map((hit) =>
                            isStale(this, hit) ? !1 : { k: hit.key, v: hit.value, e: hit.now + (hit.maxAge || 0) },
                        )
                            .toArray()
                            .filter((h2) => h2);
                    }
                    ...
                    set(key2, value2, maxAge) {
                        ...
                        if (this[CACHE].has(key2)) {
                            ...
                            return (
                                this[DISPOSE] && (this[NO_DISPOSE_ON_SET] || this[DISPOSE](key2, item.value)),
                                (item.now = now),
                                (item.maxAge = maxAge),
                                (item.value = value2),
                ...
                forEachStep = (self2, fn, node, thisp) => {
                    let hit = node.value;
                    isStale(self2, hit) && (del(self2, node), self2[ALLOW_STALE] || (hit = void 0)),
    ...
    require_range2 = __commonJS4({
        '../../node_modules/semver/classes/range.js'(exports, module) {
                ...
                parseRange(range) {
                    ...
                    loose &&
                        (rangeList = rangeList.filter(
                            (comp) => (
                                debug('loose invalid filter', comp, this.options), !!comp.match(re[t.COMPARATORLOOSE])
                            ),
                        )),
            ...
            var LRU = require_lru_cache(),
                ...
                { safeRe: re, t, comparatorTrimReplace, tildeTrimReplace, caretTrimReplace } = require_re(),
                    ...
                    return comp.replace(r, (_, M, m2, p, pr) => {
                        ...
                        return (
                            isX(M)
                                ...
                                : pr
                                ? (debug('replaceTilde pr', pr), (ret = `>=${M}.${m2}.${p}-${pr} <${M}.${+m2 + 1}.0-0`))
                        ...
                        return (
                            ...
                            xM
                                ...
                                ? (xm && (m2 = 0),
                                  ...
                                  gtlt === '>'
                                      ? ((gtlt = '>='),
                                        xm ? ((M = +M + 1), (m2 = 0), (p = 0)) : ((m2 = +m2 + 1), (p = 0)))
                                      : gtlt === '<=' && ((gtlt = '<'), xm ? (M = +M + 1) : (m2 = +m2 + 1)),
                                  gtlt === '<' && (pr = '-0'),
                                  (ret = `${gtlt + M}.${m2}.${p}${pr}`))
                                : xm
                ...
                replaceStars = (comp, options2) => (
                    debug('replaceStars', comp, options2), comp.trim().replace(re[t.STAR], '')
                ),
                replaceGTE0 = (comp, options2) => (
                    debug('replaceGTE0', comp, options2),
                    comp.trim().replace(re[options2.includePrerelease ? t.GTE0PRE : t.GTE0], '')
                ),
                ...
                testSet = (set2, version2, options2) => {
                    for (let i = 0; i < set2.length; i++) if (!set2[i].test(version2)) return !1;
                    if (version2.prerelease.length && !options2.includePrerelease) {
                        for (let i = 0; i < set2.length; i++)
                            if (
                                (debug(set2[i].semver),
                                set2[i].semver !== Comparator.ANY && set2[i].semver.prerelease.length > 0)
                            ) {
                ...
                Comparator = class _Comparator {
                    ...
                    parse(comp) {
                        ...
                        (this.operator = m2[1] !== void 0 ? m2[1] : ''),
                            ...
                            m2[2] ? (this.semver = new SemVer(m2[2], this.options.loose)) : (this.semver = ANY);
                    }
                    toString() {
                        return this.value;
                    }
            ...
            var SemVer = require_semver(),
                ...
                maxSatisfying = (versions, range, options2) => {
                    ...
                    return (
                        versions.forEach((v2) => {
                            rangeObj.test(v2) &&
                                (!max || maxSV.compare(v2) === -1) &&
                                ((max = v2), (maxSV = new SemVer(max, options2)));
                        }),
                        max
                    );
                };
            ...
            var SemVer = require_semver(),
                ...
                minSatisfying = (versions, range, options2) => {
                    ...
                    return (
                        versions.forEach((v2) => {
                            rangeObj.test(v2) &&
                                (!min || minSV.compare(v2) === 1) &&
                                ((min = v2), (minSV = new SemVer(min, options2)));
                        }),
                        min
                    );
                };
        ...
        '../../node_modules/semver/ranges/outside.js'(exports, module) {
            var SemVer = require_semver(),
                ...
                outside = (version2, range, hilo, options2) => {
                    (version2 = new SemVer(version2, options2)), (range = new Range(range, options2));
                            ...
                            (comparators.forEach((comparator) => {
                                comparator.semver === ANY && (comparator = new Comparator('>=0.0.0')),
                                    ...
                                    gtfn(comparator.semver, high.semver, options2)
                                        ? (high = comparator)
                                        : ltfn(comparator.semver, low.semver, options2) && (low = comparator);
                            }),
                            high.operator === comp ||
                                high.operator === ecomp ||
                                ((!low.operator || low.operator === comp) && ltefn(version2, low.semver)) ||
    ...
    require_gtr = __commonJS4({
        '../../node_modules/semver/ranges/gtr.js'(exports, module) {
            var outside = require_outside(),
                gtr = (version2, range, options2) => outside(version2, range, '>', options2);
            module.exports = gtr;
        },
    }),
    require_ltr = __commonJS4({
        '../../node_modules/semver/ranges/ltr.js'(exports, module) {
            var outside = require_outside(),
                ltr = (version2, range, options2) => outside(version2, range, '<', options2);
            module.exports = ltr;
        },
    }),
        ...
        '../../node_modules/semver/ranges/intersects.js'(exports, module) {
            var Range = require_range2(),
                intersects = (r1, r2, options2) => (
                    (r1 = new Range(r1, options2)), (r2 = new Range(r2, options2)), r1.intersects(r2, options2)
                );
        ...
        '../../node_modules/semver/ranges/simplify.js'(exports, module) {
            ...
            module.exports = (versions, range, options2) => {
                let set2 = [],
                    first = null,
                    prev = null,
                    v2 = versions.sort((a, b) => compare(a, b, options2));
                for (let version2 of v2)
                    satisfies(version2, range, options2)
            ...
            var Range = require_range2(),
                ...
                simpleSubset = (sub, dom, options2) => {
                    ...
                    if (sub.length === 1 && sub[0].semver === ANY) {
                        ...
                        options2.includePrerelease ? (sub = minimumVersionWithPreRelease) : (sub = minimumVersion);
                    }
                    ...
                    if (
                        ...
                        gtltComp > 0 || (gtltComp === 0 && (gt.operator !== '>=' || lt.operator !== '<=')))
                    )
                        return null;
                    for (let eq2 of eqSet) {
                        if (
                            ...
                            return null;
                        for (let c2 of dom) if (!satisfies(eq2, String(c2), options2)) return !1;
                        return !0;
                    }
                    let higher,
                        lower,
                        ...
                        hasDomGT,
                        needDomLTPre =
                            lt && !options2.includePrerelease && lt.semver.prerelease.length ? lt.semver : !1,
                        needDomGTPre =
                            gt && !options2.includePrerelease && gt.semver.prerelease.length ? gt.semver : !1;
                    needDomLTPre &&
                    ...
                    for (let c2 of dom) {
                        if (
                            ...
                            if (
                                ...
                                if (((higher = higherGT(gt, c2, options2)), higher === c2 && higher !== gt)) return !1;
                            } else if (gt.operator === '>=' && !satisfies(gt.semver, String(c2), options2)) return !1;
                        }
                        if (lt) {
                            if (
                                (needDomLTPre &&
                                ...
                                if (((lower = lowerLT(lt, c2, options2)), lower === c2 && lower !== lt)) return !1;
                            } else if (lt.operator === '<=' && !satisfies(lt.semver, String(c2), options2)) return !1;
                        }
    ...
    createContext2 = ({ api, state }) => (0, import_react2.createContext)({ api, state }),
    ...
    merge_default = (a, b) =>
        (0, import_mergeWith.default)({}, a, b, (objValue, srcValue) => {
            if (Array.isArray(srcValue) && Array.isArray(objValue))
                return (
                    srcValue.forEach((s) => {
                        objValue.find((o) => o === s || (0, import_isEqual.default)(o, s)) || objValue.push(s);
                    }),
                    objValue
                );
            if (Array.isArray(objValue)) return logger.log(['the types mismatch, picking', objValue]), objValue;
        }),
    main = (...additions) => additions.reduce((acc, item) => merge_default(acc, item), {}),
    initial_state_default = main,
    provider_exports = {};
__export2(provider_exports, { init: () => init });
var init = ({ provider, fullAPI }) => ({
    ...
    addons_exports = {};
__export2(addons_exports, { ensurePanel: () => ensurePanel, init: () => init2 });
...
var init2 = ({ provider, store: store2, fullAPI }) => {
        ...
        return {
            api,
            state: {
                selectedPanel: ensurePanel(api.getElements(Addon_TypesEnum.PANEL), store2.getState().selectedPanel),
                addons: {},
            },
        };
    },
    channel_exports = {};
__export2(channel_exports, { init: () => init3 });
var init3 = ({ provider }) => ({
        api: {
...
__export2(notifications_exports, { init: () => init4 });
var init4 = ({ store: store2 }) => {
        let api = {
            addNotification: (notification) => {
                api.clearNotification(notification.id);
                let { notifications } = store2.getState();
            ...
            clearNotification: (id) => {
                ...
                notification && notification.onClear && notification.onClear({ dismissed: !1 });
            },
        };
        return { api, state: { notifications: [] } };
    },
    settings_exports = {};
__export2(settings_exports, { init: () => init5 });
var init5 = ({ store: store2, navigate, fullAPI }) => ({
        ...
        api: {
            ...
            storeSelection: async () => {
                ...
                await store2.setState({ settings: { ...settings, lastTrackedStoryId: storyId } });
            },
        },
    }),
    stories_exports = {};
__export2(stories_exports, { init: () => init7 });
var refs_exports = {};
...
var TITLE_PATH_SEPARATOR = /\s*\/\s*/,
    denormalizeStoryParameters = ({ globalParameters, kindParameters, stories }) =>
    ...
    transformSetStoriesStoryDataToPreparedStoryIndex = (stories) => ({
        ...
        entries: Object.entries(stories).reduce((acc, [id, story]) => {
            ...
            let { docsOnly, fileName, ...parameters } = story.parameters,
                base = { title: story.kind, id, name: story.name, importPath: fileName };
            if (docsOnly) acc[id] = { type: 'docs', tags: ['stories-mdx'], storiesImports: [], ...base };
            else {
                let { argTypes, args: args2, initialArgs } = story;
                acc[id] = { type: 'story', ...base, parameters, argTypes, args: args2, initialArgs };
            }
            return acc;
        }, {}),
    }),
    ...
    transformStoryIndexV3toV4 = (index3) => {
        let countByTitle = (0, import_countBy.default)(Object.values(index3.stories), 'title');
        return {
            v: 4,
            entries: Object.values(index3.stories).reduce((acc, entry) => {
                let type = 'story';
                return (
                    (entry.parameters?.docsOnly || (entry.name === 'Page' && countByTitle[entry.title] === 1)) &&
                        (type = 'docs'),
                    (acc[entry.id] = {
                        type,
    ...
    transformStoryIndexToStoriesHash = (input, { provider, docsOptions, filters, status }) => {
        ...
        let entryValues = Object.values(index3.entries).filter((entry) => {
                ...
                return (
                    Object.values(filters).forEach((filter) => {
                        result2 !== !1 && (result2 = filter({ ...entry, status: status[entry.id] }));
                    }),
                    result2
                );
            }),
            ...
            storiesHashOutOfOrder = entryValues.reduce((acc, item) => {
                ...
                let { title } = item,
                    ...
                    root3 = (!setShowRoots || showRoots) && groups.length > 1 ? [groups.shift()] : [],
                    names = [...root3, ...groups],
                    paths = names.reduce((list, name2, idx) => {
                        let parent = idx > 0 && list[idx - 1],
                            id = k(parent ? `${parent}-${name2}` : name2);
                        if (parent === id)
                ...
                return (
                    paths.forEach((id, idx) => {
                        ...
                        root3.length && idx === 0
                            ...
                            : (!acc[id] || acc[id].type === 'component') && idx === paths.length - 1
                            ? (acc[id] = merge_default(acc[id] || {}, {
                                  type: 'component',
                                  id,
                                  name: names[idx],
        ...
        function addItem(acc, item) {
            return (
                acc[item.id] ||
                    ((acc[item.id] = item),
                    (item.type === 'root' || item.type === 'group' || item.type === 'component') &&
        ...
        oldHash
            ? Object.fromEntries(
                  Object.entries(newHash).map(([id, newEntry]) => {
                      ...
                      return newEntry.type === 'story' && oldEntry?.type === 'story' && oldEntry.prepared
    ...
    addRefIds = (input, ref) =>
        Object.entries(input).reduce((acc, [id, item]) => ({ ...acc, [id]: { ...item, refId: ref.id } }), {});
...
var parseUrl = (url) => {
        ...
        return (
            credentials && ((cleanUrl = url.replace(`${credentials}@`, '')), (authorization = btoa(`${credentials}`))),
    ...
    map = (input, ref, options2) => {
        ...
        return storyMapper
            ? Object.entries(input).reduce((acc, [id, item]) => ({ ...acc, [id]: storyMapper(ref, item) }), {})
            : input;
    },
    init6 = ({ store: store2, provider, singleStory, docsOptions = {} }, { runCheck = !0 } = {}) => {
        let api = {
                findRef: (source2) => {
                ...
                changeRefState: (id, previewInitialized) => {
                    ...
                    (updated[id] = { ...ref, previewInitialized }), store2.setState({ refs: updated });
                },
                checkRef: async (ref) => {
                    ...
                    urlParseResult.authorization &&
                        Object.assign(headers, { Authorization: `Basic ${urlParseResult.authorization}` });
                    let [indexResult, storiesResult] = await Promise.all(
                        ['index.json', 'stories.json'].map(async (file) =>
                            handleRequest(fetch(`${urlParseResult.url}/${file}${query}`, { headers, credentials })),
                        ),
                    );
          ...
          `,
                ...
                setRef: async (id, { storyIndex, setStoriesData, ...rest }, ready = !1) => {
                    ...
                    (storyIndex || setStoriesData) &&
                        ...
                        await api.updateRef(id, { ...ref, ...rest, index: index3, internal_index });
                },
    ...
    getEventMetadata = (context, fullAPI) => {
        ...
        let meta = { source: source2, sourceType, sourceLocation, refId, ref, type };
        switch (!0) {
            ...
            case sourceType === 'external':
                return meta;
            default:
                return logger.warn(`Received a ${type} frame that was not configured as a ref`), null;
        }
    },
    { fetch: fetch2 } = scope,
...
var init7 = ({
        ...
        let api = {
            ...
            getData: (storyId, refId) => {
                ...
                if (result2?.type === 'story' || result2?.type === 'docs') return result2;
            },
            ...
            getParameters: (storyIdOrCombo, parameterName) => {
                let { storyId, refId } =
                        typeof storyIdOrCombo == 'string' ? { storyId: storyIdOrCombo, refId: void 0 } : storyIdOrCombo,
            ...
            selectFirstStory: () => {
                ...
                if (!index3) return;
                let firstStory = Object.keys(index3).find((id) => index3[id].type === 'story');
                if (firstStory) {
            ...
            selectStory: (titleOrId = void 0, name2 = void 0, options2 = {}) => {
                ...
                if (hash)
                    if (name2)
                        if (titleOrId) {
                            let id = ref ? `${ref}_${N(titleOrId, name2)}` : N(titleOrId, name2);
                            if (hash[id]) api.selectStory(id, void 0, options2);
                            else {
                                let entry = hash[k(titleOrId)];
                                if (entry?.type === 'component') {
                                    let foundId = entry.children.find((childId) => hash[childId].name === name2);
                        ...
                        let entry = titleOrId ? hash[titleOrId] || hash[k(titleOrId)] : hash[kindSlug];
                        if (!entry) throw new Error(`Unknown id or title: '${titleOrId}'`);
                        store2.setState({ settings: { ...store2.getState().settings, lastTrackedStoryId: entry.id } });
                        let leafEntry = api.findLeafEntry(hash, entry.id),
                            fullId = leafEntry.refId ? `${leafEntry.refId}_${leafEntry.id}` : leafEntry.id;
            ...
            findSiblingStoryId(storyId, index3, direction, toSiblingGroup) {
                if (toSiblingGroup) {
                    ...
                    return (position2 === lookupList2.length - 1 && direction > 0) || (position2 === 0 && direction < 0)
                        ? void 0
            ...
            updateStoryArgs: (story, updatedArgs) => {
                ...
                provider.channel?.emit(UPDATE_STORY_ARGS, { storyId, updatedArgs, options: { target: refId } });
            },
            resetStoryArgs: (story, argNames) => {
                let { id: storyId, refId } = story;
                provider.channel?.emit(RESET_STORY_ARGS, { storyId, argNames, options: { target: refId } });
            },
            fetchIndex: async () => {
                try {
            ...
            setIndex: async (input) => {
                let { index: oldHash, status, filters } = store2.getState(),
                    newHash = transformStoryIndexToStoriesHash(input, { provider, docsOptions, status, filters }),
            ...
            updateStory: async (storyId, update2, ref) => {
                if (ref) {
                    ...
                    let { index: index3 } = store2.getState();
                    if (!index3) return;
                    (index3[storyId] = { ...index3[storyId], ...update2 }), await store2.setState({ index: index3 });
                }
            },
            updateDocs: async (docsId, update2, ref) => {
                if (ref) {
                    ...
                    let { index: index3 } = store2.getState();
                    if (!index3) return;
                    (index3[docsId] = { ...index3[docsId], ...update2 }), await store2.setState({ index: index3 });
                }
            },
                ...
                if (
                    ...
                    (Object.entries(update2).forEach(([storyId, value2]) => {
                        (newStatus[storyId] = { ...(newStatus[storyId] || {}) }),
                            value2 === null ? delete newStatus[storyId][id] : (newStatus[storyId][id] = value2),
                            Object.keys(newStatus[storyId]).length === 0 && delete newStatus[storyId];
                    }),
            ...
            experimental_setFilter: async (id, filterFunction) => {
                ...
                if (
                    (await store2.setState({ filters: { ...store2.getState().filters, [id]: filterFunction } }), index3)
                ) {
                    await api.setIndex(index3);
                    let refs2 = await fullAPI.getRefs();
                    Object.entries(refs2).forEach(([refId, { internal_index, ...ref }]) => {
        ...
        provider.channel?.on(STORY_SPECIFIED, function ({ storyId, viewMode }) {
            ...
            provider.channel?.on(STORY_PREPARED, function ({ id, ...update2 }) {
                ...
                if (
                    ...
                    fullAPI.setOptions(removeRemovedOptions(options2)), store2.setState({ hasCalledSetOptions: !0 });
                }
                if (sourceType === 'local') {
                    ...
                    provider.channel?.emit(PRELOAD_ENTRIES, { ids: toBePreloaded, options: { target: refId } });
                }
            }),
            ...
            provider.channel?.on(
                SELECT_STORY,
                function ({ kind, title = kind, story, name: name2 = story, storyId, ...rest }) {
                    let { ref } = getEventMetadata(this, fullAPI);
                    ref
            ...
            provider.channel?.on(STORY_ARGS_UPDATED, function ({ storyId, args: args2 }) {
                let { ref } = getEventMetadata(this, fullAPI);
            ...
            provider.channel?.on(SET_CONFIG, () => {
                ...
                config2?.sidebar?.filters &&
                    store2.setState({ filters: { ...store2.getState().filters, ...config2?.sidebar?.filters } });
            });
...
var { document: document3 } = scope,
    ...
    defaultLayoutState = {
        ...
        layout: {
            ...
            rightPanelWidth: 400,
            recentVisibleSizes: { navSize: 300, bottomPanelHeight: 300, rightPanelWidth: 400 },
    ...
    getIsPanelShown = (state) => {
        ...
        return (
            (panelPosition === 'bottom' && bottomPanelHeight > 0) || (panelPosition === 'right' && rightPanelWidth > 0)
        );
    },
    ...
    init8 = ({ store: store2, provider, singleStory }) => {
        let api = {
                    ...
                    return store2.setState(
                        (state) => {
                            ...
                            return shouldShowNav === isNavShown
                                ? { layout: state.layout }
                                : shouldShowNav
                                ? { layout: { ...state.layout, navSize: state.layout.recentVisibleSizes.navSize } }
                                : {
                                      layout: {
                                          ...state.layout,
                                          navSize: 0,
                ...
                toggleToolbar(toggled) {
                    return store2.setState(
                        (state) => {
                            let value2 = typeof toggled < 'u' ? toggled : !state.layout.showToolbar;
                ...
                setOptions: (options2) => {
                    ...
                    let updatedLayout = {
                        ...
                        updatedUi = { ...ui, ...options2.ui, ...(0, import_pick.default)(options2, Object.keys(ui)) },
                        updatedTheme = { ...theme, ...options2.theme },
                        modification = {};
                    dequal2(ui, updatedUi) || (modification.ui = updatedUi),
                        dequal2(layout, updatedLayout) || (modification.layout = updatedLayout),
                        options2.selectedPanel &&
                            !dequal2(selectedPanel, options2.selectedPanel) &&
                            (modification.selectedPanel = options2.selectedPanel),
                        Object.keys(modification).length && store2.setState(modification, { persistence: 'permanent' }),
                        dequal2(theme, updatedTheme) || store2.setState({ theme: updatedTheme });
                },
            },
            persisted = (0, import_pick.default)(store2.getState(), 'layout', 'selectedPanel');
        return (
            provider.channel?.on(SET_CONFIG, () => {
...
var { navigator } = scope,
    isMacLike = () => (navigator && navigator.platform ? !!navigator.platform.match(/(Mac|iPhone|iPod|iPad)/i) : !1),
    ...
    eventToShortcut = (e) => {
        ...
        if (
            ...
            code && code.length === 1 && code !== key2 ? keys2.push([key2, code]) : keys2.push(key2);
        }
        return (
    ...
    shortcutMatchesShortcut = (inputShortcut, shortcut) =>
        !inputShortcut ||
        !shortcut ||
        (inputShortcut.join('').startsWith('shift/') && inputShortcut.shift(), inputShortcut.length !== shortcut.length)
            ? !1
    ...
    keyToSymbol = (key2) =>
        key2 === 'alt'
            ...
            : key2 === 'shift'
            ? '\u21E7\u200B'
            : key2 === 'Enter' || key2 === 'Backspace' || key2 === 'Esc' || key2 === 'escape'
            ? ''
            : key2 === ' '
            ? 'SPACE'
            : key2 === 'ArrowUp'
    ...
    isMacLike2 = () =>
        navigator2 && navigator2.platform ? !!navigator2.platform.match(/(Mac|iPhone|iPod|iPad)/i) : !1,
...
var init9 = ({ store: store2, fullAPI, provider }) => {
        let api = {
                ...
                async setShortcut(action, value2) {
                    ...
                    return await api.setShortcuts({ ...shortcuts, [action]: value2 }), value2;
                },
                ...
                handleShortcutFeature(feature, event) {
                    ...
                    if (enableShortcuts)
                        switch ((event?.preventDefault && event.preventDefault(), feature)) {
                            ...
                            case 'focusIframe': {
                                let element = document23.getElementById('storybook-preview-iframe');
                                if (element)
                                    try {
    ...
    url_exports = {};
__export2(url_exports, { init: () => init10 });
var { window: globalWindow } = scope,
    ...
    prevParams,
    initialUrlSupport = ({ state: { location: location22, path, viewMode, storyId: storyIdFromUrl }, singleStory }) => {
        let {
                full,
                panel,
                nav,
        ...
        parseBoolean(full) === !0
            ...
            singleStory ||
                (parseBoolean(nav) === !0 && (navSize = defaultLayoutState.layout.navSize),
                parseBoolean(nav) === !1 && (navSize = 0)),
            parseBoolean(panel) === !1 && ((bottomPanelHeight = 0), (rightPanelWidth = 0));
        let layout = {
                navSize,
                bottomPanelHeight,
                rightPanelWidth,
            ...
            customQueryParams = dequal2(prevParams, otherParams) ? prevParams : otherParams;
        return (
            (prevParams = customQueryParams),
            { viewMode, layout, ui, selectedPanel, location: location22, path, customQueryParams, storyId }
        );
    },
    init10 = (moduleArgs) => {
        let { store: store2, navigate, provider, fullAPI } = moduleArgs,
            ...
            api = {
                ...
                getUrlState() {
                    let { path, customQueryParams, storyId, url, viewMode } = store2.getState();
                    ...
                    let { customQueryParams } = store2.getState(),
                        ...
                        update2 = {
                            ...
                            ...Object.entries(input).reduce(
                                (acc, [key2, value2]) => (value2 !== null && (acc[key2] = value2), acc),
                                queryParams,
                            ),
                        };
                ...
                applyQueryParams(input) {
                    ...
                    navigateTo(path, { ...queryParams, ...input }), api.setQueryParams(input);
                },
        ...
        return (
            ...
            provider.channel?.on(GLOBALS_UPDATED, ({ globals, initialGlobals }) => {
                ...
                navigateTo(path, { ...queryParams, globals: globalsString }, { replace: !0 }),
...
var import_semver = __toESM4(require_semver2()),
    ...
    init11 = ({ store: store2 }) => {
        let { dismissedVersionNotification } = store2.getState(),
            state = { versions: { current: { version }, ...getVersionCheckData() }, dismissedVersionNotification },
            api = {
                getCurrentVersion: () => {
                    let {
                        versions: { current },
                ...
                getLatestVersion: () => {
                    ...
                    return current && import_semver.default.prerelease(current.version) && next
                ...
                getDocsUrl: ({ subpath, versioned, renderer }) => {
                    ...
                    if (versioned && current?.version && latest?.version) {
                        ...
                        versionDiff === 'patch' ||
                            versionDiff === null ||
                            (url += `${import_semver.default.major(current.version)}.${import_semver.default.minor(
                                current.version,
                            )}/`);
                    }
                    if ((subpath && (url += `${subpath}/`), renderer && typeof scope.STORYBOOK_RENDERER < 'u')) {
                        let rendererName = scope.STORYBOOK_RENDERER.split('/').pop()?.toLowerCase();
                ...
                versionUpdateAvailable: () => {
                    ...
                    if (latest) {
                        ...
                        let actualCurrent = import_semver.default.prerelease(current.version)
                                ? `${import_semver.default.major(current.version)}.${import_semver.default.minor(
                                      current.version,
    ...
    whatsnew_exports = {};
__export2(whatsnew_exports, { init: () => init12 });
var WHATS_NEW_NOTIFICATION_ID = 'whats-new',
    init12 = ({ fullAPI, store: store2, provider }) => {
        ...
        function getLatestWhatsNewPost() {
            return (
                ...
                new Promise((resolve) => provider.channel?.once(RESULT_WHATS_NEW_DATA, ({ data }) => resolve(data)))
            );
        }
            ...
            init: async () => {
                ...
                !(urlState?.path === '/onboarding' || urlState.queryParams?.onboarding === 'true') &&
                    ...
                    fullAPI.addNotification({
                        ...
                        content: { headline: whatsNewData.title, subHeadline: "Learn what's new in Storybook" },
    ...
    globals_exports = {};
__export2(globals_exports, { init: () => init13 });
        ...
        constructor() {
            (this.loaders = {}),
                ...
                (this.register = (id, callback) => {
                    this.loaders[id] && logger.warn(`${id} was loaded twice, this could have bad side-effects`),
...
var addons = getAddonsStore(),
    ...
    ManagerContext = createContext2({ api: void 0, state: initial_state_default({}) }),
    combineParameters = (...parameterSets) =>
        (0, import_mergeWith.default)({}, ...parameterSets, (objValue, srcValue) => {
    ...
    ManagerProvider = class extends import_react2.Component {
        constructor(props) {
            ...
            let {
                ...
                routeData = { location: location22, path, viewMode, singleStory, storyId, refId },
            ...
            this.modules = [
                ...
                versions_exports,
                whatsnew_exports,
            ].map((m2) => m2.init({ ...routeData, ...optionsData, ...apiData, state: this.state, fullAPI: this.api }));
            let state = initial_state_default(this.state, ...this.modules.map((m2) => m2.state)),
                api = Object.assign(this.api, { navigate }, ...this.modules.map((m2) => m2.api));
...
var EffectOnMount = ({ children, effect }) => (import_react2.default.useEffect(effect, []), children),
    defaultFilter = (c2) => c2;
function ManagerConsumer({ filter = defaultFilter, children }) {
    ...
    if (typeof renderer.current != 'function')
        return import_react2.default.createElement(import_react2.Fragment, null, renderer.current);
    let comboData = filterer.current(managerContext),
        comboDataArray = (0, import_react2.useMemo)(
            () => [...Object.entries(comboData).reduce((acc, keyval) => acc.concat(keyval), [])],
...
function useStorybookState() {
    ...
    return {
        ...state,
        get storiesHash() {
            return deprecate('state.storiesHash is deprecated, please use state.index'), this.index || {};
        },
        ...
        get storiesFailed() {
            return deprecate('state.storiesFailed is deprecated, please use state.indexError'), this.indexError;
        },
    };
}
...
function useArgs() {
    let { getCurrentStoryData, updateStoryArgs, resetStoryArgs } = useStorybookApi(),
...
function _construct(Parent, args2, Class) {
    return (
        _isNativeReflectConstruct()
            ...
            : (_construct = function (Parent2, args22, Class2) {
                  var a = [null];
        ...
        (_wrapNativeSuper = function (Class2) {
            ...
            return (
                (Wrapper4.prototype = Object.create(Class2.prototype, {
                    constructor: { value: Wrapper4, enumerable: !1, writable: !0, configurable: !0 },
                })),
...
var PolishedError = (function (_Error) {
    ...
    function PolishedError2(code) {
        for (
            var _this, _len2 = arguments.length, args2 = new Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1;
            _key2 < _len2;
            _key2++
        )
...
var reduceHexValue = function (value2) {
        return value2.length === 7 && value2[1] === value2[2] && value2[3] === value2[4] && value2[5] === value2[6]
...
function hsla(value2, saturation, lightness, alpha) {
    ...
    if (typeof value2 == 'object' && saturation === void 0 && lightness === void 0 && alpha === void 0)
        return value2.alpha >= 1
            ...
            : 'rgba(' + hslToRgb(value2.hue, value2.saturation, value2.lightness) + ',' + value2.alpha + ')';
...
var curriedTransparentize = curry(transparentize),
    ...
    Code = ({ className, children, ...props }) => {
        ...
        return childrenArray.filter(isReactChildString).some((child) => child.match(isInlineCodeRegex))
            ? import_react3.default.createElement(
                  StyledSyntaxHighlighter,
                  { bordered: !0, copyable: !0, language: language?.[1] ?? 'text', format: !1, ...props },
                  children,
              )
            : import_react3.default.createElement(DefaultCodeBlock, { ...props, className }, childrenArray);
    },
    ...
    H3 = newStyled.h3(withReset, headerCommon, ({ theme }) => ({ fontSize: `${theme.typography.size.m1}px` })),
    H4 = newStyled.h4(withReset, headerCommon, ({ theme }) => ({ fontSize: `${theme.typography.size.s3}px` })),
    H5 = newStyled.h5(withReset, headerCommon, ({ theme }) => ({ fontSize: `${theme.typography.size.s2}px` })),
    ...
    OL = newStyled.ol(withReset, withMargin, listCommon, { listStyle: 'decimal' }),
    ...
    listCommon2 = { paddingLeft: 30, '& :first-of-type': { marginTop: 0 }, '& :last-child': { marginBottom: 0 } },
    UL = newStyled.ul(withReset, withMargin, listCommon2, { listStyle: 'disc' }),
    ResetWrapper = newStyled.div(withReset),
    components = {
        h1: (props) => import_react3.default.createElement(H1, { ...nameSpaceClassNames(props, 'h1') }),
        h2: (props) => import_react3.default.createElement(H2, { ...nameSpaceClassNames(props, 'h2') }),
        h3: (props) => import_react3.default.createElement(H3, { ...nameSpaceClassNames(props, 'h3') }),
        h4: (props) => import_react3.default.createElement(H4, { ...nameSpaceClassNames(props, 'h4') }),
        h5: (props) => import_react3.default.createElement(H5, { ...nameSpaceClassNames(props, 'h5') }),
        h6: (props) => import_react3.default.createElement(H6, { ...nameSpaceClassNames(props, 'h6') }),
        pre: (props) => import_react3.default.createElement(Pre, { ...nameSpaceClassNames(props, 'pre') }),
        a: (props) => import_react3.default.createElement(A, { ...nameSpaceClassNames(props, 'a') }),
        hr: (props) => import_react3.default.createElement(HR, { ...nameSpaceClassNames(props, 'hr') }),
        dl: (props) => import_react3.default.createElement(DL, { ...nameSpaceClassNames(props, 'dl') }),
        blockquote: (props) =>
            import_react3.default.createElement(Blockquote, { ...nameSpaceClassNames(props, 'blockquote') }),
        table: (props) => import_react3.default.createElement(Table, { ...nameSpaceClassNames(props, 'table') }),
        img: (props) => import_react3.default.createElement(Img, { ...nameSpaceClassNames(props, 'img') }),
        div: (props) => import_react3.default.createElement(Div, { ...nameSpaceClassNames(props, 'div') }),
        span: (props) => import_react3.default.createElement(Span, { ...nameSpaceClassNames(props, 'span') }),
        li: (props) => import_react3.default.createElement(LI, { ...nameSpaceClassNames(props, 'li') }),
        ul: (props) => import_react3.default.createElement(UL, { ...nameSpaceClassNames(props, 'ul') }),
        ol: (props) => import_react3.default.createElement(OL, { ...nameSpaceClassNames(props, 'ol') }),
        p: (props) => import_react3.default.createElement(P, { ...nameSpaceClassNames(props, 'p') }),
        code: (props) => import_react3.default.createElement(Code, { ...nameSpaceClassNames(props, 'code') }),
        tt: (props) => import_react3.default.createElement(TT, { ...nameSpaceClassNames(props, 'tt') }),
        resetwrapper: (props) =>
            import_react3.default.createElement(ResetWrapper, { ...nameSpaceClassNames(props, 'resetwrapper') }),
    },
    ...
    Badge = ({ ...props }) => import_react3.default.createElement(BadgeWrapper, { ...props }),
    LEFT_BUTTON = 0,
    isPlainLeftClick = (e) => e.button === LEFT_BUTTON && !e.altKey && !e.ctrlKey && !e.metaKey && !e.shiftKey,
    cancelled = (e, cb) => {
    ...
    A2 = newStyled.a(
        ({ theme }) => ({
            ...
            '&:hover, &:focus': {
                ...
                'svg path:not([fill])': { fill: curriedDarken$1(0.07, theme.color.secondary) },
            },
            '&:active': {
                color: curriedDarken$1(0.1, theme.color.secondary),
                'svg path:not([fill])': { fill: curriedDarken$1(0.1, theme.color.secondary) },
            },
            svg: {
                display: 'inline-block',
                height: '1em',
        ...
        ({ theme, secondary, tertiary }) => {
            let colors;
            return (
                secondary && (colors = [theme.textMutedColor, theme.color.dark, theme.color.darker]),
                tertiary && (colors = [theme.color.dark, theme.color.darkest, theme.textMutedColor]),
                colors
                    ? {
                          color: colors[0],
                          'svg path:not([fill])': { fill: colors[0] },
                          '&:hover': { color: colors[1], 'svg path:not([fill])': { fill: colors[1] } },
                          '&:active': { color: colors[2], 'svg path:not([fill])': { fill: colors[2] } },
                      }
                    : {}
            );
        },
        ...
        ({ theme, inverse }) =>
            inverse
                ? {
                      ...
                      '&:hover': { color: theme.color.lighter, 'svg path:not([fill])': { fill: theme.color.lighter } },
                      '&:active': { color: theme.color.light, 'svg path:not([fill])': { fill: theme.color.light } },
                  }
                : {},
        ({ isButton: isButton2 }) =>
            isButton2 ? { border: 0, borderRadius: 0, background: 'none', padding: 0, fontSize: 'inherit' } : {},
    ),
    Link22 = ({
        cancel = !0,
        children,
        ...
        import_react3.default.createElement(
            ...
            import_react3.default.createElement(
                ...
                children,
                withArrow && import_react3.default.createElement(ChevronRightIcon, null),
            ),
        ),
    DocumentWrapper = newStyled.div(({ theme }) => ({
        fontSize: `${theme.typography.size.s2}px`,
        lineHeight: '1.6',
        h1: { fontSize: `${theme.typography.size.l1}px`, fontWeight: theme.typography.weight.bold },
        h2: { fontSize: `${theme.typography.size.m2}px`, borderBottom: `1px solid ${theme.appBorderColor}` },
        ...
        hr: { border: '0 none', borderTop: `1px solid ${theme.appBorderColor}`, height: 4, padding: 0 },
    ...
    languages = [],
    Comp = null,
    LazySyntaxHighlighter = (0, import_react3.lazy)(async () => {
        let { SyntaxHighlighter: SyntaxHighlighter3 } = await import('./syntaxhighlighter-JOJW2KGS-VF6EEVPI.js');
        return (
            languages.length > 0 &&
            ...
            { default: (props) => import_react3.default.createElement(SyntaxHighlighter3, { ...props }) }
        );
    }),
    LazySyntaxHighlighterWithFormatter = (0, import_react3.lazy)(async () => {
        let [{ SyntaxHighlighter: SyntaxHighlighter3 }, { formatter }] = await Promise.all([
            import('./syntaxhighlighter-JOJW2KGS-VF6EEVPI.js'),
            import('./formatter-B5HCVTEV-7DCBOGO6.js'),
        ]);
        return (
            languages.length > 0 &&
                (languages.forEach((args2) => {
                ...
                (languages = [])),
            Comp === null && (Comp = SyntaxHighlighter3),
            { default: (props) => import_react3.default.createElement(SyntaxHighlighter3, { ...props, formatter }) }
        );
    }),
    SyntaxHighlighter22 = (props) =>
        import_react3.default.createElement(
            import_react3.Suspense,
            { fallback: import_react3.default.createElement('div', null) },
            props.format !== !1
                ? import_react3.default.createElement(LazySyntaxHighlighterWithFormatter, { ...props })
                : import_react3.default.createElement(LazySyntaxHighlighter, { ...props }),
        );
...
var toNumber = (input) => (typeof input == 'number' ? input : Number(input)),
    ...
    Spaced = ({ col, row, outer, children, ...rest }) => {
        ...
        return import_react3.default.createElement(Container, { col, row, outer: outerAmount, ...rest }, children);
    },
    Title = newStyled.div(({ theme }) => ({ fontWeight: theme.typography.weight.bold })),
    Desc = newStyled.div(),
    ...
    Placeholder = ({ children, ...props }) => {
        let [title, desc] = import_react3.Children.toArray(children);
        return import_react3.default.createElement(
            Message,
            { ...props },
            import_react3.default.createElement(Title, null, title),
            desc && import_react3.default.createElement(Desc, null, desc),
        );
    };
function useResolvedElement(subscriber, refOrElement) {
    var lastReportRef = (0, import_react3.useRef)(null),
        refOrElementRef = (0, import_react3.useRef)(null);
    refOrElementRef.current = refOrElement;
    var cbElementRef = (0, import_react3.useRef)(null);
    (0, import_react3.useEffect)(function () {
        evaluateSubscription();
    });
    var evaluateSubscription = (0, import_react3.useCallback)(
        function () {
            var cbElement = cbElementRef.current,
                refOrElement2 = refOrElementRef.current,
                element =
                    cbElement ||
                    (refOrElement2 ? (refOrElement2 instanceof Element ? refOrElement2 : refOrElement2.current) : null);
            (lastReportRef.current &&
                lastReportRef.current.element === element &&
                lastReportRef.current.subscriber === subscriber) ||
                (lastReportRef.current && lastReportRef.current.cleanup && lastReportRef.current.cleanup(),
                (lastReportRef.current = { element, subscriber, cleanup: element ? subscriber(element) : void 0 }));
        },
        [subscriber],
    );
    return (
...
function useResizeObserver(opts) {
    ...
    var onResize = opts.onResize,
        onResizeRef = (0, import_react3.useRef)(void 0);
    onResizeRef.current = onResize;
    var round = opts.round || Math.round,
        resizeObserverRef = (0, import_react3.useRef)(),
        _useState = (0, import_react3.useState)({ width: void 0, height: void 0 }),
        size = _useState[0],
        setSize = _useState[1],
        didUnmount = (0, import_react3.useRef)(!1);
    (0, import_react3.useEffect)(function () {
        return (
    ...
    var previous = (0, import_react3.useRef)({ width: void 0, height: void 0 }),
...
function ZoomElement({ scale, children }) {
    let componentWrapperRef = (0, import_react3.useRef)(null),
        [elementHeight, setElementHeight] = (0, import_react3.useState)(0),
        onResize = (0, import_react3.useCallback)(
            ({ height }) => {
...
var ZoomIFrame = class extends import_react3.Component {
    ...
    ErrorImportant = newStyled.strong(({ theme }) => ({ color: theme.color.ancillary, textDecoration: 'underline' })),
...
${input}`);
        ...
        if (!match) return import_react3.default.createElement(import_react3.Fragment, null, input);
        let [, type, name2] = match,
            rawLines = input.split(/\n/).slice(1),
            [, ...lines] = rawLines
                .map((line) => {
                    let result2 =
                        line.match(linesRegexChromium) || line.match(linesRegexFirefox) || line.match(linesRegexSafari);
                    return result2
                        ? {
        ...
        return import_react3.default.createElement(
            import_react3.Fragment,
            null,
            import_react3.default.createElement('span', null, type),
            ': ',
            import_react3.default.createElement(ErrorName, null, name2),
            ...
            lines.map((l, i) =>
                l.name
                    ? import_react3.default.createElement(
                          ...
                          '  ',
                          'at ',
                          import_react3.default.createElement(ErrorImportant, null, l.name),
                          ' (',
                          import_react3.default.createElement(ErrorDetail, null, l.location),
                          ')',
                          import_react3.default.createElement('br', null),
                      )
                    : import_react3.default.createElement(
    ...
    Button = (0, import_react3.forwardRef)(
        (
            ...
            let Comp2 = 'button';
            props.isLink && (Comp2 = 'a'), asChild && (Comp2 = $5e63c961fc1ce211$export$8c6ed5c666ac1360);
            let localVariant = variant,
                localSize = size,
                [isAnimating, setIsAnimating] = (0, import_react3.useState)(!1),
                handleClick = (event) => {
            ...
            if (
                ...
                (props.secondary || props.tertiary || props.gray || props.outline || props.inForm) &&
                ...
                let buttonContent = import_react3.default.Children.toArray(props.children).filter(
                    (e) => typeof e == 'string' && e !== '',
                );
                deprecate(
            ...
            return import_react3.default.createElement(StyledButton, {
                as: Comp2,
                ref,
...
var StyledButton = newStyled('button', { shouldForwardProp: (prop) => isPropValid(prop) })(
        ({ theme, variant, size, disabled, active, animating, animation, padding }) => ({
            ...
            ...(variant === 'ghost'
                ? {
                      '.sb-bar &': {
                          background: active ? curriedTransparentize$1(0.9, theme.barTextColor) : 'transparent',
                          ...
                          '&:focus': { boxShadow: `${rgba(theme.barHoverColor, 1)} 0 0 0 1px inset`, outline: 'none' },
                      },
                  }
                : {}),
            color:
    ...
    IconButton = (0, import_react3.forwardRef)(({ padding = 'small', variant = 'ghost', ...props }, ref) =>
        import_react3.default.createElement(Button, { padding, variant, ref, ...props }),
    );
        ...
        import_react3.default.createElement(
            ...
            label
                ? import_react3.default.createElement(
                      Label,
                      null,
                      import_react3.default.createElement('span', null, label),
                  )
                : null,
            children,
        );
...
function calculateNodeHeight(sizingData, value2, minRows, maxRows) {
    ...
    boxSizing === 'border-box' && (minHeight = minHeight + paddingSize + borderSize),
        (height = Math.max(minHeight, height));
    var maxHeight = rowHeight * maxRows;
    return (
        boxSizing === 'border-box' && (maxHeight = maxHeight + paddingSize + borderSize),
...
var useWindowResizeListener = function (listener) {
    ...
    _excluded3 = ['cacheMeasurements', 'maxRows', 'minRows', 'onChange', 'onHeightChange'],
    TextareaAutosize = function (_ref, userRef) {
        var cacheMeasurements = _ref.cacheMeasurements,
            ...
            libRef = React3.useRef(null),
            ref = use_composed_ref_esm_default(libRef, userRef),
            heightRef = React3.useRef(0),
            measurementsCacheRef = React3.useRef(),
        ...
        return (
            ...
            React3.createElement('textarea', _extends({}, props, { onChange: handleChange, ref }))
        );
    },
    index2 = React3.forwardRef(TextareaAutosize),
    styleResets = {
        appearance: 'none',
        border: '0 none',
        boxSizing: 'inherit',
    ...
    styles = ({ theme }) => ({
        ...
        '&:focus': { boxShadow: `${theme.color.secondary} 0 0 0 1px inset`, outline: 'none' },
    ...
    Input = Object.assign(
        newStyled(
            (0, import_react3.forwardRef)(function ({ size, valid, align, ...props }, ref) {
                return import_react3.default.createElement('input', { ...props, ref });
            }),
    ...
    Select = Object.assign(
        newStyled(
            (0, import_react3.forwardRef)(function ({ size, valid, align, ...props }, ref) {
                return import_react3.default.createElement('select', { ...props, ref });
            }),
    ...
    Textarea = Object.assign(
        newStyled(
            (0, import_react3.forwardRef)(function ({ size, valid, align, ...props }, ref) {
                return import_react3.default.createElement(index2, { ...props, ref });
            }),
        )(styles, sizes, alignment, validation, ({ height = 400 }) => ({ overflow: 'visible', maxHeight: height })),
        { displayName: 'Textarea' },
    ),
    Form = Object.assign(newStyled.form({ boxSizing: 'border-box', width: '100%' }), {
        Field,
        Input,
        Select,
        Textarea,
    ...
    LazyWithTooltip = (0, import_react3.lazy)(() =>
        import('./WithTooltip-Y7J54OF7-CEHQ77YF.js').then((mod) => ({ default: mod.WithTooltip })),
    ),
    WithTooltip = (props) =>
        import_react3.default.createElement(
            import_react3.Suspense,
            { fallback: import_react3.default.createElement('div', null) },
            import_react3.default.createElement(LazyWithTooltip, { ...props }),
        ),
    LazyWithTooltipPure = (0, import_react3.lazy)(() =>
        import('./WithTooltip-Y7J54OF7-CEHQ77YF.js').then((mod) => ({ default: mod.WithTooltipPure })),
    ),
    WithTooltipPure = (props) =>
        import_react3.default.createElement(
            import_react3.Suspense,
            { fallback: import_react3.default.createElement('div', null) },
            import_react3.default.createElement(LazyWithTooltipPure, { ...props }),
        ),
    Title2 = newStyled.div(({ theme }) => ({ fontWeight: theme.typography.weight.bold })),
    ...
    Message2 = newStyled.div(({ theme }) => ({ color: theme.color.defaultText, lineHeight: '18px' })),
    MessageWrapper = newStyled.div({ padding: 15, width: 280, boxSizing: 'border-box' }),
    TooltipMessage = ({ title, desc, links }) =>
        import_react3.default.createElement(
            ...
            import_react3.default.createElement(
                Message2,
                null,
                title && import_react3.default.createElement(Title2, null, title),
                desc && import_react3.default.createElement(Desc2, null, desc),
            ),
            links &&
                import_react3.default.createElement(
                    Links,
                    ...
                    links.map(({ title: linkTitle, ...other }) =>
                        import_react3.default.createElement(Link22, { ...other, key: linkTitle }, linkTitle),
                    ),
                ),
        );
...
var Note = newStyled.div(({ theme }) => ({
    ...
    TooltipNote = ({ note, ...props }) => import_react3.default.createElement(Note, { ...props }, note),
    Title3 = newStyled(({ active, loading, disabled, ...rest }) =>
        import_react3.default.createElement('span', { ...rest }),
    )(
        ({ theme }) => ({ color: theme.color.defaultText, fontWeight: theme.typography.weight.regular }),
        ({ active, theme }) =>
            active ? { color: theme.color.secondary, fontWeight: theme.typography.weight.bold } : {},
        ({ loading, theme }) =>
            loading ? { display: 'inline-block', flex: 'none', ...theme.animation.inlineGlow } : {},
        ({ disabled, theme }) => (disabled ? { color: curriedTransparentize$1(0.7, theme.color.defaultText) } : {}),
    ),
    ...
    getItemProps = (0, import_memoizerific4.default)(100)((onClick, href, LinkWrapper) => {
        let result2 = {};
        return (
            onClick && Object.assign(result2, { onClick }),
            href && Object.assign(result2, { href }),
            LinkWrapper && href && Object.assign(result2, { to: href, as: LinkWrapper }),
            result2
        );
    }),
    ListItem = ({
        ...
        return import_react3.default.createElement(
            ...
            icon && import_react3.default.createElement(Left, { ...commonProps }, icon),
            title || center
                ? import_react3.default.createElement(
                      Center,
                      { isIndented: !icon && isIndented },
                      title && import_react3.default.createElement(Title3, { ...commonProps, loading }, title),
                      center && import_react3.default.createElement(CenterText, { ...commonProps }, center),
                  )
                : null,
            right && import_react3.default.createElement(Right, { ...commonProps }, right),
        );
    };
ListItem.defaultProps = {
    loading: !1,
    title: import_react3.default.createElement('span', null, 'Loading state'),
    center: null,
    right: null,
    active: !1,
    disabled: !1,
...
var ListItem_default = ListItem,
    ...
    Item2 = (props) => {
        let { LinkWrapper, onClick: onClickFromProps, id, isIndented, ...rest } = props,
        ...
        return import_react3.default.createElement(ListItem_default, {
            title,
            active,
            href,
            id: `list-item-${id}`,
    ...
    TooltipLinkList = ({ links, LinkWrapper }) => {
        ...
        return import_react3.default.createElement(
            ...
            links.map(({ isGatsby, ...p }) =>
                import_react3.default.createElement(Item2, {
                    key: p.id,
...
var isLink = (obj) => typeof obj.props.href == 'string',
    isButton = (obj) => typeof obj.props.href != 'string';
function ForwardRefFunction({ children, ...rest }, ref) {
    let o = { props: rest, ref };
    if (isLink(o)) return import_react3.default.createElement('a', { ref: o.ref, ...o.props }, children);
    if (isButton(o))
        return import_react3.default.createElement('button', { ref: o.ref, type: 'button', ...o.props }, children);
...
var IconPlaceholder = newStyled.div(({ theme }) => ({
    ...
    IconButtonSkeletonWrapper = newStyled.div(() => ({ marginTop: 6, padding: 7, height: 28 })),
    IconButtonSkeleton = () =>
        import_react3.default.createElement(
            IconButtonSkeletonWrapper,
            null,
            import_react3.default.createElement(IconPlaceholder, null),
        ),
    Side = newStyled.div(
        ...
        ({ right }) => (right ? { marginLeft: 30, '& > *': { marginRight: 4 } } : {}),
    );
Side.displayName = 'Side';
var UnstyledBar = ({ children, className, scrollable }) =>
        scrollable
            ? import_react3.default.createElement(ScrollArea, { vertical: !1, className }, children)
            : import_react3.default.createElement('div', { className }, children),
    Bar = newStyled(UnstyledBar)(
        ...
        ({ theme, border = !1 }) =>
            border ? { boxShadow: `${theme.appBorderColor}  0 -1px 0 0 inset`, background: theme.barBg } : {},
    );
Bar.displayName = 'Bar';
var BarInner = newStyled.div(({ bgColor }) => ({
    ...
    FlexBar = ({ children, backgroundColor, className, ...rest }) => {
        let [left, right] = import_react3.Children.toArray(children);
        return import_react3.default.createElement(
            Bar,
            ...
            import_react3.default.createElement(
                ...
                import_react3.default.createElement(Side, { scrollable: rest.scrollable, left: !0 }, left),
                right ? import_react3.default.createElement(Side, { right: !0 }, right) : null,
            ),
        );
    };
FlexBar.displayName = 'FlexBar';
var VisuallyHidden = newStyled.div(({ active }) => (active ? { display: 'block' } : { display: 'none' })),
    childrenToList = (children) =>
        import_react3.Children.toArray(children).map(
...
function useList(list) {
    let tabBarRef = (0, import_react3.useRef)(),
        addonsRef = (0, import_react3.useRef)(),
        tabRefs = (0, import_react3.useRef)(new Map()),
        { width: tabBarWidth = 1 } = useResizeObserver({ ref: tabBarRef }),
        [visibleList, setVisibleList] = (0, import_react3.useState)(list),
        [invisibleList, setInvisibleList] = (0, import_react3.useState)([]),
        previousList = (0, import_react3.useRef)(list),
        AddonTab = (0, import_react3.useCallback)(
            ({ menuName, actions }) => {
                let isAddonsActive = invisibleList.some(({ active }) => active),
                    [isTooltipVisible, setTooltipVisible] = (0, import_react3.useState)(!1);
                return import_react3.default.createElement(
                    ...
                    import_react3.default.createElement(
                        WithToolTipState,
                        {
                            ...
                            placement: 'bottom',
                            delayHide: 100,
                            tooltip: import_react3.default.createElement(TooltipLinkList, {
                        ...
                        import_react3.default.createElement(
                            ...
                            menuName,
                            import_react3.default.createElement(CollapseIcon2, {
        ...
        setTabLists = (0, import_react3.useCallback)(() => {
            ...
            let { x: x2, width } = tabBarRef.current.getBoundingClientRect(),
                ...
                rightBorder = invisibleList.length ? x2 + width - widthAddonsTab : x2 + width,
                newVisibleList = [],
                widthSum = 0,
                newInvisibleList = list.filter((item) => {
                    ...
                    return (
                        (!crossBorder || !tabButton) && newVisibleList.push(item), (widthSum += tabWidth), crossBorder
                    );
                });
            (newVisibleList.length !== visibleList.length || previousList.current !== list) &&
                (setVisibleList(newVisibleList), setInvisibleList(newInvisibleList), (previousList.current = list));
...
var Wrapper2 = newStyled.div(({ theme }) => ({
    ...
    Content = newStyled.div({ display: 'flex', flexDirection: 'column', gap: 4, maxWidth: 415 }),
    ...
    EmptyTabContent = ({ title, description, footer }) =>
        import_react3.default.createElement(
            ...
            import_react3.default.createElement(
                Content,
                null,
                import_react3.default.createElement(Title4, null, title),
                description && import_react3.default.createElement(Description, null, description),
            ),
            footer,
        ),
    ignoreSsrWarning2 =
...
var Content2 = newStyled.div(
        { display: 'block', position: 'relative' },
        ({ theme }) => ({ fontSize: theme.typography.size.s2 - 1, background: theme.background.content }),
        ({ bordered, theme }) =>
            bordered ? { borderRadius: `0 0 ${theme.appBorderRadius - 1}px ${theme.appBorderRadius - 1}px` } : {},
        ({ absolute, bordered }) =>
            absolute
                ? {
    ...
    TabWrapper = ({ active, render, children }) =>
        import_react3.default.createElement(VisuallyHidden, { active }, render ? render() : children),
    Tabs = (0, import_react3.memo)(
        ({
            children,
            selected,
            actions,
            ...
            let idList = childrenToList(children)
                    .map((i) => i.id)
                    .join(','),
                list = (0, import_react3.useMemo)(
                    () =>
                ...
                EmptyContent =
                    emptyState ?? import_react3.default.createElement(EmptyTabContent, { title: 'Nothing found' });
            return !showToolsWhenEmpty && list.length === 0
                ...
                : import_react3.default.createElement(
                      ...
                      import_react3.default.createElement(
                          ...
                          import_react3.default.createElement(
                              TabBar,
                              { style: { whiteSpace: 'normal' }, ref: tabBarRef, role: 'tablist' },
                              visibleList.map(({ title, id, active, color: color2 }, index3) => {
                                  let indexId = `index-${index3}`;
                                  return import_react3.default.createElement(
                                      TabButton,
                                      {
                                      ...
                                      typeof title == 'function'
                                          ? import_react3.default.createElement('title', null)
                                          : title,
                                  );
                              }),
                              import_react3.default.createElement(AddonTab, { menuName, actions }),
                          ),
                          tools,
                      ),
                      import_react3.default.createElement(
                          ...
                          list.length
                              ? list.map(({ id, active, render }) =>
                                    import_react3.default.createElement(render, { key: id, active }, null),
                                )
                              : EmptyContent,
                      ),
                  );
...
var TabsState = class extends import_react3.Component {
    ...
    render() {
        let { bordered = !1, absolute = !1, children, backgroundColor, menuName } = this.props,
            { selected } = this.state;
        return import_react3.default.createElement(
            Tabs,
            { bordered, absolute, selected, backgroundColor, menuName, actions: this.handlers },
            children,
        );
    }
};
...
var Separator = newStyled.span(
    ({ theme }) => ({ width: 1, height: 20, background: theme.appBorderColor, marginLeft: 2, marginRight: 2 }),
...
var interleaveSeparators = (list) =>
            ...
            (acc, item, index3) =>
                item
                    ? import_react3.default.createElement(
                          ...
                          acc,
                          index3 > 0 ? import_react3.default.createElement(Separator, { key: `s-${index3}` }) : null,
                          item.render() || item,
                      )
                    : acc,
            null,
    ...
    AddonPanel = ({ active, children }) =>
        import_react3.default.createElement('div', { hidden: !active }, useUpdate(active, children)),
...
`,
    Icons = ({ icon, useSymbol, __suppressDeprecationWarning = !1, ...props }) => {
        ...
        return import_react3.default.createElement(Icon, { ...props });
    },
    Symbols = (0, import_react3.memo)(function ({ icons: keys2 = Object.keys(icons) }) {
        return import_react3.default.createElement(
            Svg,
            { viewBox: '0 0 14 14', style: { position: 'absolute', width: 0, height: 0 }, 'data-chromatic': 'ignore' },
            keys2.map((key2) =>
                import_react3.default.createElement('symbol', { id: `icon--${key2}`, key: key2 }, icons[key2]),
            ),
        );
    }),
    icons = {
    ...
    StorybookLogo = ({ alt, ...props }) =>
        import_react3.default.createElement(
            'svg',
            { width: '200px', height: '40px', viewBox: '0 0 200 40', ...props, role: 'img' },
            alt ? import_react3.default.createElement('title', null, alt) : null,
            import_react3.default.createElement(
                'defs',
                null,
            ...
            import_react3.default.createElement(
                ...
                import_react3.default.createElement(
                    'mask',
                    { id: 'b', fill: '#fff' },
                    import_react3.default.createElement('use', { xlinkHref: '#a' }),
                ),
                import_react3.default.createElement('use', { fill: '#FF4785', fillRule: 'nonzero', xlinkHref: '#a' }),
                import_react3.default.createElement('path', {
    ...
    StorybookIcon2 = (props) =>
        import_react3.default.createElement(
            ...
            import_react3.default.createElement('title', null, 'Storybook icon'),
            import_react3.default.createElement(
                'g',
...
`,
    ...
    Loader = ({ progress, error, size, ...props }) => {
        if (error)
            return import_react3.default.createElement(
                ProgressWrapper,
                { 'aria-label': error.toString(), 'aria-live': 'polite', role: 'status', ...props },
                import_react3.default.createElement(ErrorIcon, null),
                import_react3.default.createElement(ProgressMessage, null, error.message),
            );
        if (progress) {
            let { value: value2, modules } = progress,
                { message } = progress;
            return (
                modules && (message += ` ${modules.complete} / ${modules.total} modules`),
                import_react3.default.createElement(
                    ProgressWrapper,
                    {
                    ...
                    import_react3.default.createElement(
                        ProgressTrack,
                        null,
                        import_react3.default.createElement(ProgressBar, { style: { width: `${value2 * 100}%` } }),
                    ),
                    import_react3.default.createElement(
                        ProgressMessage,
                        null,
                        message,
                        value2 < 1 && import_react3.default.createElement(Ellipsis, { key: message }),
                    ),
                )
            );
        }
        return import_react3.default.createElement(LoaderWrapper, {
            'aria-label': 'Content is loading...',
            'aria-live': 'polite',
            role: 'status',
            size,
...
`,
    ClipboardCode = ({ code, ...props }) =>
        import_react3.default.createElement(Code2, { id: 'clipboard-code', ...props }, code),
    components2 = components,
    resetComponents = {};
Object.keys(components).forEach((key2) => {
    resetComponents[key2] = (0, import_react3.forwardRef)((props, ref) =>
        (0, import_react3.createElement)(key2, { ...props, ref }),
    );
});
export {
    require_lib,
