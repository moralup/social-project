...
import { __commonJS2 as __commonJS, __toESM, __toESM2, require_memoizerific } from './chunk-XP3HGWTR.js';
                ...
                var stringifyToken = function (token) {
                    ...
                    walkTokens = function (tokens) {
                        for (var openedTags = [], i = 0; i < tokens.length; i++) {
                            ...
                            if (
                                (typeof token != 'string' &&
                                    (token.type === 'tag' && token.content[0] && token.content[0].type === 'tag'
            ...
            (Prism.languages.markup = {
                ...
                Object.defineProperty(Prism.languages.markup.tag, 'addInlined', {
                    value: function (tagName, lang) {
                        ...
                        var inside = {
                            'included-cdata': { pattern: /<!\[CDATA\[[\s\S]*?\]\]>/i, inside: includedCdataInside },
                        };
    ...
    require_merge = __commonJS({
        '../../node_modules/hastscript/node_modules/property-information/lib/util/merge.js'(exports, module) {
            ...
            function merge(definitions) {
                for (
                    var length = definitions.length, property = [], normal = [], index = -1, info, space;
                    ++index < length;
    ...
    require_comma_separated_tokens = __commonJS({
        '../../node_modules/hastscript/node_modules/comma-separated-tokens/index.js'(exports) {
            ...
            function stringify(values, options) {
                ...
                return (
                    values[values.length - 1] === empty && (values = values.concat(empty)),
            ...
            function factory(schema, defaultTagName, caseSensitive) {
                ...
                function h(selector, properties) {
                    ...
                    if (
                        ...
                        for (property in properties) addProperty(node.properties, property, properties[property]);
                    return (
                ...
                function addProperty(properties, key, value) {
                    ...
                    value == null ||
                        ...
                        property === 'style' && typeof value != 'string' && (result = style(result)),
                        property === 'className' &&
            ...
            function isNode(tagName, value) {
                ...
                return tagName === 'input' || !type || typeof type != 'string'
                    ...
                    : ((type = type.toLowerCase()),
                      tagName === 'button'
                          ? type !== 'menu' && type !== 'submit' && type !== 'reset' && type !== 'button'
                          : 'value' in value);
            }
        ...
        '../../node_modules/refractor/node_modules/parse-entities/decode-entity.browser.js'(exports, module) {
            ...
            function decodeEntity(characters) {
                ...
                return (
                    ...
                    (el.innerHTML = entity),
                    (char = el.textContent),
                    (char.charCodeAt(char.length - 1) === semicolon && characters !== 'semi') || char === entity
                        ? !1
                        : char
                );
            }
    ...
    require_parse_entities = __commonJS({
        '../../node_modules/refractor/node_modules/parse-entities/index.js'(exports, module) {
            ...
            function parse(value, settings) {
                ...
                for (
                    typeof additional == 'string' && (additional = additional.charCodeAt(0)),
                        prev = now(),
                    ...
                    if (
                        ...
                        for (
                            ...
                            ++end < length && ((following = value.charCodeAt(end)), !!test(following));
                        ...
                        (terminated = value.charCodeAt(end) === semicolon),
                            terminated &&
                                ...
                                namedEntity && ((entityCharacters = characters), (entity = namedEntity))),
                            (diff = 1 + end - start),
                                        ...
                                        : (terminated || warning(numericNotTerminated, diff),
                                          ...
                                          prohibited(reference)
                                              ...
                                              : ((output = ''),
                                                ...
                                                reference > 65535 &&
                                                    ((reference -= 65536),
                                                    (output += fromCharCode((reference >>> 10) | 55296)),
            ...
            var _self =
                ...
                Prism = (function (_self2) {
                    ...
                    if (!_.manual) {
                        ...
                        readyState === 'loading' || (readyState === 'interactive' && script && script.defer)
            ...
            function stringify(value, language, parent) {
                ...
                return typeof value == 'string'
                    ...
                    : ((env = {
                      ...
                      h(env.tag + '.' + env.classes.join('.'), attributes(env.attributes), env.content));
            }
            ...
            (function (Prism2) {
                ...
                (Prism2.languages.bash = {
                    ...
                    string: [
                        ...
                        { pattern: /(^|[^$\\])'[^']*'/, lookbehind: !0, greedy: !0 },
                        { pattern: /\$'(?:[^'\\]|\\[\s\S])*'/, greedy: !0, inside: { entity: insideString.entity } },
                    ],
                    environment: { pattern: RegExp('\\$?' + envVars), alias: 'constant' },
                        ...
                        if (startToken.type === 'keyword' && startToken.content === 'mutation') {
                            ...
                            if (isTokenType(['definition-mutation', 'punctuation']) && getToken(1).content === '(') {
                                ...
                                for (; currentIndex < definitionEnd; currentIndex++) {
                                    var t = getToken(0);
                                    t.type === 'variable' &&
                                        (addAlias(t, 'variable-input'), inputVariables.push(t.content));
                                }
                            ...
                            if (
                                ...
                                getToken(0).content === '{' &&
                                (currentIndex++, addAlias(getToken(0), 'property-mutation'), inputVariables.length > 0)
                            ) {
    ...
    return (
        (_typeof =
            typeof Symbol == 'function' && typeof Symbol.iterator == 'symbol'
                ...
                : function (o2) {
                      return o2 && typeof Symbol == 'function' && o2.constructor === Symbol && o2 !== Symbol.prototype
                          ? 'symbol'
                          : typeof o2;
                  }),
        _typeof(o)
...
function getClassNameCombinations(classNames) {
    ...
    return (
        classNameCombinations[key] || (classNameCombinations[key] = powerSetPermutations(classNames)),
    ...
    if (TagName) {
        ...
        if (!useInlineStyles)
            ...
            var allStylesheetSelectors = Object.keys(stylesheet).reduce(function (classes, selector) {
                ...
                startingClassName = properties.className && properties.className.includes('token') ? ['token'] : [],
                className =
                    properties.className &&
        ...
        return import_react3.default.createElement(TagName, _extends({ key }, props), children);
    }
}
...
function AllLineNumbers(_ref2) {
    var codeString = _ref2.codeString,
        ...
        containerStyle =
            _ref2$containerStyle === void 0 ? { float: 'left', paddingRight: '10px' } : _ref2$containerStyle,
...
function assembleLineNumberStyles(lineNumberStyle, lineNumber, largestLineNumber) {
    var defaultLineNumberStyle = {
        ...
        assembledStyle = _objectSpread2(_objectSpread2({}, defaultLineNumberStyle), customLineNumberStyle);
...
function createLineElement(_ref3) {
    var children = _ref3.children,
        ...
        properties = typeof lineProps == 'function' ? lineProps(lineNumber) : lineProps;
    ...
    return (
        wrapLongLines & showLineNumbers &&
            (properties.style = _objectSpread2(_objectSpread2({}, properties.style), {}, { display: 'flex' })),
...
function flattenCodeTree(tree) {
    for (
        var className = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [],
            newTree = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [],
            i = 0;
        i < tree.length;
        i++
    ) {
...
`,
                    ...
                    if (i === 0) {
                        var _children = tree
                                ...
                                .concat(
                                    createLineElement({ children: [newChild], className: node.properties.className }),
                                ),
                        ...
                        if (stringChild) {
                            ...
                            var _children2 = [lastLineInPreviousSpan],
                                _line2 = createLine(_children2, lineNumber2, node.properties.className);
                            newTree.push(_line2);
                        }
                    } else {
                        var _children3 = [newChild],
                            _line3 = createLine(_children3, lineNumber2, node.properties.className);
                        newTree.push(_line3);
                    }
                }),
...
function highlight_default(defaultAstGenerator, defaultStyle) {
    return function (_ref7) {
        var language = _ref7.language,
            ...
            useInlineStyles = _ref7$useInlineStyles === void 0 ? !0 : _ref7$useInlineStyles,
            _ref7$showLineNumbers = _ref7.showLineNumbers,
            showLineNumbers = _ref7$showLineNumbers === void 0 ? !1 : _ref7$showLineNumbers,
            _ref7$showInlineLineN = _ref7.showInlineLineNumbers,
            showInlineLineNumbers = _ref7$showInlineLineN === void 0 ? !0 : _ref7$showInlineLineN,
        ...
        var allLineNumbers = showLineNumbers
                ...
                : null,
            defaultPreStyle = style.hljs || style['pre[class*="language-"]'] || { backgroundColor: '#fff' },
...
var prism_light_default = SyntaxHighlighter,
    ...
    ActionButton = newStyled.button(
        ({ theme }) => ({
            ...
            '& + *': { borderLeft: `1px solid ${theme.appBorderColor}`, borderRadius: 0 },
            '&:focus': { boxShadow: `${theme.color.secondary} 0 -3px 0 0 inset`, outline: '0 none' },
        }),
...
var ActionBar = ({ actionItems, ...props }) =>
        import_react3.default.createElement(
            ...
            actionItems.map(({ title, className, onClick, disabled }, index) =>
                import_react3.default.createElement(ActionButton, { key: index, className, onClick, disabled }, title),
            ),
        ),
    ...
    $8927f6f2acc4f386$export$250ffa63cdc0d034 = $8927f6f2acc4f386$var$NODES.reduce((primitive, node) => {
        let Node = (0, import_react3.forwardRef)((props, forwardedRef) => {
            ...
            return (
                ...
                (0, import_react3.createElement)(Comp, _extends({}, primitiveProps, { ref: forwardedRef }))
            );
        });
...
var $9f79659886946c16$export$e5c5a5f917a5871c = globalThis?.document ? import_react3.useLayoutEffect : () => {};
function $fe963b355347cc68$export$3e6543de14f8614f(initialState, machine) {
    return (0, import_react3.useReducer)((state, event) => machine[state][event] ?? state, initialState);
}
var $921a889cee6df7e8$export$99c2b779aa4e8b8b = (props) => {
    ...
    return typeof children == 'function' || presence.isPresent ? (0, import_react3.cloneElement)(child, { ref }) : null;
};
        ...
        $9f79659886946c16$export$e5c5a5f917a5871c(() => {
            if (node1) {
                let handleAnimationEnd = (event) => {
                        let isCurrentAnimation = $921a889cee6df7e8$var$getAnimationName(stylesRef.current).includes(
                            event.animationName,
                        );
                        event.target === node1 &&
                            isCurrentAnimation &&
...
function $c512c27ab02ef895$export$50c7b4e9d9f19c1(scopeName, createContextScopeDeps = []) {
    ...
    function $c512c27ab02ef895$export$fd42f52fd3ae1109(rootComponentName, defaultContext) {
        ...
        function Provider(props) {
            let { scope: scope2, children, ...context } = props,
                ...
                value = (0, import_react3.useMemo)(() => context, Object.values(context));
            return (0, import_react3.createElement)(Context.Provider, { value }, children);
        }
    ...
    let createScope = () => {
        let scopeContexts = defaultContexts.map((defaultContext) => (0, import_react3.createContext)(defaultContext));
        ...
        (0, import_react3.useMemo)(
            () =>
                (...args) => {
                    ...
                    return (_callbackRef$current = callbackRef.current) === null || _callbackRef$current === void 0
                        ? void 0
...
function $f631663db3294ace$export$b39126d51d94e6f3(localDir) {
    let globalDir = (0, import_react3.useContext)($f631663db3294ace$var$DirectionContext);
...
var $57acba87d6e25586$var$SCROLL_AREA_NAME = 'ScrollArea',
    [$57acba87d6e25586$var$createScrollAreaContext, $57acba87d6e25586$export$488468afe3a6f2b1] =
        $c512c27ab02ef895$export$50c7b4e9d9f19c1($57acba87d6e25586$var$SCROLL_AREA_NAME),
    [$57acba87d6e25586$var$ScrollAreaProvider, $57acba87d6e25586$var$useScrollAreaContext] =
        $57acba87d6e25586$var$createScrollAreaContext($57acba87d6e25586$var$SCROLL_AREA_NAME),
    $57acba87d6e25586$export$ccf8d8d7bbf3c2cc = (0, import_react3.forwardRef)((props, forwardedRef) => {
        let { __scopeScrollArea, type = 'hover', dir, scrollHideDelay = 600, ...scrollAreaProps } = props,
            ...
            [scrollbarXEnabled, setScrollbarXEnabled] = (0, import_react3.useState)(!1),
            [scrollbarYEnabled, setScrollbarYEnabled] = (0, import_react3.useState)(!1),
            composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, (node) => setScrollArea(node)),
    ...
    $57acba87d6e25586$export$a21cbf9f11fca853 = (0, import_react3.forwardRef)((props, forwardedRef) => {
        let { __scopeScrollArea, children, ...viewportProps } = props,
            ...
            composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, ref, context.onViewportChange);
        return (0, import_react3.createElement)(
            ...
            (0, import_react3.createElement)(
                ...
                (0, import_react3.createElement)(
                    'div',
                    { ref: context.onContentChange, style: { minWidth: '100%', display: 'table' } },
                    children,
                ),
            ),
        );
    ...
    $57acba87d6e25586$export$2fabd85d0eba3c57 = (0, import_react3.forwardRef)((props, forwardedRef) => {
    ...
    $57acba87d6e25586$var$ScrollAreaScrollbarHover = (0, import_react3.forwardRef)((props, forwardedRef) => {
        let { forceMount, ...scrollbarProps } = props,
            context = $57acba87d6e25586$var$useScrollAreaContext(
                $57acba87d6e25586$var$SCROLLBAR_NAME,
                props.__scopeScrollArea,
        ...
        return (
            ...
            (0, import_react3.createElement)(
                ...
                (0, import_react3.createElement)(
                    $57acba87d6e25586$var$ScrollAreaScrollbarAuto,
                    _extends({ 'data-state': visible ? 'visible' : 'hidden' }, scrollbarProps, { ref: forwardedRef }),
                ),
            )
        );
    }),
    $57acba87d6e25586$var$ScrollAreaScrollbarScroll = (0, import_react3.forwardRef)((props, forwardedRef) => {
        let { forceMount, ...scrollbarProps } = props,
            context = $57acba87d6e25586$var$useScrollAreaContext(
                $57acba87d6e25586$var$SCROLLBAR_NAME,
                props.__scopeScrollArea,
            ...
            isHorizontal = props.orientation === 'horizontal',
            debounceScrollEnd = $57acba87d6e25586$var$useDebounceCallback(() => send('SCROLL_END'), 100),
        ...
        return (
                ...
                if (viewport) {
                    let prevScrollPos = viewport[scrollDirection],
                        handleScroll = () => {
                            ...
                            prevScrollPos !== scrollPos && (send('SCROLL'), debounceScrollEnd()),
            ...
            (0, import_react3.createElement)(
                ...
                (0, import_react3.createElement)(
                    $57acba87d6e25586$var$ScrollAreaScrollbarVisible,
                    _extends({ 'data-state': state === 'hidden' ? 'hidden' : 'visible' }, scrollbarProps, {
                        ref: forwardedRef,
    ...
    $57acba87d6e25586$var$ScrollAreaScrollbarAuto = (0, import_react3.forwardRef)((props, forwardedRef) => {
        let context = $57acba87d6e25586$var$useScrollAreaContext(
            ...
            handleResize = $57acba87d6e25586$var$useDebounceCallback(() => {
                if (context.viewport) {
                    let isOverflowX = context.viewport.offsetWidth < context.viewport.scrollWidth,
                        isOverflowY = context.viewport.offsetHeight < context.viewport.scrollHeight;
    ...
    $57acba87d6e25586$var$ScrollAreaScrollbarVisible = (0, import_react3.forwardRef)((props, forwardedRef) => {
        let { orientation = 'vertical', ...scrollbarProps } = props,
            ...
            thumbRatio = $57acba87d6e25586$var$getThumbRatio(sizes.viewport, sizes.content),
            commonProps = {
                ...scrollbarProps,
                sizes,
                      ...
                      onThumbPositionChange: () => {
                          if (context.viewport && thumbRef.current) {
                              let scrollPos = context.viewport.scrollTop,
                                  offset = $57acba87d6e25586$var$getThumbOffsetFromScroll(scrollPos, sizes);
    ...
    $57acba87d6e25586$var$ScrollAreaScrollbarX = (0, import_react3.forwardRef)((props, forwardedRef) => {
        let { sizes, onSizesChange, ...scrollbarProps } = props,
            ...
            ref = (0, import_react3.useRef)(null),
            composeRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, ref, context.onScrollbarXChange);
        return (
            (0, import_react3.useEffect)(() => {
                    ...
                    onWheelScroll: (event, maxScrollPos) => {
                        if (context.viewport) {
                            ...
                            props.onWheelScroll(scrollPos),
                                $57acba87d6e25586$var$isScrollingWithinScrollbarBounds(scrollPos, maxScrollPos) &&
    ...
    $57acba87d6e25586$var$ScrollAreaScrollbarY = (0, import_react3.forwardRef)((props, forwardedRef) => {
        let { sizes, onSizesChange, ...scrollbarProps } = props,
            context = $57acba87d6e25586$var$useScrollAreaContext(
                $57acba87d6e25586$var$SCROLLBAR_NAME,
                props.__scopeScrollArea,
            ...
            [computedStyle, setComputedStyle] = (0, import_react3.useState)(),
            ref = (0, import_react3.useRef)(null),
            composeRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, ref, context.onScrollbarYChange);
        return (
            (0, import_react3.useEffect)(() => {
                ref.current && setComputedStyle(getComputedStyle(ref.current));
            }, [ref]),
    ...
    [$57acba87d6e25586$var$ScrollbarProvider, $57acba87d6e25586$var$useScrollbarContext] =
        $57acba87d6e25586$var$createScrollAreaContext($57acba87d6e25586$var$SCROLLBAR_NAME),
    $57acba87d6e25586$var$ScrollAreaScrollbarImpl = (0, import_react3.forwardRef)((props, forwardedRef) => {
        let {
                __scopeScrollArea,
                sizes,
                hasThumb,
            ...
            composeRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, (node) => setScrollbar(node)),
            ...
            handleWheelScroll = $b1b2314f5f9a1d84$export$25bec8c6f54ee79a(onWheelScroll),
            handleThumbPositionChange = $b1b2314f5f9a1d84$export$25bec8c6f54ee79a(onThumbPositionChange),
        ...
        return (
            ...
            (0, import_react3.useEffect)(handleThumbPositionChange, [sizes, handleThumbPositionChange]),
                    ...
                    _extends({}, scrollbarProps, {
                        ...
                        onPointerDown: $e42e1063c40fb3ef$export$b9ecd428b558ff10(props.onPointerDown, (event) => {
                            event.button === 0 &&
                                ...
                                context.viewport && (context.viewport.style.scrollBehavior = 'auto'),
                        ...
                        onPointerUp: $e42e1063c40fb3ef$export$b9ecd428b558ff10(props.onPointerUp, (event) => {
                            ...
                            element.hasPointerCapture(event.pointerId) &&
                                ...
                                context.viewport && (context.viewport.style.scrollBehavior = ''),
    ...
    $57acba87d6e25586$export$9fba1154677d7cd2 = (0, import_react3.forwardRef)((props, forwardedRef) => {
    ...
    $57acba87d6e25586$var$ScrollAreaThumbImpl = (0, import_react3.forwardRef)((props, forwardedRef) => {
        let { __scopeScrollArea, style, ...thumbProps } = props,
            ...
            composedRef = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, (node) =>
        ...
        return (
            ...
            (0, import_react3.createElement)(
                $8927f6f2acc4f386$export$250ffa63cdc0d034.div,
                _extends({ 'data-state': scrollbarContext.hasThumb ? 'visible' : 'hidden' }, thumbProps, {
                    ref: composedRef,
                    style: {
    ...
    $57acba87d6e25586$export$56969d565df7cc4b = (0, import_react3.forwardRef)((props, forwardedRef) => {
        let context = $57acba87d6e25586$var$useScrollAreaContext(
    ...
    $57acba87d6e25586$var$ScrollAreaCornerImpl = (0, import_react3.forwardRef)((props, forwardedRef) => {
        let { __scopeScrollArea, ...cornerProps } = props,
            context = $57acba87d6e25586$var$useScrollAreaContext($57acba87d6e25586$var$CORNER_NAME, __scopeScrollArea),
        ...
        return (
            $57acba87d6e25586$var$useResizeObserver(context.scrollbarX, () => {
                ...
                let height =
                    ((_context$scrollbarX = context.scrollbarX) === null || _context$scrollbarX === void 0
                        ? void 0
            ...
            $57acba87d6e25586$var$useResizeObserver(context.scrollbarY, () => {
                ...
                let width =
                    ((_context$scrollbarY = context.scrollbarY) === null || _context$scrollbarY === void 0
                        ? void 0
...
function $57acba87d6e25586$var$getThumbSize(sizes) {
    let ratio = $57acba87d6e25586$var$getThumbRatio(sizes.viewport, sizes.content),
...
function $57acba87d6e25586$var$getThumbOffsetFromScroll(scrollPos, sizes, dir = 'ltr') {
    let thumbSizePx = $57acba87d6e25586$var$getThumbSize(sizes),
        ...
        scrollWithoutMomentum = $ae6933e535247d3d$export$7d15b64cf5a3a4c4(scrollPos, scrollClampRange);
...
var $57acba87d6e25586$export$be92b6f5f03c0fe9 = $57acba87d6e25586$export$ccf8d8d7bbf3c2cc,
    ...
    ScrollAreaRoot = newStyled($57acba87d6e25586$export$be92b6f5f03c0fe9)(({ scrollbarsize, offset }) => ({
        width: '100%',
        height: '100%',
        overflow: 'hidden',
    ...
    ScrollAreaViewport = newStyled($57acba87d6e25586$export$d5c6c08dc2d3ca7)({ width: '100%', height: '100%' }),
    ScrollAreaScrollbar = newStyled($57acba87d6e25586$export$9a4e88b92edfce6b)(({ offset, horizontal, vertical }) => ({
        display: 'flex',
        userSelect: 'none',
        touchAction: 'none',
    ...
    ScrollAreaThumb = newStyled($57acba87d6e25586$export$6521433ed15a34db)(({ theme }) => ({
        flex: 1,
    ...
    ScrollArea = ({ children, horizontal = !1, vertical = !1, offset = 2, scrollbarSize = 6, className }) =>
        import_react3.default.createElement(
            ScrollAreaRoot,
            ...
            horizontal &&
                vertical &&
                import_react3.default.createElement($57acba87d6e25586$export$ac61190d9fc311a9, null),
        ),
...
var Wrapper = newStyled.div(
        ({ theme }) => ({ position: 'relative', overflow: 'hidden', color: theme.color.defaultText }),
        ({ theme, bordered }) =>
            bordered
                ? {
    ...
    UnstyledScroller = ({ children, className }) =>
        import_react3.default.createElement(ScrollArea, { horizontal: !0, vertical: !0, className }, children),
    Scroller = newStyled(UnstyledScroller)({ position: 'relative' }, ({ theme }) => themedSyntax(theme)),
    ...
    defaultRenderer2 = ({ rows, stylesheet, useInlineStyles }) =>
        rows.map((node, i) =>
            createElement({ node: processLineNumber(node), stylesheet, useInlineStyles, key: `code-segement${i}` }),
        ),
    wrapRenderer = (renderer, showLineNumbers) =>
        showLineNumbers
            ? renderer
                ? ({ rows, ...rest }) => renderer({ rows: rows.map((row) => processLineNumber(row)), ...rest })
                : defaultRenderer2
            : renderer,
    SyntaxHighlighter2 = ({
        children,
