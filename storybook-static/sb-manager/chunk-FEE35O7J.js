...
function effect2(_ref2) {
    ...
    arrowElement != null &&
        ((typeof arrowElement == 'string' &&
            ...
            (contains(state.elements.popper, arrowElement) && (state.elements.arrow = arrowElement)));
}
var arrow_default = {
    name: 'arrow',
    enabled: !0,
...
function usePopperTooltip(config, popperOptions) {
    ...
    var finalConfig = Object.keys(defaultConfig).reduce(function (config2, key) {
            ...
            return _extends(
                ...
                config2,
                ((_extends2 = {}),
                (_extends2[key] = config2[key] !== void 0 ? config2[key] : defaultConfig[key]),
                _extends2),
            );
        }, config),
    ...
    Tooltip = import_react.default.forwardRef(
        ({ placement, hasChrome, children, arrowProps, tooltipRef, color, withArrows, ...props }, ref) =>
            import_react.default.createElement(
                ...
                hasChrome &&
                    withArrows &&
                    import_react.default.createElement(Arrow, { placement, ...arrowProps, color }),
                children,
            ),
    );
